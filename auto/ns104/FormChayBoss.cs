...
public class FormChayBoss : Form
{
	...
	public static int RunBossCoordinateRouteForCharacter(CharacterAccountConfig characterAccountConfig_0)
	{
							...
							while (true)
							{
								...
								if (!CommonUtility.bool_0 && num18 >= 0 && Form1.characterAccountConfig_1[num18].bool_25)
								{
									...
									if (num14 == 0)
									{
										...
										GameProcessInteractionHelper.PrintGameMessage(characterAccountConfig_0, GameTextEncodingHelper.ConvertDisplayTextToGameText("<color=yellow>Bắt đầu chạy điểm boss..."));
										num14 = 1;
									}
									if (num3 == characterAccountConfig_0.int_0 && characterAccountConfig_0.bool_1)
									{
										...
										if (num19 != 1)
										{
											uint num20 = WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_11.resolvedValue, characterAccountConfig_0.int_137);
											uint num21 = WindowsInteropHelper.ReadProcessUInt32(num20 + GameConfigurationManager.memorySignatureScanConfig_13.resolvedValue, characterAccountConfig_0.int_137);
											uint num22 = WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_14.resolvedValue, characterAccountConfig_0.int_137);
											num23 = num22 + num21 * GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue;
											int num24 = (int)WindowsInteropHelper.ReadProcessUInt32(num23 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, characterAccountConfig_0.int_137);
											int num25 = (int)WindowsInteropHelper.ReadProcessUInt32(num23 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, characterAccountConfig_0.int_137);
											...
											if (num25 > 0 && num26 > 0 && num24 != 10 && num24 != 21 && num28 > 1)
											{
												...
												if (num15 >= 0 && num15 == num27)
												{
													array8 = new uint[2]
													{
														WindowsInteropHelper.ReadProcessUInt32(num23 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, characterAccountConfig_0.int_137),
								...
								if (num36 <= 240000L)
								{
									...
									{
										int num39 = (int)WindowsInteropHelper.ReadProcessUInt32(num23 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, characterAccountConfig_0.int_137);
		...
		CharacterMovementHelper.SetMovementActive(characterAccountConfig_0, bool_0: false);
		GameProcessInteractionHelper.PrintGameMessage(characterAccountConfig_0, GameTextEncodingHelper.ConvertDisplayTextToGameText("<color=yellow>Kết thúc chạy điểm boss !"));
		return num;
	}
