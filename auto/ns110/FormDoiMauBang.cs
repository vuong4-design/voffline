...
public class FormDoiMauBang : Form
{
	...
	private static void smethod_2()
	{
		...
		while (true)
		{
			...
			if (num2 <= 0)
			{
				...
				num4 = 0u;
				Class24.ReadProcessMemory(int_3, GameConfigurationManager.memorySignatureScanConfig_11.uint_0, array, 4, ref int_);
				uint num5 = BitConverter.ToUInt32(array, 0);
				Class24.ReadProcessMemory(int_3, num5 + GameConfigurationManager.memorySignatureScanConfig_13.uint_0, array, 4, ref int_);
				uint num6 = BitConverter.ToUInt32(array, 0) * GameConfigurationManager.memorySignatureScanConfig_15.uint_0;
				Class24.ReadProcessMemory(int_3, GameConfigurationManager.memorySignatureScanConfig_14.uint_0, array, 4, ref int_);
				num7 = BitConverter.ToUInt32(array, 0);
				num8 = num7 + num6;
				if (num3 != 0)
				{
					num4 = num7 + num3 * GameConfigurationManager.memorySignatureScanConfig_15.uint_0;
					Class24.ReadProcessMemory(int_3, num4 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, array, 4, ref int_);
					if (BitConverter.ToInt32(array, 0) > 0)
					{
						Class24.ReadProcessMemory(int_3, num4 + GameConfigurationManager.memorySignatureScanConfig_16.uint_0, array, 1, ref int_);
						if (array[0] != 0)
						{
							Class24.ReadProcessMemory(int_3, num4 + GameConfigurationManager.memorySignatureScanConfig_54.uint_0, array, 1, ref int_);
							int num9 = array[0];
							if (num9 > 0 && num9 <= 3)
							{
								if (gstruct2_0.int_2 != 0)
								{
									...
									{
										Class24.ReadProcessMemory(int_3, num4 + GameConfigurationManager.memorySignatureScanConfig_88.uint_0, array, 4, ref int_);
								...
								{
									Class24.ReadProcessMemory(int_3, num4 + GameConfigurationManager.memorySignatureScanConfig_16.uint_0, byte_, int_2, ref int_);
				...
				for (num13 = 1u; num13 < 256 && num11 > num12; num13++)
				{
					...
					Class24.ReadProcessMemory(int_3, num4 + GameConfigurationManager.memorySignatureScanConfig_16.uint_0, array, 4, ref int_);
					if (array[0] == 0)
					{
						continue;
					}
					num12++;
					Class24.ReadProcessMemory(int_3, num4 + GameConfigurationManager.memorySignatureScanConfig_52.uint_0, array, 4, ref int_);
					...
					Class24.ReadProcessMemory(int_3, num4 + GameConfigurationManager.memorySignatureScanConfig_89.uint_0, array2, array2.Length, ref int_);
					if (array2[0] == 0)
					{
						continue;
					}
			...
			IL_056c:
			num4 = num7 + num3 * GameConfigurationManager.memorySignatureScanConfig_15.uint_0;
			Class24.ReadProcessMemory(int_3, num4 + GameConfigurationManager.memorySignatureScanConfig_54.uint_0, array, 4, ref int_);
			uint num16 = array[0];
			if (num16 == 0 || num16 > 3)
			{
				continue;
			}
			Class24.ReadProcessMemory(int_3, num8 + GameConfigurationManager.memorySignatureScanConfig_54.uint_0, array, 4, ref int_);
			uint num17 = array[0];
			if (num17 == 0)
			{
				continue;
	...
	public static void smethod_3(CharacterAccountConfig characterAccountConfig_0, ref string[] string_2, string[] string_3 = null, bool bool_2 = false)
	{
		...
		for (uint num4 = 1u; num4 < 256 && num2 > num3; num4++)
		{
			...
			num3++;
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num5 + GameConfigurationManager.memorySignatureScanConfig_52.uint_0, array2, 4, ref int_);
			...
			if (!bool_2)
			{
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num5 + GameConfigurationManager.memorySignatureScanConfig_16.uint_0, array, array.Length, ref int_);
