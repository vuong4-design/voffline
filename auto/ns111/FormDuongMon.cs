...
public class FormDuongMon : Form
{
	...
	public static void RunDuongMonConfiguredSkillCycle(CharacterAccountConfig characterAccountConfig_0, ref int int_6, uint[] uint_0, ref int int_7, bool bool_2)
	{
		...
		if (bool_2 && placeBombsAroundMainAccountEnabled > 0)
		{
			...
			for (; num < 40; num++)
			{
				int num9 = (int)WindowsInteropHelper.ReadProcessUInt32(num6 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, characterAccountConfig_0.int_137);
			...
			int int_8 = 0;
			WindowsInteropHelper.WriteProcessMemory(characterAccountConfig_0.int_137, num6 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, new byte[4], 4, ref int_8);
			for (num = 0; num < 8; num++)
			{
		...
		do
		{
			...
			if (characterAccountConfig_0.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId || Form1.remoteAuxiliarySyncModeEnabled > 0 || Form1.manualAuxiliaryMachineModeEnabled > 0)
			{
			...
			for (; i < 15; i++)
			{
				int num14 = (int)WindowsInteropHelper.ReadProcessUInt32(num6 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, characterAccountConfig_0.int_137);
			...
			for (; i < 60; i++)
			{
				...
				int num15 = (int)WindowsInteropHelper.ReadProcessUInt32(num6 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, characterAccountConfig_0.int_137);
	...
	private bool PopulateSkillComboBox(ComboBox comboBox_0, SkillMetadata[] gstruct58_0)
	{
	...
	private string FindSkillNameById(SkillMetadata[] gstruct58_0, int int_6)
	{
