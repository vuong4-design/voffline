...
public class FormKhongCatdo : Form
{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ns114.FormKhongCatdo));
		...
		this.comboBoxTenTuiMauHotro.Location = new System.Drawing.Point(4, 220);
		...
		this.buttonThem.Location = new System.Drawing.Point(4, 250);
		this.buttonThem.Name = "buttonThem";
		this.buttonThem.Size = new System.Drawing.Size(60, 23);
		this.buttonThem.TabIndex = 219;
		this.buttonThem.Text = "Thêm";
		this.buttonThem.UseVisualStyleBackColor = true;
		this.buttonThem.Click += new System.EventHandler(buttonThem_Click);
		this.buttonXoa.Location = new System.Drawing.Point(67, 250);
		this.buttonXoa.Name = "buttonXoa";
		this.buttonXoa.Size = new System.Drawing.Size(60, 23);
		this.buttonXoa.TabIndex = 220;
		this.buttonXoa.Text = "Xóa";
		this.buttonXoa.UseVisualStyleBackColor = true;
		this.buttonXoa.Click += new System.EventHandler(buttonXoa_Click);
		this.buttonClose.Location = new System.Drawing.Point(162, 279);
		this.buttonClose.Name = "buttonClose";
		this.buttonClose.Size = new System.Drawing.Size(74, 26);
		...
		this.buttonAppAll.Location = new System.Drawing.Point(133, 250);
		this.buttonAppAll.Name = "buttonAppAll";
		this.buttonAppAll.Size = new System.Drawing.Size(123, 23);
		...
		base.Load += new System.EventHandler(FormKhongCatdo_Load);
	...
	private void buttonThem_Click(object sender, EventArgs e)
	{
		...
		if (Form1.characterAccountConfig_1[num].string_5 != null)
		{
			for (int j = 0; j < Form1.characterAccountConfig_1[num].string_5.Length; j++)
			{
				if (Form1.characterAccountConfig_1[num].string_5[j] == text)
				{
					return;
				}
			}
	...
	private void buttonXoa_Click(object sender, EventArgs e)
	{
		...
		while (true)
		{
			...
			{
				if (text == listView1.Items[num2].SubItems[0].Text)
				{
					break;
				}
				num2++;
	...
	private void buttonAppAll_Click(object sender, EventArgs e)
	{
		...
		try
		{
			for (int i = 0; i < Form1.characterAccountConfig_1.Length; i++)
			{
				...
				Form1.characterAccountConfig_1[i].string_5 = null;
				if (Form1.characterAccountConfig_1[num].string_5 != null)
				{
					Form1.characterAccountConfig_1[i].string_5 = new string[Form1.characterAccountConfig_1[num].string_5.Length];
					for (int j = 0; j < Form1.characterAccountConfig_1[num].string_5.Length; j++)
					{
