...
public class FormLocdo : Form
{
	...
	private void buttonXoa_Click(object sender, EventArgs e)
	{
		...
		{
			if (GameTextEncodingHelper.ConvertGameTextToDisplayText(Form1.characterAccountConfig_1[num].string_4[i], 1) == text)
			{
				CommonUtility.RemoveStringFromArray(ref Form1.characterAccountConfig_1[num].string_4, Form1.characterAccountConfig_1[num].string_4[i]);
	...
	private void buttonThem_Click(object sender, EventArgs e)
	{
		...
		if (text == null)
		{
			text = GameTextEncodingHelper.ConvertDisplayTextToGameText(text2);
		}
	...
	private void comboBoxTenVatpham_MouseDown(object sender, MouseEventArgs e)
	{
		...
		inventoryItemNameCandidates = InventoryItemMemoryHelper.CollectInventoryItemNames(Form1.characterAccountConfig_1[num]);
		comboBoxTenVatpham.Items.Clear();
	...
	private void buttonApdungAll_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			int[] array = new int[2]
			{
				...
				CommonUtility.ParseInt32OrZero(textBoxDongNhan.Text)
			};
			int[] array2 = new int[2]
			{
				Convert.ToByte(checkBoxDaychuyen.Checked),
				CommonUtility.ParseInt32OrZero(textBoxDongDC.Text)
			};
			int[] array3 = new int[2]
			{
				Convert.ToByte(checkBoxNgocBoi.Checked),
				CommonUtility.ParseInt32OrZero(textBoxDongNB.Text)
			};
			...
			int num7 = CommonUtility.ParseInt32OrZero(comboBoxCap.Text);
			...
			for (int n = 0; n < Form1.characterAccountConfig_1.Length; n++)
			{
				...
				try
				{
					for (int num8 = 0; num8 < Form1.characterAccountConfig_1[n].itemAttributeFilterRule_0.Length; num8++)
					{
						...
						Form1.characterAccountConfig_1[n].itemAttributeFilterRule_0[num8].int_2 = CommonUtility.ParseInt32OrZero(listView1.Items[n].SubItems[2].Text);
					}
				}
				catch
				{
	...
	private void buttonS_Click(object sender, EventArgs e)
	{
		...
		string text = GameTextEncodingHelper.ConvertGameTextToDisplayText(Form1.characterAccountConfig_1[num].string_22, 1);
		...
		{
			CommonUtility.WriteAllTextWithEncodingOption(text4, text2, 2);
		}
	}
