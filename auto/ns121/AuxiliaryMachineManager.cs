...
public class AuxiliaryMachineManager : Form
{
	...
	public static void smethod_1(string string_5)
	{
		...
		CombatTargetSelectionHelper.int_1 = CommonUtility.smethod_11(array[0]);
		CombatTargetSelectionHelper.int_2 = CommonUtility.smethod_11(array[1]);
		CombatTargetSelectionHelper.int_3 = CommonUtility.smethod_11(array[2]);
		if (array.Length > 3)
		{
	...
	public static void smethod_4(int int_7)
	{
		...
		while (true)
		{
			...
			if (Form1.int_12 > 0 && CommonUtility.smethod_28(num5) >= 2500 + int_2)
			{
	...
	public static void smethod_5(CharacterAccountConfig characterAccountConfig_0)
	{
		...
		if (GClass1.long_1 != 0L && !bool_1)
		{
			...
			if (text != null && text.Length >= 10)
			{
				...
				if (text2 != null && !(text2 == string.Empty))
				{
					...
					if (0 <= num2)
					{
						...
						if (array.Length >= 3 && array[2] != null && !(array[2] == string.Empty) && (Form1.int_53 <= 0 || CommonUtility.smethod_11(array[1]) == Form1.int_54))
						{
			...
			if (CommonUtility.smethod_28(CharacterStateSyncCoordinator.characterSyncSnapshot_1.long_1) > 6000L)
			{
				...
				CharacterStateSyncCoordinator.characterSyncSnapshot_1.long_1 = CommonUtility.smethod_27();
			}
		}
		else
		{
		...
		if (CommonUtility.smethod_63(CharacterStateSyncCoordinator.characterSyncSnapshot_1.uint_4))
		{
			...
			if (CongThanhQuanTransportCatalog.IsTransportMap(num))
			{
				...
				if (num6 != 10 && num6 != 21 && num7 != 0 && num8 > 1)
				{
					...
					int num9 = (int)WindowsInteropHelper.smethod_30(num5 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, characterAccountConfig_0.int_137);
					long num12;
					byte[] byte_;
	...
	public static int smethod_10(CharacterAccountConfig characterAccountConfig_0, ref long long_2, ref int int_7, ref uint[] uint_0)
	{
		if (CommonUtility.smethod_63(CharacterStateSyncCoordinator.characterSyncSnapshot_1.uint_4))
		{
			...
			if (num5 != 10 && num5 != 21 && num6 != 0 && num7 > 1)
			{
				...
				int num9 = (int)WindowsInteropHelper.smethod_30(num4 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, characterAccountConfig_0.int_137);
	...
	public static int smethod_11(CharacterAccountConfig characterAccountConfig_0, ref bool bool_10, ref long long_2, ref int int_7, ref uint[] uint_0)
	{
		...
		if (num5 != 10 && num5 != 21 && num6 != 0 && num7 > 1)
		{
			...
			if (num9 != CharacterStateSyncCoordinator.characterSyncSnapshot_1.int_4)
			{
				...
				num9 = (int)WindowsInteropHelper.smethod_30(GameConfigurationManager.memorySignatureScanConfig_27.uint_0, characterAccountConfig_0.int_137);
				if (ChienLongDongNavigationHelper.IsChienLongDongMap(num9))
				{
					if (GameProcessInteractionHelper.smethod_3(characterAccountConfig_0, GameProcessInteractionHelper.uint_19, 4) > 0 && MapNavigationHelper.smethod_7(characterAccountConfig_0, CharacterStateSyncCoordinator.characterSyncSnapshot_1.int_4, null, CharacterStateSyncCoordinator.characterSyncSnapshot_1.uint_4))
					{
						int num10 = 0;
						while (num10 < 10)
						{
							if (WindowsInteropHelper.smethod_30(GameConfigurationManager.memorySignatureScanConfig_27.uint_0, characterAccountConfig_0.int_137) == num9)
							{
								num10++;
								Thread.Sleep(100);
								continue;
				...
				else
				{
					...
					if (num9 != 175)
					{
						...
						else
						{
								...
								if (gStruct.int_0 != num9 || gStruct.int_1 != CharacterStateSyncCoordinator.characterSyncSnapshot_1.int_4)
								{
									...
									if (GameProcessInteractionHelper.smethod_3(characterAccountConfig_0, GameProcessInteractionHelper.uint_19, 4) > 0 && !flag)
									{
										...
										if (0 <= num19 && MapNavigationHelper.smethod_7(characterAccountConfig_0, num18))
										{
											...
											Class64.smethod_11(characterAccountConfig_0);
											Thread.Sleep(600);
											int num20 = (int)WindowsInteropHelper.smethod_30(GameConfigurationManager.memorySignatureScanConfig_27.uint_0, characterAccountConfig_0.int_137);
											if (num20 != num9)
											{
												goto IL_0b64;
											}
										...
										else if (num9 != 103 && num9 != 114 && num9 != 110 && (CharacterStateSyncCoordinator.characterSyncSnapshot_1.int_4 == 110 || CharacterStateSyncCoordinator.characterSyncSnapshot_1.int_4 == 114) && MapNavigationHelper.smethod_7(characterAccountConfig_0, 103))
										{
											...
											Class64.smethod_11(characterAccountConfig_0);
											Thread.Sleep(600);
											int num21 = (int)WindowsInteropHelper.smethod_30(GameConfigurationManager.memorySignatureScanConfig_27.uint_0, characterAccountConfig_0.int_137);
											if (num21 != num9)
											{
												goto IL_0b64;
											}
									...
									if (flag2)
									{
										...
										while (num23 < 8)
										{
											int num24 = (int)WindowsInteropHelper.smethod_30(GameConfigurationManager.memorySignatureScanConfig_27.uint_0, characterAccountConfig_0.int_137);
											if (num24 == num9)
											{
												num23++;
												Thread.Sleep(100);
							...
							{
								if (GameProcessInteractionHelper.smethod_3(characterAccountConfig_0, GameProcessInteractionHelper.uint_19, 4) > 0 && MapNavigationHelper.smethod_7(characterAccountConfig_0, CharacterStateSyncCoordinator.characterSyncSnapshot_1.int_4))
								{
									Thread.Sleep(300);
									Class64.smethod_11(characterAccountConfig_0);
									Thread.Sleep(600);
									int num26 = (int)WindowsInteropHelper.smethod_30(GameConfigurationManager.memorySignatureScanConfig_27.uint_0, characterAccountConfig_0.int_137);
									if (num26 != num9)
									{
										return -7;
									}
			...
			if (num30 > Form1.int_27 * Form1.int_27)
			{
				...
				if (num30 >= 810000L)
				{
					...
					if (!CharacterMovementHelper.IsMovementActive(characterAccountConfig_0) || CommonUtility.smethod_28(long_2) > 4000L)
					{
						int_7++;
