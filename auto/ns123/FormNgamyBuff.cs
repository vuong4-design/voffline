...
public class FormNgamyBuff : Form
{
	...
	private void checkBoxnttk_CheckedChanged(object sender, EventArgs e)
	{
		...
		{
			num2 = 1114 * Convert.ToByte(CharacterSkillHelper.ReadSkillLevel(characterAccountConfig_, 1114) > 0);
			num3 = 470;
		}
		if (num2 == 0)
		{
			num2 = 93 * Convert.ToByte(CharacterSkillHelper.ReadSkillLevel(characterAccountConfig_, 93) > 0);
			num3 = 400;
		}
