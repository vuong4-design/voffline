...
public class FormNhiepTT : Form
{
			...
			try
			{
				...
				if (CommonUtility.bool_0 || num < 0 || !Form1.characterAccountConfig_1[num].bool_25 || Form1.characterAccountConfig_1[num].int_123 <= 0)
				{
					if (0 <= num)
					{
						...
						byte[] byte_ = array;
						WindowsInteropHelper.WriteProcessMemory(Form1.characterAccountConfig_1[num].int_137, Form1.characterAccountConfig_1[num].uint_16 + GameProcessInteractionHelper.uint_42 * 4, byte_, 1, ref int_2);
					}
					break;
				}
				if (!flag)
	...
	private static int EnsureHeldItemCanMoveToContainerThree(CharacterAccountConfig characterAccountConfig_0, uint[] uint_0)
	{
		...
		if (uint_0 != null && uint_0[4] != num)
		{
			...
			while (true)
			{
				...
				for (; i < 20; i++)
				{
					WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, GameConfigurationManager.memorySignatureScanConfig_123.resolvedValue, array2, 1, ref int_);
					int num4 = array2[0];
					if (num4 > 0)
					{
						break;
	...
	public static void RunVuotAiRegistrationAutomation(int int_12)
	{
		...
		while (true)
		{
			...
			WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, array, 4, ref int_13);
			...
			if (num2 == num17)
			{
				...
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num21 + GameConfigurationManager.memorySignatureScanConfig_13.resolvedValue, array, 4, ref array2[1]);
				...
				uint num24 = num23 + num22 * GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue;
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num24 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, array, 4, ref array2[3]);
				int num25 = BitConverter.ToInt32(array, 0);
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num24 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array, 4, ref array2[4]);
				...
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num24 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, array, 4, ref array2[5]);
					...
					if (num28 <= 0)
					{
						...
						if (num7 > 0)
						{
							...
							if (num6 >= 3)
							{
								...
								array7 = new uint[2];
								WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num24 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, array, 4, ref int_13);
					...
					while (true)
					{
						...
						while (NpcDialogHelper.GetActiveMenuLayoutState(characterAccountConfig) < 0)
						{
							...
							if (WindowsInteropHelper.ReadProcessUInt32(characterAccountConfig.uint_7 + GameConfigurationManager.memorySignatureScanConfig_172.resolvedValue, characterAccountConfig.int_137) != 0)
							{
								...
								{
									InventoryItemHelper.SubmitDetectedDialogResponse(characterAccountConfig, "1");
								}
								else
								{
						...
						if (num5 <= 0)
						{
							uint num33 = num21 + GameConfigurationManager.memorySignatureScanConfig_12.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_75.resolvedValue;
							WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num33 + GameConfigurationManager.memorySignatureScanConfig_73.resolvedValue, array, 4, ref int_13);
							int num34 = BitConverter.ToInt32(array, 0);
							int num35 = 100000;
							if (num34 < 100000)
							{
								WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num33 + GameConfigurationManager.memorySignatureScanConfig_74.resolvedValue, array, 4, ref int_13);
