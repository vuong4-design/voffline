...
public class FormTangdiem : Form
{
	...
	private void RunPendingPointAllocationWorker()
	{
		...
		catch
		{
			...
			for (int i = 0; i < Form1.characterAccountConfig_1.Length; i++)
			{
				...
				{
					WindowsInteropHelper.WriteProcessMemory(Form1.characterAccountConfig_1[i].int_137, Form1.characterAccountConfig_1[i].uint_16 + GameProcessInteractionHelper.pointAllocationStateSlot * 4, byte_, 1, ref int_);
					break;
				}
			}
		}
	...
	private void ApplyPointAllocationProfileToAccount(int int_7)
	{
		...
		WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, characterAccountConfig_.uint_16 + GameProcessInteractionHelper.pointAllocationStateSlot * 4, array, 1, ref int_8);
		if (array[0] > 0)
		{
			return;
		}
		array[0] = 1;
		WindowsInteropHelper.WriteProcessMemory(characterAccountConfig_.int_137, characterAccountConfig_.uint_16 + GameProcessInteractionHelper.pointAllocationStateSlot * 4, array, 1, ref int_8);
		...
		if (num >= 0)
		{
			...
			while (true)
			{
				...
				if (!flag && array2 != null && array2.Length > num2)
				{
					...
					if (num7 != 0)
					{
						...
						if (num9 <= array3[num2])
						{
							...
							if (num10 > 0)
							{
								WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, characterAccountConfig_.uint_7 + GameConfigurationManager.memorySignatureScanConfig_172.resolvedValue, array, 4, ref int_8);
				...
				uint uint_ = BitConverter.ToUInt32(array, 0) + GameConfigurationManager.memorySignatureScanConfig_71.resolvedValue;
				...
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, num17 + GameConfigurationManager.memorySignatureScanConfig_13.resolvedValue, array, 4, ref int_8);
				uint num18 = BitConverter.ToUInt32(array, 0) * GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue;
				...
				uint num20 = num18 + num19 + GameConfigurationManager.memorySignatureScanConfig_161.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_162.resolvedValue;
				int num21 = 0;
				int num22 = -1;
				while (num21 < 80)
				{
					...
					{
						num20 += GameConfigurationManager.memorySignatureScanConfig_163.resolvedValue;
						continue;
					}
