...
public class FormThuocTocdoDanh : Form
{
	...
	private void method_0(string[] string_1, string[] string_2)
	{
		...
		if (string_2 != null && string_2.Length != 0)
		{
			...
			{
				method_1(listView1, GameTextEncodingHelper.smethod_1(string_2[i], 1));
			}
		}
		if (string_1 != null && string_1.Length != 0)
		{
			...
			{
				method_1(listViewThuong, GameTextEncodingHelper.smethod_1(string_1[j], 1));
			}
		}
	...
	private void comboBoxThuong_MouseDown(object sender, MouseEventArgs e)
	{
		...
		if (string_0 != null)
		{
			for (int i = 0; i < string_0.Length; i++)
			{
				comboBoxThuong.Items.Add(GameTextEncodingHelper.smethod_1(string_0[i], 1));
			}
		}
	}
