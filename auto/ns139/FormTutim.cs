...
public class FormTutim : Form
{
	...
	private void FormTutim_Load(object sender, EventArgs e)
	{
		...
		richTextBox1.Text = text.Replace("|", GameConfigurationManager.lineSeparator);
	...
	private void FindNextMatchingListViewItem()
	{
		...
		CommonUtility.AppendRichTextBoxText(richTextBox1, "Không tìm thấy \"" + textBoxTukhoa.Text + "\"");
	}
