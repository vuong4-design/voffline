...
internal class ShopItemMemoryReader
{
	...
	public static GStruct1 ReadItemByIndex(CharacterAccountConfig characterAccountConfig_0, int int_0)
	{
		...
		Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num + GameConfigurationManager.memorySignatureScanConfig_20.uint_0 - 4, array, 4, ref int_1);
		...
		Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num3 + GameConfigurationManager.memorySignatureScanConfig_18.uint_0, array, 4, ref int_1);
		...
		Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num + GameConfigurationManager.memorySignatureScanConfig_20.uint_0, array, 4, ref int_1);
