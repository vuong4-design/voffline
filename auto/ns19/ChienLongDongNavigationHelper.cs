		...
		while (true)
		{
			...
			if (!Class11.bool_0 && num6 >= 0 && GameInterfaceMemoryHelper.smethod_12(characterAccountConfig_0) <= 0 && GameInterfaceMemoryHelper.smethod_39(characterAccountConfig_0) > 1)
			{
				if (bool_1 || Form1.int_121 > 0)
				{
					...
					{
						uint num7 = Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_11.uint_0, characterAccountConfig_0.int_137);
						if (num7 == 0)
						{
							continue;
						}
						uint num8 = Class24.smethod_30(num7 + GameConfigurationManager.memorySignatureScanConfig_13.uint_0, characterAccountConfig_0.int_137);
						uint num9 = Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_14.uint_0, characterAccountConfig_0.int_137);
						if (num9 == 0)
						{
							continue;
						}
						num10 = num9 + num8 * GameConfigurationManager.memorySignatureScanConfig_15.uint_0;
						int num11 = (int)Class24.smethod_30(num10 + GameConfigurationManager.memorySignatureScanConfig_55.uint_0, characterAccountConfig_0.int_137);
						int num12 = (int)Class24.smethod_30(num10 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, characterAccountConfig_0.int_137);
						...
						int num14 = (int)Class24.smethod_30(num10 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, characterAccountConfig_0.int_137);
			...
			Class24.WriteProcessMemory(characterAccountConfig_0.int_137, num10 + GameConfigurationManager.memorySignatureScanConfig_72.uint_0, bytes, 4, ref int_2);
			Thread.Sleep(100);
			num = 0;
		...
		if (num6 >= 0)
		{
			...
			if (num7 <= 90000L)
			{
				...
				while (true)
				{
					...
					Class24.WriteProcessMemory(characterAccountConfig_0.int_137, num4 + GameConfigurationManager.memorySignatureScanConfig_72.uint_0, bytes, 4, ref int_);
					Thread.Sleep(100);
					for (int i = 0; i < 10; i++)
					{
						Thread.Sleep(150);
