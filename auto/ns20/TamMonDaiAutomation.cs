...
internal class TamMonDaiAutomation
{
	public static void Run(int int_0)
	{
		...
		while (true)
		{
			...
			Class24.ReadProcessMemory(characterAccountConfig.int_137, num17 + GameConfigurationManager.memorySignatureScanConfig_13.uint_0, array3, 4, ref array4[1]);
			...
			Class24.ReadProcessMemory(characterAccountConfig.int_137, num21 + GameConfigurationManager.memorySignatureScanConfig_55.uint_0, array3, 4, ref array4[4]);
			int num22 = BitConverter.ToInt32(array3, 0);
			Class24.ReadProcessMemory(characterAccountConfig.int_137, num21 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, array3, 4, ref array4[5]);
			...
			Class24.ReadProcessMemory(characterAccountConfig.int_137, num21 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, array3, 4, ref array4[7]);
			...
			if ((characterAccountConfig.int_136 != ApplicationRuntimeCoordinator.characterAccountConfig_0.int_136 && characterAccountConfig.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.int_0) || (num26 != 1 && num26 != 2))
			{
				...
				if (num23 != 0 && num22 != 0 && num24 != 0 && num22 != 10 && num22 != 21 && num27 > 1)
				{
					...
					while (true)
					{
						...
						{
							Class24.smethod_30(num21 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_58.uint_0, characterAccountConfig.int_137),
							Class24.smethod_30(num21 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_59.uint_0, characterAccountConfig.int_137)
						};
						...
						if (num2 == num24)
						{
							if (num3 != num25)
							{
								...
								while (num25 == 0 && num29 < 30 && num25 != num3)
								{
									...
									Class24.ReadProcessMemory(characterAccountConfig.int_137, num17 + GameConfigurationManager.memorySignatureScanConfig_13.uint_0, array3, 4, ref int_6);
									...
									num21 = num19 + num20;
									Class24.ReadProcessMemory(characterAccountConfig.int_137, num21 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, array3, 4, ref int_6);
							...
							flag3 = false;
							flag3 = false;
							if (Class24.smethod_30(num21 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, characterAccountConfig.int_137) == 0)
							{
								break;
							}
							...
							if (flag && characterAccountConfig.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.int_0)
							{
								...
								num7 = 0;
								int_1 = 0;
								if (num25 > 0 && !characterAccountConfig.bool_22 && characterAccountConfig.int_93 == 1 && Form1.int_109 > 0 && (Form1.int_35 > 0 || Form1.int_34 > 0 || Form1.int_36 > 0) && Class24.smethod_30(num21 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, characterAccountConfig.int_137) != 0)
								{
								...
								if (num11 <= 0L || Class11.smethod_28(num11) >= 1500L)
								{
									...
									if (CharacterStateSyncCoordinator.smethod_5(num4, ref array5, ref uint_2) > 0)
									{
										...
										if (num14 > 0)
										{
											Class24.WriteProcessMemory(characterAccountConfig.int_137, num21 + GameConfigurationManager.memorySignatureScanConfig_72.uint_0, byte_, 4, ref int_6);
										}
										num14 = 0;
							...
							else
							{
								...
								if (flag11)
								{
									...
									num22 = (int)Class24.smethod_30(num21 + GameConfigurationManager.memorySignatureScanConfig_55.uint_0, characterAccountConfig.int_137);
									if (num22 < 3)
									{
										array5 = new uint[2]
										{
						...
						while (num2 != num24)
						{
							...
							num19 = BitConverter.ToUInt32(array3, 0);
							num21 = num19 + num20;
							Class24.ReadProcessMemory(characterAccountConfig.int_137, num21 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, array3, 4, ref int_6);
						...
						if (flag10)
						{
							...
							{
								num24 = (int)Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_27.uint_0, characterAccountConfig.int_137);
								array5 = new uint[2]
								{
									Class24.smethod_30(num21 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_58.uint_0, characterAccountConfig.int_137),
									Class24.smethod_30(num21 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_59.uint_0, characterAccountConfig.int_137)
								...
								if (characterAccountConfig.int_119 > 0 && characterAccountConfig.int_3 != null)
								{
									...
									if (array9 != null && array9[0, 0] >= 0)
									{
										...
										while (true)
										{
											...
											num22 = (int)Class24.smethod_30(num21 + GameConfigurationManager.memorySignatureScanConfig_55.uint_0, characterAccountConfig.int_137);
											num23 = (int)Class24.smethod_30(num21 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, characterAccountConfig.int_137);
											num25 = (int)Class24.smethod_30(num21 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, characterAccountConfig.int_137);
											...
											if (num25 > 0 && num24 == num50 && num22 != 11 && num22 != 22 && num23 != 0)
											{
												for (int j = 0; j < array9.GetLength(0); j++)
												{
													...
													Class24.ReadProcessMemory(characterAccountConfig.int_137, num49 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, array3, 4, ref int_6);
													...
													if (num32 > 0)
													{
														Class24.ReadProcessMemory(characterAccountConfig.int_137, num49 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, array3, 4, ref int_6);
														if (BitConverter.ToInt32(array3, 0) <= 0)
														{
															continue;
														}
													...
													if (!flag13 || num32 > 0)
													{
														...
														num31 = num48;
														Class24.ReadProcessMemory(characterAccountConfig.int_137, num49 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_58.uint_0, array3, 4, ref int_6);
														array6[0] = BitConverter.ToUInt32(array3, 0);
														Class24.ReadProcessMemory(characterAccountConfig.int_137, num49 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_59.uint_0, array3, 4, ref int_6);
														...
														Class24.WriteProcessMemory(characterAccountConfig.int_137, num21 + GameConfigurationManager.memorySignatureScanConfig_161.uint_0 - 8, BitConverter.GetBytes(num47), 4, ref int_6);
														Class24.WriteProcessMemory(characterAccountConfig.int_137, num21 + GameConfigurationManager.memorySignatureScanConfig_31.uint_0, BitConverter.GetBytes(num31), 4, ref int_6);
														Class24.WriteProcessMemory(characterAccountConfig.int_137, num21 + GameConfigurationManager.memorySignatureScanConfig_72.uint_0, BitConverter.GetBytes(num33), 4, ref int_6);
														Thread.Sleep(10);
														num14 = 1;
														continue;
													}
											...
											if (num14 <= 0 && characterAccountConfig.int_6 <= 0 && flag12)
											{
												...
												Class24.WriteProcessMemory(characterAccountConfig.int_137, num21 + GameConfigurationManager.memorySignatureScanConfig_161.uint_0 - 8, BitConverter.GetBytes(CharacterSkillHelper.smethod_13(characterAccountConfig)), 4, ref int_6);
												Class24.WriteProcessMemory(characterAccountConfig.int_137, num21 + GameConfigurationManager.memorySignatureScanConfig_31.uint_0, BitConverter.GetBytes(num31), 4, ref int_6);
												Class24.WriteProcessMemory(characterAccountConfig.int_137, num21 + GameConfigurationManager.memorySignatureScanConfig_72.uint_0, BitConverter.GetBytes(num33), 4, ref int_6);
											}
									...
									else
									{
										...
										while (true)
										{
											...
											if (Form1.int_56 > 0 && (num32 <= 0 || num32 == array2[0]) && array2[1] > 0 && array2[2] == num24 && array2[3] > 0)
											{
												...
												Class24.ReadProcessMemory(characterAccountConfig.int_137, num70 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, array3, 4, ref int_6);
												if (BitConverter.ToInt32(array3, 0) > 0)
												{
													Class24.ReadProcessMemory(characterAccountConfig.int_137, num70 + GameConfigurationManager.memorySignatureScanConfig_45.uint_0, array3, 4, ref int_6);
													long num71 = BitConverter.ToInt32(array3, 0);
													if ((ulong)num71 > 0uL)
													{
														Class24.ReadProcessMemory(characterAccountConfig.int_137, num70 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, array3, 4, ref int_6);
														if (num68 <= 0 || BitConverter.ToInt32(array3, 0) > 0)
														{
															array6 = new uint[2]
															{
																Class24.smethod_30(num70 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_58.uint_0, characterAccountConfig.int_137),
																Class24.smethod_30(num70 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_59.uint_0, characterAccountConfig.int_137)
															};
											...
											if (characterAccountConfig.gstruct50_0.int_0 == 0 || CombatTargetSelectionHelper.smethod_10(characterAccountConfig, (uint)num33) <= 0)
											{
												...
												Class24.WriteProcessMemory(characterAccountConfig.int_137, num21 + GameConfigurationManager.memorySignatureScanConfig_161.uint_0 - 8, BitConverter.GetBytes(value), 4, ref int_6);
												Class24.WriteProcessMemory(characterAccountConfig.int_137, num21 + GameConfigurationManager.memorySignatureScanConfig_31.uint_0, BitConverter.GetBytes(num31), 4, ref int_6);
												Class24.WriteProcessMemory(characterAccountConfig.int_137, num21 + GameConfigurationManager.memorySignatureScanConfig_72.uint_0, BitConverter.GetBytes(num33), 4, ref int_6);
											}
						...
						if (num80 != 0 && characterAccountConfig.int_136 != ApplicationRuntimeCoordinator.characterAccountConfig_0.int_136)
						{
							...
							{
								Class24.smethod_30(num21 + GameConfigurationManager.memorySignatureScanConfig_31.uint_0, characterAccountConfig.int_137);
			...
			else
			{
				...
				if (Form1.int_127 > 0)
				{
					Class24.WriteProcessMemory(characterAccountConfig.int_137, num21 + GameConfigurationManager.memorySignatureScanConfig_251.uint_0, GameConfigurationManager.byte_0, GameConfigurationManager.byte_0.Length, ref int_6);
				}
				num14 = 0;
				num15 = 0;
			}
