...
internal class WindowsInteropHelper
{
	...
	public static int smethod_8(int int_41, uint uint_11, string string_0, uint uint_12 = 0u, bool bool_0 = true, bool bool_1 = true)
	{
		if (string_0 != null && !(string_0 == ""))
		{
			...
			if (num > 0)
			{
				string text = GameTextEncodingHelper.ConvertGameTextToDisplayText(string_0, 1, bool_0: true);
	...
	public static void smethod_71(string string_0 = null, bool bool_0 = true)
	{
		try
		{
			...
			string text3 = WindowsRegistryHelper.ReadRegistryValueAsString(string_1, string_0, 0);
			string text4 = WindowsRegistryHelper.ReadRegistryValueAsString(string_1, string_0, 1);
			...
			WindowsRegistryHelper.SetRegistryValue(string_1, string_0, text, "", 0);
			WindowsRegistryHelper.SetRegistryValue(string_1, string_0, text, "", 1);
		}
		catch
		{
		}
	...
	public static void smethod_72()
	{
		...
		WindowsRegistryHelper.SetRegistryValue(string_, string_2, ".exe;.bat;.cmd;.vbs", "", 0);
		WindowsRegistryHelper.SetRegistryValue(string_, string_2, ".exe;.bat;.cmd;.vbs", "", 1);
	}
