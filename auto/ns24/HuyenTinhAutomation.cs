...
internal class HuyenTinhAutomation
{
	...
	public void UpgradeHuyenTinh()
	{
		...
		while (true)
		{
			...
			int num8 = (int)WindowsInteropHelper.ReadProcessUInt32(num7 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, characterAccountConfig_.int_137);
			int num9 = (int)WindowsInteropHelper.ReadProcessUInt32(num7 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, characterAccountConfig_.int_137);
			int num10 = GameInterfaceMemoryHelper.ReadGatewayConnectionState(characterAccountConfig_);
			if (num8 == 10 || num8 == 21 || num9 == 0 || num10 <= 1)
			{
				continue;
			}
			uint num11 = num4 + GameConfigurationManager.memorySignatureScanConfig_12.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_75.resolvedValue;
			if (!flag)
			{
				num3 = CharacterAccountListHelper.FindAccountIndexById(Form1.characterAccountConfig_1, num);
				if (0 <= num3)
				...
				long num13 = WindowsInteropHelper.ReadProcessUInt32(num11 + GameConfigurationManager.memorySignatureScanConfig_74.resolvedValue, characterAccountConfig_.int_137);
				if (num13 > 0L)
				{
			...
			uint num14 = num4 + GameConfigurationManager.memorySignatureScanConfig_97.resolvedValue;
			uint num15 = WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_105.resolvedValue, characterAccountConfig_.int_137);
			int num16 = -1;
			for (int i = 1; i < 10; i++)
			{
			...
			while (true)
			{
				...
				{
					WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, num14 + (num20 * 5 + GameConfigurationManager.memorySignatureScanConfig_99.resolvedValue) * 4, array3, 4, ref int_);
					uint num21 = BitConverter.ToUInt32(array3, 0);
					if (num21 != 0)
					{
						uint num22 = num15 + num21 * GameConfigurationManager.memorySignatureScanConfig_106.resolvedValue;
						WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_106.resolvedValue - 4, array3, 4, ref int_);
						if (BitConverter.ToInt32(array3, 0) == 0)
						{
							WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_107.resolvedValue, array2, 1, ref int_);
							if (array2[0] != 0)
							{
								num19++;
								uint num23 = num14 + num20 * 20;
								WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, num23 + GameConfigurationManager.memorySignatureScanConfig_100.resolvedValue - 8, array2, 1, ref int_);
								uint num24 = array2[0];
								if (num24 == 1 || num24 == 3)
								{
									WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_108.resolvedValue, array2, 1, ref int_);
									if (array2[0] == 6)
									{
										WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_111.resolvedValue, array2, 1, ref int_);
										int num25 = array2[0];
										WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_112.resolvedValue, array2, 1, ref int_);
										int num26 = array2[0];
										if (num25 == 1 && num26 == 1)
										{
											WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_119.resolvedValue, array3, 4, ref int_);
											int num27 = BitConverter.ToInt32(array3, 0);
											if (num27 > 0)
											{
												WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_114.resolvedValue, array2, 1, ref int_);
												if (array2[0] == num16)
												{
													WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_107.resolvedValue, array, array.Length, ref int_);
													...
													if (CommonUtility.FindSubstringIndex(string_, text) >= 0)
													{
														if (num27 != 1)
														{
															...
															if (array6 != null)
															{
																...
																{
																	int num28 = 0;
																	while (!CommonUtility.bool_0 && WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_123.resolvedValue, characterAccountConfig_.int_137) == 0)
																	{
																		if (num28 % 20 == 0)
																		{
																...
																int num29 = 0;
																while (!CommonUtility.bool_0 && (int)WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_123.resolvedValue, characterAccountConfig_.int_137) > 0)
																{
																	if (num29 % 20 == 0)
																	{
	...
	public void CraftHuyenTinh()
	{
		...
		while (true)
		{
			...
			if (num2 <= 0)
			{
				...
				int_ = (int)WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, characterAccountConfig_.int_137);
				num2 = 10;
			}
			WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, GameConfigurationManager.memorySignatureScanConfig_11.resolvedValue, array, 4, ref int_2);
			uint num9 = BitConverter.ToUInt32(array, 0);
			WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, GameConfigurationManager.memorySignatureScanConfig_105.resolvedValue, array, 4, ref int_2);
			...
			while (num14 < GameConfigurationManager.int_1)
			{
				if (array2[0] == 0 || array2[1] == 0 || array2[2] == 0)
				{
					...
					WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, num11 + (num14 * 5 + GameConfigurationManager.memorySignatureScanConfig_99.resolvedValue) * 4, array, 4, ref int_2);
					uint num15 = BitConverter.ToUInt32(array, 0);
					if (num15 != 0)
					{
						uint num16 = num10 + num15 * GameConfigurationManager.memorySignatureScanConfig_106.resolvedValue;
						WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, num16 + GameConfigurationManager.memorySignatureScanConfig_106.resolvedValue - 4, array, 4, ref int_2);
						if (BitConverter.ToInt32(array, 0) == 0)
						{
							WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, num16 + GameConfigurationManager.memorySignatureScanConfig_107.resolvedValue, array, 1, ref int_2);
							if (array[0] != 0)
							{
								num13++;
								uint num17 = num11 + num14 * 20;
								WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, num17 + GameConfigurationManager.memorySignatureScanConfig_100.resolvedValue - 8, array, 1, ref int_2);
								uint num18 = array[0];
								if (num18 == 3 || (num18 == 23 && UseGuildStorageMaterials > 0))
								{
									WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, num16 + GameConfigurationManager.memorySignatureScanConfig_108.resolvedValue, array, 1, ref int_2);
									if (array[0] == 0)
									{
										WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_.int_137, num16 + GameConfigurationManager.memorySignatureScanConfig_110.resolvedValue, array, 1, ref int_2);
										uint num19 = array[0];
