...
internal class GameEntityMemoryHelper
{
	...
	public static int smethod_2(CharacterAccountConfig characterAccountConfig_0, uint uint_0)
	{
		...
		Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num2 + GameConfigurationManager.memorySignatureScanConfig_85.uint_0, array, 4, ref int_);
		return BitConverter.ToInt32(array, 0);
	}

	private static uint smethod_3(CharacterAccountConfig characterAccountConfig_0, int int_0, uint uint_0)
	{
		uint num = Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_14.uint_0, characterAccountConfig_0.int_137) + (uint)(int)(int_0 * GameConfigurationManager.memorySignatureScanConfig_15.uint_0);
	...
	public static int smethod_13(CharacterAccountConfig characterAccountConfig_0, string string_0, int int_0 = -1, bool bool_0 = false, int int_1 = -1, int int_2 = 80)
	{
		if (string_0 != null && !(string_0 == ""))
		{
			...
			uint num4 = num3 + num2;
			int num5 = (int)Class24.smethod_30(num4 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_58.uint_0, characterAccountConfig_0.int_137);
			int num6 = (int)Class24.smethod_30(num4 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_59.uint_0, characterAccountConfig_0.int_137);
			int int_3 = 0;
			...
			for (uint num10 = 1u; num10 < 256 && num7 > num9; num10++)
			{
				...
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num11 + GameConfigurationManager.memorySignatureScanConfig_16.uint_0, array4, 4, ref int_3);
				if (array4[0] == 0)
				{
					continue;
				}
				num9++;
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num11 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, array4, 4, ref int_3);
				...
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num11 + GameConfigurationManager.memorySignatureScanConfig_16.uint_0, array3, array3.Length, ref int_3);
				...
				{
					int num13 = (int)Class24.smethod_30(num11 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_58.uint_0, characterAccountConfig_0.int_137);
					int num14 = (int)Class24.smethod_30(num11 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_59.uint_0, characterAccountConfig_0.int_137);
					if (num13 > 0 && num14 > 0)
					{
		...
		if (string_0 != null && !(string_0 == string.Empty))
		{
			...
			if (num2 > 0)
			{
				...
				for (uint num4 = 1u; num4 < 256; num4++)
				{
					...
					Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num5 + GameConfigurationManager.memorySignatureScanConfig_16.uint_0, array2, 4, ref int_1);
					if (array2[0] == 0)
					{
						continue;
					}
					num3++;
					Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num5 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, array2, 4, ref int_1);
					if (BitConverter.ToInt32(array2, 0) > 0 && Class24.smethod_30(num5 + GameConfigurationManager.memorySignatureScanConfig_52.uint_0, characterAccountConfig_0.int_137) == int_0)
					{
						Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num5 + GameConfigurationManager.memorySignatureScanConfig_16.uint_0, array, array.Length, ref int_1);
	...
	public static int smethod_15(CharacterAccountConfig characterAccountConfig_0, string string_0, ref uint[] uint_0, int int_0 = 3, bool bool_0 = true, int int_1 = -1, int[] int_2 = null)
	{
		...
		if (string_0 != null && !(string_0 == string.Empty))
		{
			...
			for (uint num10 = 1u; num10 < 256; num10++)
			{
				...
				num9++;
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num11 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, array4, 4, ref int_3);
				if (BitConverter.ToInt32(array4, 0) <= 0 || Class24.smethod_30(num11 + GameConfigurationManager.memorySignatureScanConfig_52.uint_0, characterAccountConfig_0.int_137) != int_0)
				{
					continue;
				}
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num11 + GameConfigurationManager.memorySignatureScanConfig_16.uint_0, array3, array3.Length, ref int_3);
	...
	public static string smethod_16(CharacterAccountConfig characterAccountConfig_0, int int_0, ref uint[] uint_0, int int_1 = 60)
	{
		...
		if ((int)Class24.smethod_30(num3 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, characterAccountConfig_0.int_137) <= 0)
		{
			return string.Empty;
		}
		int int_2 = 0;
		byte[] array = new byte[1];
		Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num3 + GameConfigurationManager.memorySignatureScanConfig_16.uint_0, array, 1, ref int_2);
		if (array[0] == 0)
		{
			return string.Empty;
		}
		array = new byte[int_1];
		Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num3 + GameConfigurationManager.memorySignatureScanConfig_16.uint_0, array, int_1, ref int_2);
		uint_0 = new uint[2]
		{
			Class24.smethod_30(num3 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_58.uint_0, characterAccountConfig_0.int_137),
			Class24.smethod_30(num3 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_59.uint_0, characterAccountConfig_0.int_137)
		};
	...
	public static bool smethod_17(CharacterAccountConfig characterAccountConfig_0, int int_0)
	{
		...
		int int_1 = 0;
		byte[] array = new byte[4];
		Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num3 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, array, 4, ref int_1);
	...
	public static int smethod_18(CharacterAccountConfig characterAccountConfig_0, string string_0, ref uint[] uint_0, int int_0 = 60000, uint[] uint_1 = null)
	{
		...
		for (uint num11 = 1u; num11 < 256; num11++)
		{
			...
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num12 + GameConfigurationManager.memorySignatureScanConfig_16.uint_0, array3, 4, ref int_1);
			if (array3[0] == 0)
			{
				continue;
			}
			num10++;
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num12 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, array3, 4, ref int_1);
			if (BitConverter.ToInt32(array3, 0) <= 0 || Class24.smethod_30(num12 + GameConfigurationManager.memorySignatureScanConfig_52.uint_0, characterAccountConfig_0.int_137) != 3)
			{
				continue;
			}
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num12 + GameConfigurationManager.memorySignatureScanConfig_16.uint_0, array2, 1, ref int_1);
			if (array2[0] != array[0])
			{
				continue;
			}
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num12 + GameConfigurationManager.memorySignatureScanConfig_16.uint_0, array2, array2.Length, ref int_1);
	...
	public static string smethod_23(CharacterAccountConfig characterAccountConfig_0, int int_0)
	{
		...
		byte[] array2 = new byte[4];
		Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num2 + GameConfigurationManager.memorySignatureScanConfig_88.uint_0, array2, 4, ref int_1);
		uint num3 = BitConverter.ToUInt32(array2, 0);
		if (num3 != 0)
		{
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num2 + GameConfigurationManager.memorySignatureScanConfig_89.uint_0, array, array.Length, ref int_1);
	...
	public static void smethod_24(CharacterAccountConfig characterAccountConfig_0, ref string[] string_0)
	{
		...
		for (uint num4 = 1u; num4 < 256; num4++)
		{
			...
			uint num5 = num + num4 * GameConfigurationManager.memorySignatureScanConfig_15.uint_0;
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num5 + GameConfigurationManager.memorySignatureScanConfig_16.uint_0, array2, 4, ref int_);
			if (array2[0] == 0)
			{
				continue;
			}
			num3++;
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num5 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, array2, 4, ref int_);
			if (BitConverter.ToInt32(array2, 0) <= 0)
			{
				continue;
			}
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num5 + GameConfigurationManager.memorySignatureScanConfig_88.uint_0, array2, 4, ref int_);
			uint num6 = BitConverter.ToUInt32(array2, 0);
			if (num6 == 0)
			{
				continue;
			}
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num5 + GameConfigurationManager.memorySignatureScanConfig_89.uint_0, array, array.Length, ref int_);
			string text = GameTextEncodingHelper.smethod_3(array);
	...
	public static void smethod_25(CharacterAccountConfig characterAccountConfig_0, ref string[] string_0, int int_0 = -1, string[] string_1 = null)
	{
		...
		for (uint num4 = 1u; num4 < 256 && num2 > num3; num4++)
		{
			...
			if (0 <= int_0)
			{
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num5 + GameConfigurationManager.memorySignatureScanConfig_52.uint_0, array2, 4, ref int_1);
				uint num6 = BitConverter.ToUInt32(array2, 0);
				if (num6 != int_0)
				{
					continue;
	...
	public static void smethod_26(CharacterAccountConfig characterAccountConfig_0, ref GStruct25[] gstruct25_0, int int_0 = -1, string[] string_0 = null)
	{
		...
		Class24.ReadProcessMemory(characterAccountConfig_0.int_137, uint_, array2, 4, ref int_1);
		int num2 = BitConverter.ToInt32(array2, 0);
		Class24.ReadProcessMemory(characterAccountConfig_0.int_137, GameConfigurationManager.memorySignatureScanConfig_27.uint_0, array2, 4, ref int_1);
		...
		for (uint num4 = 1u; num4 < 256 && num2 > num3; num4++)
		{
			...
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num5 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_58.uint_0, array2, 4, ref int_1);
			uint num7 = BitConverter.ToUInt32(array2, 0);
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num5 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_59.uint_0, array2, 4, ref int_1);
	...
	public static int smethod_31(CharacterAccountConfig characterAccountConfig_0, int int_0, int int_1)
	{
		...
		{
			uint num5 = Class24.smethod_30(num3 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_2.uint_0 + GameConfigurationManager.memorySignatureScanConfig_3.uint_0 * num4, characterAccountConfig_0.int_137);
			if (num5 == num)
			{
				return num;
			}
