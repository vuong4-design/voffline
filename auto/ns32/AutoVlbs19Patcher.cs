...
internal class AutoVlbs19Patcher
{
	...
	public void LaunchAndPatch()
	{
		...
		{
			if (HardwareLicenseIdentity.hardwareAuthorizationValid && CommonUtility.long_0 >= LicenseRuntimeCoordinator.networkTimeTicks && LicenseRuntimeCoordinator.networkTimeTicks > 0L)
			{
				uint num = 4194304u;
				uint num2 = 4194304u;
				uint num3 = 4319353u;
				...
				NativeProcessInformation gStruct = WindowsInteropHelper.LaunchProcess(text, array3[0]);
