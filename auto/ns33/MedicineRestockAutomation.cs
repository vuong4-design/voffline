...
internal class MedicineRestockAutomation
{
	...
	public static int BuyFromKtcTab(CharacterAccountConfig characterAccountConfig_0, string string_0, string string_1, int int_0)
	{
		...
		if (array2 != null && array2.Length != 0)
		{
			...
			{
				int k = 0;
				uint num4 = WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_165.resolvedValue, characterAccountConfig_0.int_137);
				for (; k < 4; k++)
				{
					uint num5 = WindowsInteropHelper.ReadProcessUInt32(num4 + GameConfigurationManager.memorySignatureScanConfig_167.resolvedValue, characterAccountConfig_0.int_137);
					if (num5 != 0)
					{
						uint num6 = WindowsInteropHelper.ReadProcessUInt32(num5 + (uint)(k * 4), characterAccountConfig_0.int_137);
						if (num6 != 0 && WindowsInteropHelper.ReadProcessUInt32(num6, characterAccountConfig_0.int_137) != 0)
						{
				...
				for (int l = 1; l < 60; l++)
				{
					...
					uint num9 = WindowsInteropHelper.ReadProcessUInt32(num4 + GameConfigurationManager.memorySignatureScanConfig_167.resolvedValue, characterAccountConfig_0.int_137);
					if (num9 == 0)
					{
						continue;
					}
					uint num10 = WindowsInteropHelper.ReadProcessUInt32(num9, characterAccountConfig_0.int_137);
					if (num10 != 0)
					{
			...
			if (TongKimBattlefieldHelper.FindBattlefieldMapMatrixPosition(int_2) == null)
			{
				...
				while (true)
				{
					...
					if (!CommonUtility.bool_0 && num26 >= 0 && Form1.characterAccountConfig_1[num26].bool_25 && !Form1.pauseAllPurchasesEnabled)
					{
						...
						WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num27 + GameConfigurationManager.memorySignatureScanConfig_13.resolvedValue, array, 4, ref int_);
						uint num28 = BitConverter.ToUInt32(array, 0) * GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue;
						...
						num30 = num29 + num28;
						WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num30 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array, 4, ref int_);
						int num31 = BitConverter.ToInt32(array, 0);
						WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num30 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, array, 4, ref int_);
						int num32 = BitConverter.ToInt32(array, 0);
						WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num30 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, array, 4, ref int_);
						num33 = BitConverter.ToInt32(array, 0);
						WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, array, 4, ref int_);
						int_2 = BitConverter.ToInt32(array, 0);
						int num34 = GameInterfaceMemoryHelper.ReadGatewayConnectionState(characterAccountConfig_0);
						if (num31 != 0 && num32 != 0 && int_2 != 0 && num34 > 1 && num32 != 10 && num32 != 21)
						{
							...
							if (num35 != 0)
							{
								...
								string text5 = WindowsInteropHelper.ReadNullTerminatedUtf7ProcessString(characterAccountConfig_0.uint_7 + GameConfigurationManager.memorySignatureScanConfig_28.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_29.resolvedValue, characterAccountConfig_0.int_137, 20);
								...
								if (num18 > 0)
								{
									string text6 = GameEntityMemoryHelper.GetEntityNameAndPositionByIndex(characterAccountConfig_0, num18, ref uint_, 40);
									if (text6 == text2)
									{
										goto IL_0810;
									}
					...
					int k = 0;
					uint num41 = WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_165.resolvedValue, characterAccountConfig_0.int_137);
					for (; k < 6; k++)
					{
						uint num42 = WindowsInteropHelper.ReadProcessUInt32(num41 + GameConfigurationManager.memorySignatureScanConfig_167.resolvedValue, characterAccountConfig_0.int_137);
						if (num42 != 0)
						{
							uint num43 = WindowsInteropHelper.ReadProcessUInt32(num42 + (uint)(k * 4), characterAccountConfig_0.int_137);
							if (num43 != 0 && WindowsInteropHelper.ReadProcessUInt32(num43, characterAccountConfig_0.int_137) != 0)
							{
								GameProcessInteractionHelper.ExecuteRemoteStub(characterAccountConfig_0.int_137, characterAccountConfig_0.uint_56);
								Thread.Sleep(300);
							}
					...
					for (int l = 0; l < num20; l++)
					{
						...
						if (num44 <= 3)
						{
							uint num46 = WindowsInteropHelper.ReadProcessUInt32(num41 + GameConfigurationManager.memorySignatureScanConfig_167.resolvedValue, characterAccountConfig_0.int_137);
							if (num46 == 0)
							{
								continue;
							}
							uint num47 = WindowsInteropHelper.ReadProcessUInt32(num46, characterAccountConfig_0.int_137);
							if (num47 == 0)
							{
								continue;
							}
					...
					if (characterAccountConfig_0.int_70 > 0)
					{
						...
						if (num4 < 3 && int_2 != 13 && GameProcessInteractionHelper.ReadSharedSlotIntegerValue(characterAccountConfig_0, GameProcessInteractionHelper.uint_19, 4) > 0)
						{
							num4++;
					...
					else
					{
						...
						else if (!flag)
						{
							...
							if (uint_ == null)
							{
								uint_ = MapTravelDataHelper.FindNearestNamedMapPointCoordinates(array4, int_2, "HIEUTHUOC");
							}
						}
						else
						{
						...
						while (num18 > 0)
						{
							...
							while (true)
							{
								...
								if (num11 < 3)
								{
									...
									uint num59 = num27 + GameConfigurationManager.memorySignatureScanConfig_12.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_75.resolvedValue;
									long num60 = WindowsInteropHelper.ReadProcessUInt32(num59 + GameConfigurationManager.memorySignatureScanConfig_74.resolvedValue, characterAccountConfig_0.int_137);
									if (num60 > 0L)
									{
										if (Form1.int_67[0] > 0)
										{
		...
		if (string_0 != null && !(string_0 == string.Empty))
		{
			...
			for (uint num8 = 1u; num8 < GameConfigurationManager.int_1; num8++)
			{
				...
				if (!CommonUtility.bool_0)
				{
					...
					WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num10 + GameConfigurationManager.memorySignatureScanConfig_99.resolvedValue * 4, array2, 4, ref int_);
					...
					WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num12 + GameConfigurationManager.memorySignatureScanConfig_106.resolvedValue - 4, array2, 4, ref int_);
					if (BitConverter.ToInt32(array2, 0) != 0)
					{
						continue;
					}
					WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num12 + GameConfigurationManager.memorySignatureScanConfig_107.resolvedValue, array2, 1, ref int_);
					if (array2[0] == 0)
					{
						continue;
					}
					...
					WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num10 + GameConfigurationManager.memorySignatureScanConfig_100.resolvedValue - 8, array2, 1, ref int_);
					uint num13 = array2[0];
					if (num13 != 3 && num13 != 1)
					{
						continue;
					}
					WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num12 + GameConfigurationManager.memorySignatureScanConfig_108.resolvedValue, array2, 1, ref int_);
					if (array2[0] == 0)
					{
						continue;
					}
					WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num12 + GameConfigurationManager.memorySignatureScanConfig_107.resolvedValue, array3, array3.Length, ref int_);
					...
					WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num10 + GameConfigurationManager.memorySignatureScanConfig_100.resolvedValue - 4, array2, 1, ref int_);
					uint uint_ = array2[0];
					WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num10 + GameConfigurationManager.memorySignatureScanConfig_100.resolvedValue, array2, 1, ref int_);
					uint uint_2 = array2[0];
					WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num12 + GameConfigurationManager.memorySignatureScanConfig_111.resolvedValue, array2, 1, ref int_);
					...
					if (array4 != null)
					{
						...
						for (l = 0; l < 120; l++)
						{
							...
							WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num10 + GameConfigurationManager.memorySignatureScanConfig_100.resolvedValue - 8, array2, 4, ref int_);
