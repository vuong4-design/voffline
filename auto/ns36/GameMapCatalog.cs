...
internal class GameMapCatalog
{
	...
	public static string GetMapName(int int_0, bool bool_0 = false)
	{
		for (int i = 0; i < MapEntries.GetLength(0); i++)
		{
			if (MapEntries[i].int_0 == int_0)
			{
				...
				return Class1.smethod_1(string_, 1);
			}
		}
		return "";
	}
	...
	public static string ReadCurrentMapName(CharacterAccountConfig characterAccountConfig_0)
	{
		...
		{
			uint uint_ = characterAccountConfig_0.uint_7 + Class56.memorySignatureScanConfig_28.uint_0 + Class56.memorySignatureScanConfig_29.uint_0;
			return Class24.smethod_28(uint_, characterAccountConfig_0.int_137, 60);
		}
		return "";
	}
}
