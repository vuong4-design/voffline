...
internal class CongThanhChienTamTruAutomation
{
	...
	public static void Run(int int_1)
	{
		...
		while (true)
		{
			...
			if (!characterAccountConfig.bool_15 && GameProcessInteractionHelper.ReadSharedSlotIntegerValue(characterAccountConfig, GameProcessInteractionHelper.clickNpcAutomationActiveSlot, 4) <= 0)
			{
				...
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num19 + GameConfigurationManager.memorySignatureScanConfig_13.resolvedValue, array4, 4, ref array5[1]);
				uint num20 = BitConverter.ToUInt32(array4, 0);
				uint num21 = num20 * GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue;
				...
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num23 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, array4, 4, ref array5[4]);
				int num24 = BitConverter.ToInt32(array4, 0);
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num23 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array4, 4, ref array5[5]);
							...
							while (true)
							{
								...
								if (num12 == num26 && (num6 == CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId || Form1.findMainAccountEnabled <= 0))
								{
									if (num11 != num27)
									{
										...
										{
											WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, GameConfigurationManager.memorySignatureScanConfig_11.resolvedValue, array4, 4, ref int_7);
											num19 = BitConverter.ToUInt32(array4, 0);
											WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num19 + GameConfigurationManager.memorySignatureScanConfig_13.resolvedValue, array4, 4, ref int_7);
											num20 = BitConverter.ToUInt32(array4, 0);
											num21 = num20 * GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue;
											WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, GameConfigurationManager.memorySignatureScanConfig_14.resolvedValue, array4, 4, ref int_7);
											num22 = BitConverter.ToUInt32(array4, 0);
											num23 = num22 + num21;
											WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num23 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, array4, 4, ref int_7);
									...
									if (num27 > 0 && num26 == int_0)
									{
										flag = false;
										flag = false;
										if (WindowsInteropHelper.ReadProcessUInt32(num23 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, characterAccountConfig.int_137) == 0)
										{
											break;
										}
										...
										flag10 = Form1.findMainAccountEnabled > 0 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId > 0 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId != characterAccountConfig.int_136 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.entityExistsFlag > 0 && CommonUtility.IsNonZeroCoordinatePair(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates) && CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId == num26 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.fightState > 0;
										...
										if (flag10 && characterAccountConfig.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId)
										{
											array6 = new uint[2]
											{
												WindowsInteropHelper.ReadProcessUInt32(num23 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, characterAccountConfig.int_137),
											...
											num35 = GameAutomationUtility.GetSquaredCoordinateDistance(array6, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates);
											if (characterAccountConfig.int_130[0] > 0 && characterAccountConfig.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId && num27 == CharacterStateSyncCoordinator.characterSyncSnapshot_0.fightState && num27 > 0)
											{
												int num36 = characterAccountConfig.int_130[1] + Form1.mainAccountSearchDistance;
												if (num35 <= num36 * num36 && CircularMovementHelper.MoveToNextPointAroundCenter(characterAccountConfig, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, characterAccountConfig.int_130[1]) > 0)
												{
													goto IL_268d;
												}
											}
											...
											num5 = 0;
											int_3 = 0;
											if (num27 > 0 && !characterAccountConfig.bool_22 && characterAccountConfig.int_93 == 1 && Form1.dismountWhenReadyEnabled > 0 && (Form1.attackMonstersEnabled > 0 || Form1.attackPlayersEnabled > 0 || Form1.prioritizeBossTargetsEnabled > 0) && WindowsInteropHelper.ReadProcessUInt32(num23 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, characterAccountConfig.int_137) != 0)
											{
											...
											if (num9 <= 0L || CommonUtility.GetElapsedMilliseconds(num9) >= 1500L)
											{
												...
												{
													long num38 = GameAutomationUtility.GetSquaredCoordinateDistance(array8, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates);
													long num39 = GameAutomationUtility.GetSquaredCoordinateDistance(array6, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates);
													if (num39 > num15 * num15)
													{
														if (num37 > 0)
														{
															uint[] uint_2 = GameAutomationUtility.GetCoordinateOffsetAlongLine(array6, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, -100);
													...
													if (num16 > 0)
													{
														WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num23 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, byte_, 4, ref int_7);
													}
													num16 = 0;
													CharacterStateSyncCoordinator.MoveTowardCoordinateWithOffset(characterAccountConfig, array6, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, num38 <= 5625L);
													goto IL_261e;
												}
												num9 = 0L;
												if (num16 == 0 && GameAutomationUtility.GetSquaredCoordinateDistance(array8, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates) > Form1.mainAccountSearchDistance * Form1.mainAccountSearchDistance)
												{
													num8++;
													if (num8 > 3)
													{
										...
										else
										{
											if (characterAccountConfig.int_68 != null && characterAccountConfig.int_68[0] > 0 && !AuxiliaryMachineManager.bool_3)
											{
												...
												{
													array9 = GameAutomationUtility.FindConfiguredTargetCharacterCoordinates(characterAccountConfig, ref int_2);
													if (array9 != null)
													{
														num10 = 0L;
														long num40 = GameAutomationUtility.GetSquaredCoordinateDistance(array6, array9);
														if (num40 < 8000L)
														{
															goto IL_0f74;
														}
											...
											if (flag9)
											{
												...
												num24 = (int)WindowsInteropHelper.ReadProcessUInt32(num23 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, characterAccountConfig.int_137);
												if (num24 < 3)
												{
													array6 = new uint[2]
													{
									...
									if (num26 != map223RouteProfile.mapId && num26 != map222RouteProfile.mapId)
									{
										...
										{
											GameAutomationUtility.TryShowStatusMessageIfDue(characterAccountConfig, "<color=pink>CTC Ac chÝnh ng\u00adêi dïng tù ®iÒu khiÓn..");
											Thread.Sleep(300);
											break;
										}
										...
										if (num42 <= 0)
										{
											...
											if (flag && num3 >= 0 && num3 == InventoryItemMemoryHelper.GetInventoryEntryCount(characterAccountConfig))
											{
												num2 = 0;
												if (GameAutomationUtility.GetSquaredCoordinateDistance(array6, TamTruGatePosition) > 90000L)
												{
												...
												while (!CommonUtility.bool_0 && num4 < 50)
												{
													...
													if (GameAutomationUtility.GetSquaredCoordinateDistance(array6, TamTruGatePosition) < 12500L)
													{
														break;
													}
											...
											if (!Form1.pauseAllPurchasesEnabled)
											{
												...
												if (num44 <= 0 && num2 < 6)
												{
													GameAutomationUtility.PerformAlternateMovementNudge(characterAccountConfig);
													Thread.Sleep(300);
													break;
												}
											}
											...
											uint num45 = num19 + GameConfigurationManager.memorySignatureScanConfig_12.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_75.resolvedValue;
											uint num46 = WindowsInteropHelper.ReadProcessUInt32(num45 + GameConfigurationManager.memorySignatureScanConfig_74.resolvedValue, characterAccountConfig.int_137);
											if (num46 == 0)
											{
												break;
											}
								...
								while (num12 != num26)
								{
									...
									num22 = BitConverter.ToUInt32(array4, 0);
									num23 = num22 + num21;
									WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num23 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array4, 4, ref int_7);
									num25 = BitConverter.ToInt32(array4, 0);
									WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, array4, 4, ref int_7);
								...
								num12 = num26;
								num6 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId;
								break;
								IL_268d:
								...
								break;
								IL_261e:
								if (!flag8 && characterAccountConfig.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId && CurrentCharacterMemoryHelper.GetCurrentTargetEntityIndexByTypes(characterAccountConfig, new int[2] { 0, 1 }) != 0)
								{
									if (num16 > 0)
									{
										WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num23 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, byte_, 4, ref int_7);
								...
								if (num16 <= 0 && characterAccountConfig.int_6 <= 0 && flag11)
								{
									...
									for (int l = 0; l < array10.GetLength(0); l++)
									{
										...
										uint num56 = num22 + (uint)(num54 * (int)GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue);
										WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num56 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array4, 4, ref int_7);
										...
										if (num53 > 0)
										{
											WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num56 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, array4, 4, ref int_7);
											if (BitConverter.ToInt32(array4, 0) <= 0)
											{
												continue;
											}
										...
										WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num56 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, array4, 4, ref int_7);
										array7[0] = BitConverter.ToUInt32(array4, 0);
										WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num56 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_59.resolvedValue, array4, 4, ref int_7);
										array7[1] = BitConverter.ToUInt32(array4, 0);
										long num57 = GameAutomationUtility.GetSquaredCoordinateDistance(array6, array7);
										...
										if (flag10)
										{
											int num58 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, array7));
											int num59 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(array6, array7));
								...
								if (flag8)
								{
									if (!CharacterStateSyncCoordinator.DetectPrimaryAccountInputActivity(characterAccountConfig, ref int_6) && GameInterfaceMemoryHelper.ReadEngineStateByte(characterAccountConfig) != 1)
									{
										...
										uint[] uint_3 = array6;
										if (flag10 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId == num26 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.fightState > 0 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates != null)
										{
											uint_3 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates;
											num32 += num15;
										}
										uint num61 = 0u;
										if (Form1.shareTargetEnabled > 0 && (flag9 || flag10))
										{
											if (flag9)
											{
												if (CharacterStateSyncCoordinator.characterSyncSnapshot_1.mapId == num26 && CharacterStateSyncCoordinator.characterSyncSnapshot_1.currentTargetEntityId != num7)
												{
													num61 = CharacterStateSyncCoordinator.characterSyncSnapshot_1.currentTargetEntityId;
												}
											}
											else if (flag10 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId == num26 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.currentTargetEntityId != num7)
											{
												num61 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.currentTargetEntityId;
											}
											if (num61 == 0 && Form1.autoFindTargetEnabled <= 0)
											{
												goto IL_261e;
											}
										}
										...
										if (characterAccountConfig.int_119 > 0 && characterAccountConfig.int_3 != null)
										{
											...
											{
												int num62 = -1;
												int int_8 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId;
												num16 = 0;
												flag11 = false;
												bool flag13 = false;
												while (GameInterfaceMemoryHelper.ReadEngineStateByte(characterAccountConfig) != 1)
												{
													...
													num24 = (int)WindowsInteropHelper.ReadProcessUInt32(num23 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, characterAccountConfig.int_137);
													num25 = (int)WindowsInteropHelper.ReadProcessUInt32(num23 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, characterAccountConfig.int_137);
													num27 = (int)WindowsInteropHelper.ReadProcessUInt32(num23 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, characterAccountConfig.int_137);
													int num66 = (int)WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, characterAccountConfig.int_137);
													if (num27 > 0 && num26 == num66 && num24 != 11 && num24 != 22 && num25 != 0)
													{
														for (int n = 0; n < array10.GetLength(0); n++)
														{
															...
															num65 = num22 + (uint)(num34 * (int)GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue);
															WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num65 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array4, 4, ref int_7);
															if (BitConverter.ToInt32(array4, 0) <= 0)
															{
																continue;
															}
															if (num67 > 0)
															{
																WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num65 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, array4, 4, ref int_7);
																if (BitConverter.ToInt32(array4, 0) <= 0)
																{
																	continue;
																}
															...
															if (!flag13 || num67 > 0)
															{
																...
																num33 = num64;
																WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num65 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, array4, 4, ref int_7);
																array7[0] = BitConverter.ToUInt32(array4, 0);
																WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num65 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_59.resolvedValue, array4, 4, ref int_7);
																array7[1] = BitConverter.ToUInt32(array4, 0);
																array6 = new uint[2]
																{
																	WindowsInteropHelper.ReadProcessUInt32(num23 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, characterAccountConfig.int_137),
																...
																if (flag10)
																{
																	...
																	long num68 = GameAutomationUtility.GetSquaredCoordinateDistance(array6, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates);
																	if (int_8 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId || num68 > num15 * num15)
																	{
																		goto IL_1c2f;
																	}
																	int num69 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, array7));
																	int num70 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(array6, array7));
																...
																if (GameAutomationUtility.GetSquaredCoordinateDistance(array6, array7) > num33 * num33 && characterAccountConfig.int_95 <= 0)
																{
																	continue;
																}
																...
																WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num23 + GameConfigurationManager.memorySignatureScanConfig_161.resolvedValue - 8, BitConverter.GetBytes(num63), 4, ref int_7);
																WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num23 + GameConfigurationManager.memorySignatureScanConfig_31.resolvedValue, BitConverter.GetBytes(num33), 4, ref int_7);
																WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num23 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, BitConverter.GetBytes(num34), 4, ref int_7);
																Thread.Sleep(10);
																num16 = 1;
										...
										else if (!(flag8 = !characterAccountConfig.bool_22 && (Form1.attackMonstersEnabled > 0 || Form1.attackPlayersEnabled > 0)))
										{
											flag8 = false;
										}
										else
											...
											if (array10 != null)
											{
												...
												while (true)
												{
													if (array10[num73, 1] > 0)
													{
														...
														if (flag10)
														{
															int num74 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(array6, array7));
															int num75 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, array7));
															if (num74 - num33 > 0)
															{
																if (num75 > num74)
																{
																	int num76 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, array6));
														...
														else if (GameAutomationUtility.GetSquaredCoordinateDistance(array6, array7) > num33 * num33 && characterAccountConfig.int_95 <= 0)
														{
															if (characterAccountConfig.int_88 != 1 || num73 != 0)
															{
																break;
													...
													_ = array10[num73, 2];
													if (Form1.fightUntilDeathEnabled > 0 && (num77 <= 0 || num77 == array3[0]) && array3[1] > 0 && array3[2] == num26 && array3[3] > 0)
													{
														int num78 = array3[0];
														int num79 = array3[1];
														uint num80 = num22 + (uint)(num79 * (int)GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue);
														WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num80 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array4, 4, ref int_7);
														if (BitConverter.ToInt32(array4, 0) > 0)
														{
															WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num80 + GameConfigurationManager.memorySignatureScanConfig_45.resolvedValue, array4, 4, ref int_7);
															long num81 = BitConverter.ToInt32(array4, 0);
															if ((ulong)num81 > 0uL)
															{
																WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num80 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, array4, 4, ref int_7);
																if (num78 <= 0 || BitConverter.ToInt32(array4, 0) > 0)
																{
																	array7 = new uint[2]
																	{
																		WindowsInteropHelper.ReadProcessUInt32(num80 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, characterAccountConfig.int_137),
																		WindowsInteropHelper.ReadProcessUInt32(num80 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_59.resolvedValue, characterAccountConfig.int_137)
																	};
																	long num82 = GameAutomationUtility.GetSquaredCoordinateDistance(array6, array7);
																	if (!flag10)
																	{
																	...
																	else
																	{
																		...
																		int num84 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, array7));
																		if (num83 - num33 > 0)
																		{
																			if (num84 > num83)
																			{
																				int num85 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, array6));
								...
								else
								{
									...
									if (flag8 || FormDame.alwaysAttackEnabled > 0)
									{
										...
										bool flag17 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.spaceKeyPressedFlag == 1 || (flag9 && CharacterStateSyncCoordinator.characterSyncSnapshot_1.spaceKeyPressedFlag == 1);
								...
								if (int_3 > 6)
								{
									long num89 = GameAutomationUtility.GetSquaredCoordinateDistance(array, array6);
									array = null;
									if (num89 < 180000L)
									{
										CharacterMovementHelper.SetMovementActive(characterAccountConfig, bool_0: false);
								...
								if (CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates != null && (!CharacterMovementHelper.IsMovementActive(characterAccountConfig) || CommonUtility.GetElapsedMilliseconds(long_) > 3000L))
								{
								...
								if (!flag9)
								{
									if (characterAccountConfig.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId && characterAccountConfig.int_136 != ApplicationRuntimeCoordinator.characterAccountConfig_0.int_136 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.packedMousePosition != 0)
									{
										...
										uint_4 = GameInterfaceMemoryHelper.ConvertScreenToWorldCoordinates(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, (int)num92, (int)num91);
										uint[] array12 = GameInterfaceMemoryHelper.ConvertWorldToScreenCoordinates(array6, uint_4);
										num90 = (array12[1] << 16) + array12[0];
										array11 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates;
								...
								{
									uint num93 = CharacterStateSyncCoordinator.characterSyncSnapshot_1.packedMousePosition >> 16;
									uint num94 = CharacterStateSyncCoordinator.characterSyncSnapshot_1.packedMousePosition - (num93 << 16);
									uint_4 = GameInterfaceMemoryHelper.ConvertScreenToWorldCoordinates(CharacterStateSyncCoordinator.characterSyncSnapshot_1.coordinates, (int)num94, (int)num93);
									uint[] array13 = GameInterfaceMemoryHelper.ConvertWorldToScreenCoordinates(array6, uint_4);
									num90 = (array13[1] << 16) + array13[0];
									array11 = CharacterStateSyncCoordinator.characterSyncSnapshot_1.coordinates;
									GameInterfaceMemoryHelper.WritePackedMousePosition(characterAccountConfig, num90);
									Thread.Sleep(10);
								}
								GameAutomationUtility.ApplyConfiguredHorseSwitching(characterAccountConfig);
								...
								if (num90 != 0 && characterAccountConfig.int_136 != ApplicationRuntimeCoordinator.characterAccountConfig_0.int_136)
								{
									...
									{
										WindowsInteropHelper.ReadProcessUInt32(num23 + GameConfigurationManager.memorySignatureScanConfig_31.resolvedValue, characterAccountConfig.int_137);
									...
									{
										uint[] uint_5 = GameAutomationUtility.GetCoordinateOffsetAlongLine(array11, uint_4, -1 * (Form1.mainAccountSearchDistance - 50));
										long num97 = GameAutomationUtility.GetSquaredCoordinateDistance(array6, uint_5);
										if (num97 > 7000L)
										{
				...
				else
				{
					...
					{
						WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num23 + GameConfigurationManager.memorySignatureScanConfig_251.resolvedValue, GameConfigurationManager.byte_0, GameConfigurationManager.byte_0.Length, ref int_7);
					}
					num16 = 0;
					num17 = 0;
				}
	...
	public static int BuyMedicineAtConfiguredShop(CharacterAccountConfig characterAccountConfig_0)
	{
		if (MedicineShopName != null && !(MedicineShopName == string.Empty) && MedicineShopPosition != null && MedicineShopName[0] != 0)
		{
			...
			GameAutomationUtility.TryShowStatusMessageIfDue(characterAccountConfig_0, "Mua thuèc, xin chê chøt xÝu...");
			long long_ = 0L;
			while (true)
			{
				Thread.Sleep(300);
				...
				if ((characterAccountConfig_0.int_71[0] > 0 && characterAccountConfig_0.int_71[2] > 0) || (characterAccountConfig_0.int_72[0] > 0 && characterAccountConfig_0.int_72[2] > 0) || (characterAccountConfig_0.int_73[0] > 0 && characterAccountConfig_0.int_73[2] > 0))
				{
					...
					WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num9 + GameConfigurationManager.memorySignatureScanConfig_13.resolvedValue, array2, 4, ref int_2);
					...
					WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num13 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, array2, 4, ref int_2);
					int num14 = BitConverter.ToInt32(array2, 0);
					WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num13 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array2, 4, ref int_2);
					...
					WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num13 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, array2, 4, ref int_2);
						...
						if (num15 != 0 && num14 != 0 && num16 != 0)
						{
							if (num17 <= 0)
							{
								if (InventoryItemMemoryHelper.GetFreeItemGridCellCount(characterAccountConfig_0) != 0)
								{
									...
									{
										WindowsInteropHelper.ReadProcessUInt32(num13 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, characterAccountConfig_0.int_137),
										WindowsInteropHelper.ReadProcessUInt32(num13 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_59.resolvedValue, characterAccountConfig_0.int_137)
									};
									...
									int num18 = 0;
									if (GameAutomationUtility.GetSquaredCoordinateDistance(array4, MedicineShopPosition) > 90000L)
									{
									...
									while (true)
									{
										if (!CommonUtility.bool_0)
										{
											...
											if (GameAutomationUtility.GetSquaredCoordinateDistance(array4, MedicineShopPosition) >= 22500L)
											{
										...
										while (true)
										{
											for (num18 = 0; num18 < 10; num18++)
											{
												...
												if (GameAutomationUtility.GetSquaredCoordinateDistance(array4, array5) < 11250L)
												{
													break;
												}
											...
											while (true)
											{
												...
												if (num4 == 0)
												{
													...
													uint num20 = num9 + GameConfigurationManager.memorySignatureScanConfig_12.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_75.resolvedValue;
													long num21 = WindowsInteropHelper.ReadProcessUInt32(num20 + GameConfigurationManager.memorySignatureScanConfig_74.resolvedValue, characterAccountConfig_0.int_137);
													if (num21 > 0L)
													{
														if (Form1.int_67[0] <= 0)
														{
											...
											while (true)
											{
												...
												if (array6[0] > 0 && array6[2] > 0 && text2 != null && text2 != string.Empty)
												{
													...
													num26 = InventoryItemMemoryHelper.CountInventoryItemQuantityByName(characterAccountConfig_0, text2);
													num25 = array6[2] - num26;
													if (num25 > 0)
													{
														string empty = string.Empty;
														uint num28 = WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_165.resolvedValue, characterAccountConfig_0.int_137);
														uint num29 = WindowsInteropHelper.ReadProcessUInt32(num28 + GameConfigurationManager.memorySignatureScanConfig_167.resolvedValue, characterAccountConfig_0.int_137);
														byte[] array7 = new byte[15];
														int num30 = InventoryItemMemoryHelper.GetInventoryEntryCount(characterAccountConfig_0);
														for (int j = 0; j < num25; j++)
														{
															...
															int num31 = InventoryItemMemoryHelper.GetInventoryEntryCount(characterAccountConfig_0);
															if (num31 == num30)
															{
																num23++;
																if (num23 > 10)
															...
															if (CommonUtility.FindSubstringIndex(empty, "ho¶ng trèng") > 0 && InventoryItemMemoryHelper.GetFreeItemGridCellCount(characterAccountConfig_0) == 0)
															{
																result = 1;
																goto end_IL_0750;
															}
				...
				if (num7 > 0)
				{
					...
					{
						InventoryItemMemoryHelper.RepairAndCollectLowDurabilityEquipment(characterAccountConfig_0, 0, 0, num7 < 2);
					}
		...
		GameAutomationUtility.TryShowStatusMessageIfDue(characterAccountConfig_0, GameTextEncodingHelper.ConvertDisplayTextToGameText("<color=yellow>Không thể mua thuốc, bạn cần vào mục CTC Tam trụ để lấy tên hiệu thuốc..."));
		return 1;
	}
}
