...
internal class EventFruitPickupAutomation
{
	...
	private static void RunForCharacter(int int_1)
	{
		...
		while (true)
		{
			...
			WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, characterAccountConfig.uint_16 + Class75.uint_13 * 4, array, 4, ref int_2);
			if (array[0] == 0)
			{
				flag2 = true;
			}
			...
			WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, characterAccountConfig.uint_16 + Class75.uint_15 * 4, array, 1, ref int_2);
			int num10 = array[0];
			WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, characterAccountConfig.uint_16 + Class75.uint_16 * 4, array, 4, ref int_2);
			array4[0] = BitConverter.ToUInt32(array, 0);
			WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, characterAccountConfig.uint_16 + (Class75.uint_16 + 1) * 4, array, 4, ref int_2);
			array4[1] = BitConverter.ToUInt32(array, 0);
			WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, characterAccountConfig.uint_16 + (Class75.uint_16 + 2) * 4, array, 4, ref int_2);
			...
			if (num5 != 0)
			{
				...
				while (flag && Class11.smethod_28(long_) < characterAccountConfig.gstruct49_0.int_7)
				{
					...
					if (text4 != null && !(text4 == string.Empty))
					{
						...
						WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num9 + GameConfigurationManager.memorySignatureScanConfig_251.uint_0, array2, array2.Length, ref int_2);
						WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, characterAccountConfig.uint_16 + Class75.uint_13 * 4, array, 1, ref int_2);
						if (array[0] != 0)
						{
							WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, characterAccountConfig.uint_16 + Class75.uint_14 * 4, array, 1, ref int_2);
							if (array[0] == 0)
							{
								break;
							}
