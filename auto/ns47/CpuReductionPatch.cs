...
internal class CpuReductionPatch
{
	...
	{
		int accountState = LicenseRuntimeCoordinator.GetAccountStateCodeSafe(accountConfig);
		if (accountState > 0)
		{
			GameLaunchHelper.bool_0 = true;
		}
		if (accountState <= 0 || accountConfig.uint_7 == 0 || GameConfigurationManager.memorySignatureScanConfig_245.resolvedValue == 0 || GameConfigurationManager.memorySignatureScanConfig_246.resolvedValue == 0)
		{
			return;
		}
		uint primaryPatchAddress = accountConfig.uint_7 + GameConfigurationManager.memorySignatureScanConfig_245.resolvedValue;
		uint secondaryPatchAddress = accountConfig.uint_7 + GameConfigurationManager.memorySignatureScanConfig_246.resolvedValue;
	...
	{
		uint firstPatchAddress = accountConfig.uint_7 + GameConfigurationManager.memorySignatureScanConfig_247.resolvedValue;
		uint secondPatchAddress = accountConfig.uint_7 + GameConfigurationManager.memorySignatureScanConfig_248.resolvedValue;
		uint thirdPatchAddress = accountConfig.uint_7 + GameConfigurationManager.memorySignatureScanConfig_249.resolvedValue;
		int bytesTransferred = 0;
