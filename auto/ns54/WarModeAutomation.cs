								...
								while (true)
								{
									...
									if (!flag9)
									{
										if (num == num39 && (num2 == CharacterStateSyncCoordinator.characterSyncSnapshot_0.int_4 || Form1.int_25 <= 0))
										{
											...
											{
												string text = WindowsInteropHelper.smethod_28(characterAccountConfig.uint_7 + GameConfigurationManager.memorySignatureScanConfig_28.uint_0 + GameConfigurationManager.memorySignatureScanConfig_29.uint_0, characterAccountConfig.int_137, 20);
												flag18 = 0 <= text.IndexOf("Tr\u00adêng B¹ch");
											}
											if (!flag18 && characterAccountConfig.int_105 > 0 && (num39 == 333 || num39 == 998) && CommonUtility.smethod_28(long_6) > 6000L)
											{
												if (num14 <= 0)
												{
											...
											if (num40 <= 0)
											{
												...
												if (characterAccountConfig.int_133[0] <= 0 && (!flag3 || num4 < 0 || num4 != num54))
												{
													...
													{
														string text2 = WindowsInteropHelper.smethod_28(characterAccountConfig.uint_7 + GameConfigurationManager.memorySignatureScanConfig_28.uint_0 + GameConfigurationManager.memorySignatureScanConfig_29.uint_0, characterAccountConfig.int_137, 20);
														if ((num39 != 989 || 0 > text2.IndexOf("Ph\u00adîng Ho")) && (num39 != 977 || (0 > text2.IndexOf("Cæ L") && 0 > text2.IndexOf("Hßa B"))))
														{
															...
															GameProcessInteractionHelper.smethod_52(characterAccountConfig, "<bclr=blue><color=green>" + text3);
															...
															{
																GameProcessInteractionHelper.smethod_50(characterAccountConfig, CharacterStateSyncCoordinator.characterSyncSnapshot_0.string_0, text3);
															}
												...
												if (flag7)
												{
													long num58 = WindowsInteropHelper.smethod_30(num36 + GameConfigurationManager.memorySignatureScanConfig_45.uint_0, characterAccountConfig.int_137);
													long num59 = WindowsInteropHelper.smethod_30(num36 + GameConfigurationManager.memorySignatureScanConfig_47.uint_0, characterAccountConfig.int_137) + 1;
													long num60 = WindowsInteropHelper.smethod_30(num36 + GameConfigurationManager.memorySignatureScanConfig_47.uint_0 + 4, characterAccountConfig.int_137) + 1;
													long num61 = WindowsInteropHelper.smethod_30(num36 + GameConfigurationManager.memorySignatureScanConfig_46.uint_0, characterAccountConfig.int_137);
													long num62 = WindowsInteropHelper.smethod_30(num36 + GameConfigurationManager.memorySignatureScanConfig_48.uint_0, characterAccountConfig.int_137) + 1;
													long num63 = WindowsInteropHelper.smethod_30(num36 + GameConfigurationManager.memorySignatureScanConfig_48.uint_0 + 4, characterAccountConfig.int_137) + 1;
											...
											else
											{
												...
												flag3 = false;
												flag7 = true;
												if (((Form1.int_121 > 0 && !ChienLongDongNavigationHelper.IsChienLongDongMap(num39)) || (characterAccountConfig.int_104[0] > 0 && characterAccountConfig.int_104[1] <= num47)) && !Class64.smethod_14(characterAccountConfig) && GameProcessInteractionHelper.smethod_3(characterAccountConfig, GameProcessInteractionHelper.uint_19, 4) > 0)
												{
											...
											flag20 = false;
											flag21 = false;
											num39 = (int)WindowsInteropHelper.smethod_30(GameConfigurationManager.memorySignatureScanConfig_27.uint_0, characterAccountConfig.int_137);
											num40 = (int)WindowsInteropHelper.smethod_30(num36 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, characterAccountConfig.int_137);
											...
											if (Form1.int_120 > 0 && num40 <= 0)
											{
												...
												{
													if (CommonUtility.smethod_28(long_5) > 10000L)
													{
												...
												else
												{
													...
													{
														uint num67 = CommonUtility.smethod_12(characterAccountConfig.string_15);
														if (num67 != 0)
														{
													...
													if (CommonUtility.smethod_28(long_5) > 8000L)
													{
														GameProcessInteractionHelper.smethod_52(characterAccountConfig, "Ra diem tap ket.");
														long_5 = CommonUtility.smethod_27();
													}
													num43 = 0;
									...
									if ((flag25 = flag23 || flag24) && (!flag10 || Form1.int_82 <= 0) && (!AuxiliaryMachineManager.bool_1 || (Form1.int_11 <= 0 && Form1.int_10 <= 0)))
									{
										if (!flag22)
										{
											...
											if (Form1.int_90 > 0 || GameProcessInteractionHelper.smethod_3(characterAccountConfig, GameProcessInteractionHelper.uint_19, 4) == 0)
											{
												if (bool_)
												{
													bool_ = false;
											...
											if (GameProcessInteractionHelper.smethod_3(characterAccountConfig, GameProcessInteractionHelper.uint_19, 4) > 0)
											{
												...
												if (0 <= num73 && MapNavigationHelper.smethod_7(characterAccountConfig, num72))
												{
													...
													Class64.smethod_11(characterAccountConfig);
													Thread.Sleep(600);
													int num74 = (int)WindowsInteropHelper.smethod_30(GameConfigurationManager.memorySignatureScanConfig_27.uint_0, characterAccountConfig.int_137);
													if (num74 != num39)
													{
														break;
													}
												...
												else if (num39 != 103 && num39 != 114 && num39 != 110 && (num70 == 110 || num70 == 114) && MapNavigationHelper.smethod_7(characterAccountConfig, 103))
												{
													...
													Class64.smethod_11(characterAccountConfig);
													Thread.Sleep(600);
													int num75 = (int)WindowsInteropHelper.smethod_30(GameConfigurationManager.memorySignatureScanConfig_27.uint_0, characterAccountConfig.int_137);
													if (num75 != num39)
													{
														break;
													}
											...
											if (num77 != 0)
											{
												...
												else if (CommonUtility.smethod_28(long_3) > 15000L)
												{
													GameProcessInteractionHelper.smethod_52(characterAccountConfig, "<color=yellow>Khong the den toa do dinh san...");
													long_3 = CommonUtility.smethod_27();
												}
												break;
											}
									...
									if (Form1.int_121 > 0 && !ChienLongDongNavigationHelper.IsChienLongDongMap(num39))
									{
										...
										if (num16 < 5 && GameProcessInteractionHelper.smethod_3(characterAccountConfig, GameProcessInteractionHelper.uint_19, 4) > 0)
										{
											num16++;
											CharacterMovementHelper.SetMovementActive(characterAccountConfig, bool_0: false);
										...
										if (CharacterStateSyncCoordinator.characterSyncSnapshot_0.int_4 == num39)
										{
											if (CharacterStateSyncCoordinator.characterSyncSnapshot_0.uint_4 != null)
											{
												...
												if (num13 <= 0L || CommonUtility.smethod_28(num13) >= 1500L)
												{
													...
													if (Form1.int_31 > 0 && num40 > 0 && characterAccountConfig.int_131[0] > 0 && GameProcessInteractionHelper.smethod_3(characterAccountConfig, GameProcessInteractionHelper.uint_31, 4) == 0)
													{
												...
												if (num39 != 175)
												{
													...
													else
													{
														...
														if (num40 == 0 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.int_3 > 0)
														{
															...
															flag31 = false;
															if (GameProcessInteractionHelper.smethod_3(characterAccountConfig, GameProcessInteractionHelper.uint_19, 4) <= 0 || flag30)
															{
																goto IL_3e43;
															}
									...
									if (num51 <= 0)
									{
										...
										num29++;
										GameProcessInteractionHelper.smethod_61(characterAccountConfig, array22);
										Thread.Sleep(200);
										if (num29 > 15)
										{
											num26 = -1;
									...
									if (num96 != 0 && characterAccountConfig.int_136 != ApplicationRuntimeCoordinator.characterAccountConfig_0.int_136)
									{
										...
										{
											WindowsInteropHelper.smethod_30(num36 + GameConfigurationManager.memorySignatureScanConfig_31.uint_0, characterAccountConfig.int_137);
									...
									if (flag35)
									{
										...
										while (num103 < 5)
										{
											int num104 = (int)WindowsInteropHelper.smethod_30(GameConfigurationManager.memorySignatureScanConfig_27.uint_0, characterAccountConfig.int_137);
											if (num104 == num39)
											{
												num103++;
												Thread.Sleep(100);
									...
									if (num86 != 0)
									{
										if (num86 > 0)
										{
											if (array28 != null)
											{
												if (GameProcessInteractionHelper.smethod_3(characterAccountConfig, GameProcessInteractionHelper.uint_19, 4) > 0 && num16 < 5)
												{
													num16++;
									...
									if (flag21)
									{
										uint[] array29 = null;
										long num106 = 0L;
										if (num12 <= 0L || CommonUtility.smethod_28(num12) >= 800L)
										{
												...
												if (num106 >= 8000L)
												{
													if (num106 >= 15000L && num106 >= characterAccountConfig.int_68[1] * characterAccountConfig.int_68[1])
													{
														if (num106 < 360000L)
														{
															...
															num21 = 0;
															CharacterMovementHelper.SetMovementActive(characterAccountConfig, bool_0: false);
															GameProcessInteractionHelper.smethod_61(characterAccountConfig, array29);
															Thread.Sleep(200);
															break;
														}
														if (num106 < 1200000L)
														{
															if (CommonUtility.smethod_28(long_3) > 3000L)
															{
													...
													{
														num37 = (int)WindowsInteropHelper.smethod_30(num36 + GameConfigurationManager.memorySignatureScanConfig_55.uint_0, characterAccountConfig.int_137);
										...
										if (flag20)
										{
											...
											WindowsInteropHelper.smethod_30(num36 + GameConfigurationManager.memorySignatureScanConfig_56.uint_0, characterAccountConfig.int_137);
											if (num106 <= 0L)
											{
												break;
											}
										...
										if (array30 != null && array30[0, 0] >= 0)
										{
											...
											while (true)
											{
												...
												if (num21 <= 0 && characterAccountConfig.int_6 <= 0 && flag36)
												{
													...
													WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num36 + GameConfigurationManager.memorySignatureScanConfig_161.uint_0 - 8, BitConverter.GetBytes(CharacterSkillHelper.smethod_13(characterAccountConfig)), 4, ref int_6);
													WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num36 + GameConfigurationManager.memorySignatureScanConfig_31.uint_0, BitConverter.GetBytes(num49), 4, ref int_6);
													WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num36 + GameConfigurationManager.memorySignatureScanConfig_72.uint_0, BitConverter.GetBytes(num51), 4, ref int_6);
												}
									...
									{
										long num149 = CommonUtility.smethod_28(long_2);
										if (num149 < 300L)
										{
											break;
										}
									...
									if (num39 != Map878NavigationHelper.MapId)
									{
										...
										{
											flag12 = true;
											if (GameProcessInteractionHelper.smethod_3(characterAccountConfig, GameProcessInteractionHelper.uint_19, 4) > 0 && MapNavigationHelper.smethod_6(characterAccountConfig, CharacterStateSyncCoordinator.characterSyncSnapshot_0.int_4) > 0)
											{
												Thread.Sleep(300);
												break;
											}
										...
										if (num40 != 0 || CharacterStateSyncCoordinator.characterSyncSnapshot_0.int_3 <= 0 || TongKimBattlefieldHelper.smethod_0(num39) == null)
										{
											...
											case 998:
											{
												if (GameProcessInteractionHelper.smethod_3(characterAccountConfig, GameProcessInteractionHelper.uint_19, 4) > 0 && num81 > 15354505L && Form1.string_6 == "vltrungnguyen.com")
												{
													num81 = -1L;
													int num158 = -1;
									...
									if (num167 <= 0 && (!CharacterMovementHelper.IsMovementActive(characterAccountConfig) || CommonUtility.smethod_28(long_3) > 4000L))
									{
									...
									{
										if (!CharacterMovementHelper.IsMovementActive(characterAccountConfig) || CommonUtility.smethod_28(long_3) > 3000L)
										{
									...
									if (!CharacterMovementHelper.IsMovementActive(characterAccountConfig) || CommonUtility.smethod_28(long_3) > 4000L)
									{
										int_2++;
