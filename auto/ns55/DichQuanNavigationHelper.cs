...
internal class DichQuanNavigationHelper
{
	public static int MoveToDichQuan(CharacterAccountConfig characterAccountConfig_0, uint[] uint_0 = null)
	{
		...
		while (true)
		{
			...
			int num7 = (int)WindowsInteropHelper.ReadProcessUInt32(num5 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, characterAccountConfig_0.int_137);
			int num8 = (int)WindowsInteropHelper.ReadProcessUInt32(num5 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, characterAccountConfig_0.int_137);
