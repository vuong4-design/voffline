...
internal class ItemPickupFilterAutomation
{
	...
	public static uint[] FindPickupCandidate(CharacterAccountConfig characterAccountConfig_0, uint[] uint_0, bool bool_2, bool bool_3)
	{
		...
		uint num7 = num6 + num5;
		uint num8 = Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_126.uint_0, characterAccountConfig_0.int_137);
		...
		for (uint num12 = 0u; num12 < 256; num12++)
		{
			if (!Class11.bool_0 && (num > num10 || num11 <= 5))
			{
				...
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num13 + GameConfigurationManager.memorySignatureScanConfig_138.uint_0, array2, 1, ref int_);
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num13 + GameConfigurationManager.memorySignatureScanConfig_137.uint_0, array, 4, ref int_);
				if (array2[0] != 0 && BitConverter.ToInt32(array, 0) > 0)
				{
					num11 = 0;
					num10++;
					Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num13 + GameConfigurationManager.memorySignatureScanConfig_133.uint_0, array, 4, ref int_);
					uint num15 = BitConverter.ToUInt32(array, 0);
					Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num13 + GameConfigurationManager.memorySignatureScanConfig_134.uint_0, array, 4, ref int_);
					uint num16 = BitConverter.ToUInt32(array, 0);
					Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num13 + GameConfigurationManager.memorySignatureScanConfig_128.uint_0, array, 4, ref int_);
					...
					if (num17 != 4)
					{
						...
						{
							Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num13 + GameConfigurationManager.memorySignatureScanConfig_138.uint_0, array2, array2.Length, ref int_);
						...
						Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num13 + GameConfigurationManager.memorySignatureScanConfig_129.uint_0, array, 4, ref int_);
						...
						if (num19 != 1 && num19 != 2 && num19 <= 4)
						{
							...
							Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num13 + GameConfigurationManager.memorySignatureScanConfig_130.uint_0, array, 4, ref int_);
							int num20 = BitConverter.ToInt32(array, 0);
							Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num13 + GameConfigurationManager.memorySignatureScanConfig_131.uint_0, array, 4, ref int_);
					...
					{
						Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num13 + GameConfigurationManager.memorySignatureScanConfig_132.uint_0, array, 4, ref int_);
						num18 = BitConverter.ToInt32(array, 0);
					}
					if (Class24.smethod_30(num13 + GameConfigurationManager.memorySignatureScanConfig_140.uint_0, characterAccountConfig_0.int_137) != 0)
					{
	...
	private static void RunForCharacter(int int_2)
	{
		...
		while (true)
		{
			...
			{
				int num5 = 0;
				uint num6 = Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_126.uint_0, characterAccountConfig.int_137);
				int int_3 = 0;
				int num7 = -1;
				...
				while (characterAccountConfig.gstruct40_0 != null && num5 < 60)
				{
					...
					for (int i = 0; i < characterAccountConfig.gstruct40_0.Length; i++)
					{
						...
						Class24.ReadProcessMemory(characterAccountConfig.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_138.uint_0, byte_, 1, ref int_3);
						Class24.ReadProcessMemory(characterAccountConfig.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_137.uint_0, array, 4, ref int_3);
				...
				if (!bool_0)
				{
					...
					while (gstruct40_0 != null && num5 <= 255)
					{
						...
						for (int k = 0; k < gstruct40_0.Length; k++)
						{
							...
							Class24.ReadProcessMemory(characterAccountConfig.int_137, num10 + GameConfigurationManager.memorySignatureScanConfig_138.uint_0, byte_, 1, ref int_3);
							Class24.ReadProcessMemory(characterAccountConfig.int_137, num10 + GameConfigurationManager.memorySignatureScanConfig_137.uint_0, array, 4, ref int_3);
			...
			uint num12 = Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_11.uint_0, characterAccountConfig.int_137);
			uint num13 = Class24.smethod_30(num12 + GameConfigurationManager.memorySignatureScanConfig_13.uint_0, characterAccountConfig.int_137);
			uint num14 = Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_14.uint_0, characterAccountConfig.int_137);
			uint num15 = num14 + num13 * GameConfigurationManager.memorySignatureScanConfig_15.uint_0;
			int num16 = (int)Class24.smethod_30(num15 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, characterAccountConfig.int_137);
	...
	public static bool smethod_3(CharacterAccountConfig characterAccountConfig_0)
	{
		...
		for (uint num6 = 1u; num6 < GameConfigurationManager.int_1 && num4 > num5; num6++)
		{
			...
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_106.uint_0 - 4, array3, 4, ref int_2);
			...
			uint num10 = Class24.smethod_30(num2 + num9 * 20 + GameConfigurationManager.memorySignatureScanConfig_100.uint_0 - 8, characterAccountConfig_0.int_137);
			if ((int)num9 <= 0 || (num10 != 3 && num10 != 1))
			{
				continue;
			}
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_108.uint_0, array2, 4, ref int_);
			int num11 = BitConverter.ToInt32(array2, 0);
			if (num11 > 0)
			{
				continue;
			}
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_109.uint_0, array2, 4, ref int_);
			...
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_119.uint_0, array2, 4, ref int_);
			int num13 = BitConverter.ToInt32(array2, 0);
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_119.uint_0 + 4, array2, 4, ref int_);
			...
			if (characterAccountConfig_0.int_43[0] > 0 && num16 == 3)
			{
				...
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_118.uint_0 + (uint)((characterAccountConfig_0.int_43[1] - 1) * 16), array2, 4, ref int_);
				if (BitConverter.ToInt32(array2, 0) != 0)
				{
					continue;
				}
			...
			else if (characterAccountConfig_0.int_44[0] > 0 && num16 == 4)
			{
				...
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_118.uint_0 + (uint)((characterAccountConfig_0.int_44[1] - 1) * 16), array2, 4, ref int_);
				if (BitConverter.ToInt32(array2, 0) != 0)
				{
					continue;
				}
			...
			else if (characterAccountConfig_0.int_45[0] > 0 && num16 == 9)
			{
				...
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_118.uint_0 + (uint)((characterAccountConfig_0.int_45[1] - 1) * 16), array2, 4, ref int_);
				if (BitConverter.ToInt32(array2, 0) != 0)
				{
					continue;
				}
			...
			{
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_114.uint_0, array2, 4, ref int_);
			...
			{
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_115.uint_0, array2, 4, ref int_);
			...
			if (characterAccountConfig_0.int_50 > 0)
			{
				...
				for (int i = 0; i < characterAccountConfig_0.itemAttributeFilterRule_0.Length; i++)
				{
					...
					{
						Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_118.uint_0 + num19 * 16, array2, 4, ref int_);
						int num20 = BitConverter.ToInt32(array2, 0);
						if (characterAccountConfig_0.itemAttributeFilterRule_0[i].int_1 == num20)
						{
							Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_118.uint_0 + num19 * 16 + 4, array2, 4, ref int_);
							int num21 = BitConverter.ToInt32(array2, 0);
							Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_118.uint_0 + num19 * 16 + 12, array2, 4, ref int_);
			...
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num2 + num9 * 20 + GameConfigurationManager.memorySignatureScanConfig_100.uint_0 - 4, array2, 4, ref int_);
			uint num23 = BitConverter.ToUInt32(array2, 0);
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num2 + num9 * 20 + GameConfigurationManager.memorySignatureScanConfig_100.uint_0, array2, 4, ref int_);
			...
			uint[] uint_2 = null;
			uint num27 = Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_126.uint_0, characterAccountConfig_0.int_137);
			for (uint num28 = 1u; num28 < 256; num28++)
			{
				...
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num29 + GameConfigurationManager.memorySignatureScanConfig_138.uint_0, array, 1, ref int_);
				if (array[0] != 0)
				{
					Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num29 + GameConfigurationManager.memorySignatureScanConfig_137.uint_0, array2, 4, ref int_);
					if (BitConverter.ToInt32(array2, 0) > 0)
					{
			...
			for (uint num30 = 1u; num30 < 256; num30++)
			{
				...
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num31 + GameConfigurationManager.memorySignatureScanConfig_138.uint_0, array, 1, ref int_);
				byte b = (byte)text[0];
				if (array[0] != b)
				{
					continue;
				}
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num31 + GameConfigurationManager.memorySignatureScanConfig_137.uint_0, array2, 4, ref int_);
				if (BitConverter.ToInt32(array2, 0) <= 0)
				{
					continue;
				}
	...
	public static GStruct33 smethod_6(CharacterAccountConfig characterAccountConfig_0)
	{
		...
		for (uint num5 = 1u; num5 < GameConfigurationManager.int_1; num5++)
		{
			...
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num6 + GameConfigurationManager.memorySignatureScanConfig_106.uint_0 - 4, array3, 4, ref int_2);
			if (BitConverter.ToInt32(array3, 0) != 0)
			{
				continue;
			}
			...
			{
				num4++;
				uint num8 = Class24.smethod_30(num + num7 * 20 + GameConfigurationManager.memorySignatureScanConfig_100.uint_0 - 8, characterAccountConfig_0.int_137);
				if ((int)num7 > 0 && num8 == 1)
				{
					Class24.ReadProcessMemory(characterAccountConfig_0.int_137, uint_, array, array.Length, ref int_);
					result.string_0 = GameTextEncodingHelper.smethod_3(array);
					result.uint_1 = num5;
					Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num6 + GameConfigurationManager.memorySignatureScanConfig_111.uint_0, array2, 4, ref int_);
					result.uint_4 = BitConverter.ToUInt32(array2, 0);
					Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num6 + GameConfigurationManager.memorySignatureScanConfig_112.uint_0, array2, 4, ref int_);
					...
					Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num6 + GameConfigurationManager.memorySignatureScanConfig_110.uint_0, array2, 4, ref int_);
