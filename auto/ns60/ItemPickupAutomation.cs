	...
	private static void RunForCharacter(int int_1)
	{
		...
		while (true)
		{
			...
			if (characterAccountConfig.int_61 > 0 && characterAccountConfig.int_25 <= 0 && characterAccountConfig.gstruct49_0.pickupEnabled <= 0)
			{
				...
				int num12 = (int)WindowsInteropHelper.ReadProcessUInt32(num11 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, characterAccountConfig.int_137);
				int num13 = (int)WindowsInteropHelper.ReadProcessUInt32(num11 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, characterAccountConfig.int_137);
				WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, characterAccountConfig.int_137);
				int num14 = GameInterfaceMemoryHelper.ReadGatewayConnectionState(characterAccountConfig);
				int num15 = (int)WindowsInteropHelper.ReadProcessUInt32(num11 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, characterAccountConfig.int_137);
				if (num12 != 0 && num15 != 10 && num15 != 21 && num14 > 1 && (num13 > 0 || characterAccountConfig.int_39 > 0))
				{
					...
					uint uint_ = characterAccountConfig.uint_7 + GameConfigurationManager.memorySignatureScanConfig_124.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_125.resolvedValue + 4;
					...
					int num18 = 0;
					int num19 = 0;
					uint num20 = WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_126.resolvedValue, characterAccountConfig.int_137);
					for (uint num21 = 1u; num21 < 256; num21++)
					{
						...
						uint num22 = num20 + num21 * GameConfigurationManager.memorySignatureScanConfig_127.resolvedValue;
						WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_138.resolvedValue, array2, 1, ref int_2);
						WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_137.resolvedValue, array, 4, ref int_2);
						if (array2[0] != 0 && BitConverter.ToInt32(array, 0) > 0)
						{
							num19 = 0;
							num18++;
							WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_128.resolvedValue, array, 1, ref int_2);
							if (array[0] == 4)
							{
								WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_132.resolvedValue, array, 4, ref int_2);
							...
							else
							{
								...
								{
									bool flag = false;
									WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_138.resolvedValue, array2, array2.Length, ref int_2);
								...
								WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_129.resolvedValue, array, 4, ref int_2);
								...
								if (num23 != 1 && num23 != 2 && num23 <= 4)
								{
									...
									WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_130.resolvedValue, array, 4, ref int_2);
									int num24 = BitConverter.ToInt32(array, 0);
									WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_131.resolvedValue, array, 4, ref int_2);
							...
							if (WindowsInteropHelper.ReadProcessUInt32(num22 + GameConfigurationManager.memorySignatureScanConfig_140.resolvedValue, characterAccountConfig.int_137) != 0)
							{
								WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_133.resolvedValue, array, 4, ref int_2);
								uint num26 = BitConverter.ToUInt32(array, 0);
								WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_134.resolvedValue, array, 4, ref int_2);
								uint num27 = BitConverter.ToUInt32(array, 0);
								uint[] uint_2 = new uint[2]
								{
									WindowsInteropHelper.ReadProcessUInt32(num11 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, characterAccountConfig.int_137),
