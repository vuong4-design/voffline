...
internal class TongKimPhongHoaLienThanhAutomation
{
	...
	public static void Run(int int_1)
	{
		...
		while (true)
		{
			...
			if (!characterAccountConfig.bool_15 && GameProcessInteractionHelper.ReadSharedSlotIntegerValue(characterAccountConfig, GameProcessInteractionHelper.clickNpcAutomationActiveSlot, 4) <= 0)
			{
				...
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num18 + GameConfigurationManager.memorySignatureScanConfig_13.resolvedValue, array3, 4, ref array4[1]);
				...
				uint num21 = num19 * GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue;
				...
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, array3, 4, ref array4[4]);
				int num23 = BitConverter.ToInt32(array3, 0);
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array3, 4, ref array4[5]);
				...
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, array3, 4, ref array4[7]);
				int num26 = BitConverter.ToInt32(array3, 0);
				num16 = 7;
				int num27 = GameInterfaceMemoryHelper.ReadEngineStateByte(characterAccountConfig);
				if ((characterAccountConfig.int_136 != ApplicationRuntimeCoordinator.foregroundCharacterAccount.int_136 && characterAccountConfig.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId) || (num27 != 1 && num27 != 2))
				{
					if (num14 <= 0)
					{
						array2[0] = 0;
					...
					if (num24 != 0 && num23 != 0 && num25 != 0 && num23 != 10 && num23 != 21 && num28 > 1)
					{
						...
						while (true)
						{
							...
							{
								WindowsInteropHelper.ReadProcessUInt32(num22 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, characterAccountConfig.int_137),
								WindowsInteropHelper.ReadProcessUInt32(num22 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_59.resolvedValue, characterAccountConfig.int_137)
							};
							...
							if (!flag7)
							{
								if (num3 == num25)
								{
									if (num4 != num26)
									{
										...
										{
											WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, GameConfigurationManager.memorySignatureScanConfig_11.resolvedValue, array3, 4, ref int_7);
											num18 = BitConverter.ToUInt32(array3, 0);
											WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num18 + GameConfigurationManager.memorySignatureScanConfig_13.resolvedValue, array3, 4, ref int_7);
											num19 = BitConverter.ToUInt32(array3, 0);
											num21 = num19 * GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue;
											WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, GameConfigurationManager.memorySignatureScanConfig_14.resolvedValue, array3, 4, ref int_7);
											num20 = BitConverter.ToUInt32(array3, 0);
											num22 = num20 + num21;
											WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, array3, 4, ref int_7);
									...
									if (array7 == null && 0 > num35 && (GameAutomationUtility.FindTravelHubGroupPosition(num25) != null || TongKimBattlefieldHelper.FindBattlefieldMapMatrixPosition(num25) != null || 0 > TongKimBattlefieldHelper.FindNearestBattlefieldRouteIndex(array5, num25)))
									{
										...
										{
											WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, byte_, 4, ref int_7);
										...
										if (num26 <= 0)
										{
											...
											uint num37 = num18 + GameConfigurationManager.memorySignatureScanConfig_12.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_75.resolvedValue;
											uint num38 = WindowsInteropHelper.ReadProcessUInt32(num37 + GameConfigurationManager.memorySignatureScanConfig_73.resolvedValue, characterAccountConfig.int_137);
											...
											{
												flag4 = true;
												uint num40 = WindowsInteropHelper.ReadProcessUInt32(num37 + GameConfigurationManager.memorySignatureScanConfig_74.resolvedValue, characterAccountConfig.int_137);
												if (num40 != 0)
												{
										...
										{
											int num43 = 0;
											if ((Form1.remoteAuxiliarySyncModeEnabled <= 0 && Form1.manualAuxiliaryMachineModeEnabled <= 0) || TongKimBattlefieldHelper.FindBattlefieldMapGroupPosition(CharacterStateSyncCoordinator.characterSyncSnapshot_1.mapId) == null)
											{
												if (TongKimBattlefieldHelper.FindBattlefieldMapGroupPosition(CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId) != null)
												{
													num43 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId;
												}
											}
											else
											{
												num43 = CharacterStateSyncCoordinator.characterSyncSnapshot_1.mapId;
											}
									...
									if (num26 > 0 && !flag8)
									{
										...
										if (array7 != null)
										{
											...
											if (array3[0] != 0)
											{
												if (TongKimBattlefieldHelper.uint_0 != null && TongKimBattlefieldHelper.uint_0[0] != 0 && TongKimBattlefieldHelper.uint_0[1] != 0 && TongKimBattlefieldHelper.uint_1 != null && TongKimBattlefieldHelper.uint_1[0] != 0 && TongKimBattlefieldHelper.uint_1[1] != 0 && TongKimBattlefieldHelper.int_1 == num25)
												{
													...
													long num45 = GameAutomationUtility.GetSquaredCoordinateDistance(array5, TongKimBattlefieldHelper.uint_1);
													if (!flag8)
													{
													...
													if (flag8)
													{
														uint[] uint_3 = GameAutomationUtility.GetCoordinateOffsetAlongLine(TongKimBattlefieldHelper.uint_0, TongKimBattlefieldHelper.uint_1, 1000);
										...
										if (characterAccountConfig.int_63 > 0 && (num < 0 || num != InventoryItemMemoryHelper.GetInventoryEntryCount(characterAccountConfig)))
										{
											GameAutomationUtility.UseMatchingInventoryItems(characterAccountConfig, characterAccountConfig.string_6);
											num = InventoryItemMemoryHelper.GetInventoryEntryCount(characterAccountConfig);
										}
										flag12 = (Form1.remoteAuxiliarySyncModeEnabled > 0 || Form1.manualAuxiliaryMachineModeEnabled > 0) && Form1.findMainAccountEnabled > 0 && (CharacterStateSyncCoordinator.characterSyncSnapshot_1.fightState > 0 || Form1.findMainAccountInCityEnabled > 0) && CharacterStateSyncCoordinator.characterSyncSnapshot_1.mapId > 0 && CommonUtility.IsNonZeroCoordinatePair(CharacterStateSyncCoordinator.characterSyncSnapshot_1.coordinates) && (characterAccountConfig.int_136 == CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId || CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId <= 0);
										flag2 = Form1.findMainAccountEnabled > 0 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId > 0 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId != characterAccountConfig.int_136 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.entityExistsFlag > 0 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId == num25 && CommonUtility.IsNonZeroCoordinatePair(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates) && CharacterStateSyncCoordinator.characterSyncSnapshot_0.fightState > 0;
										...
										if (flag2 && characterAccountConfig.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId)
										{
											array5 = new uint[2]
											{
												WindowsInteropHelper.ReadProcessUInt32(num22 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, characterAccountConfig.int_137),
											...
											num46 = GameAutomationUtility.GetSquaredCoordinateDistance(array5, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates);
											if (characterAccountConfig.int_130[0] > 0 && characterAccountConfig.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId && num26 == CharacterStateSyncCoordinator.characterSyncSnapshot_0.fightState && num26 > 0)
											{
												int num47 = characterAccountConfig.int_130[1] + Form1.mainAccountSearchDistance;
												if (num46 <= num47 * num47 && CircularMovementHelper.MoveToNextPointAroundCenter(characterAccountConfig, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, characterAccountConfig.int_130[1]) > 0)
												{
													goto IL_2d8e;
												}
											}
											...
											int_2 = 0;
											num17 = 0;
											if (num26 > 0 && !characterAccountConfig.bool_22 && characterAccountConfig.int_93 == 1 && Form1.dismountWhenReadyEnabled > 0 && (Form1.attackMonstersEnabled > 0 || Form1.attackPlayersEnabled > 0 || Form1.prioritizeBossTargetsEnabled > 0) && WindowsInteropHelper.ReadProcessUInt32(num22 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, characterAccountConfig.int_137) != 0)
											{
											...
											if (num10 <= 0L || CommonUtility.GetElapsedMilliseconds(num10) >= 1500L)
											{
												...
												if (CharacterStateSyncCoordinator.RefreshTrackedEntityPositionAndDetectSeparation(num5, ref array5, ref uint_) > 0)
												{
													long num49 = GameAutomationUtility.GetSquaredCoordinateDistance(uint_4, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates);
													long num50 = GameAutomationUtility.GetSquaredCoordinateDistance(array5, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates);
													if (num50 > num12 * num12)
													{
														if (num48 > 0)
														{
															uint[] uint_5 = GameAutomationUtility.GetCoordinateOffsetAlongLine(array5, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, -100);
													...
													num13 = 0;
													CharacterStateSyncCoordinator.MoveTowardCoordinateWithOffset(characterAccountConfig, array5, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, num49 <= 5625L);
													goto IL_2d1f;
												}
												num10 = 0L;
												if (num13 == 0 && GameAutomationUtility.GetSquaredCoordinateDistance(uint_4, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates) > Form1.mainAccountSearchDistance * Form1.mainAccountSearchDistance)
												{
													num7++;
													if (num7 > 3)
													{
										...
										else
										{
											if (characterAccountConfig.int_68 != null && characterAccountConfig.int_68[0] > 0 && !AuxiliaryMachineManager.bool_3)
											{
												...
												{
													array8 = GameAutomationUtility.FindConfiguredTargetCharacterCoordinates(characterAccountConfig, ref int_3);
													if (array8 != null)
													{
														num9 = 0L;
														long num51 = GameAutomationUtility.GetSquaredCoordinateDistance(array5, array8);
														if (num51 < 8000L)
														{
															goto IL_1615;
														}
											...
											if (flag12)
											{
												...
												num23 = (int)WindowsInteropHelper.ReadProcessUInt32(num22 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, characterAccountConfig.int_137);
												if (num23 < 3)
												{
													array5 = new uint[2]
													{
									...
									array3[0] = 0;
									WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, characterAccountConfig.uint_16 + GameProcessInteractionHelper.uint_22 * 4, array3, 1, ref int_7);
									if (characterAccountConfig.int_136 == CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId && Form1.mainAccountLeavesRearCampEnabled <= 0 && ((Form1.remoteAuxiliarySyncModeEnabled <= 0 && Form1.manualAuxiliaryMachineModeEnabled <= 0) || CharacterStateSyncCoordinator.characterSyncSnapshot_1.mapId <= 0))
									{
										Thread.Sleep(300);
										break;
									}
									if (Form1.disableTongKimMedicinePurchaseEnabled <= 0 && (!flag5 || flag8 || num < 0 || num != InventoryItemMemoryHelper.GetInventoryEntryCount(characterAccountConfig)))
									{
										...
										num = InventoryItemMemoryHelper.GetInventoryEntryCount(characterAccountConfig);
										uint num54 = 1500000u;
										uint num55 = num18 + GameConfigurationManager.memorySignatureScanConfig_12.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_75.resolvedValue;
										uint num56 = WindowsInteropHelper.ReadProcessUInt32(num55 + GameConfigurationManager.memorySignatureScanConfig_73.resolvedValue, characterAccountConfig.int_137);
										uint num57 = WindowsInteropHelper.ReadProcessUInt32(num55 + GameConfigurationManager.memorySignatureScanConfig_74.resolvedValue, characterAccountConfig.int_137);
										if (num56 <= 1500000)
										{
									...
									flag8 = false;
									if (Form1.findMainAccountEnabled <= 0 || CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId <= 0)
									{
									}
									bool flag13 = Form1.findMainAccountEnabled > 0 && (Form1.remoteAuxiliarySyncModeEnabled > 0 || Form1.manualAuxiliaryMachineModeEnabled > 0);
									if (0 > num35)
									{
										WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, array3, 4, ref int_7);
										num25 = BitConverter.ToInt32(array3, 0);
										num17 = 0;
										if (Form1.findMainAccountEnabled > 0)
										{
											if (Form1.auxiliaryAccountsWaitForMainAccountEnabled > 0 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId != characterAccountConfig.int_136 && (CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId == 0 || (CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId > 0 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.fightState == 0)))
											{
												break;
											}
											if (Form1.scoutModeEnabled > 0)
											{
												...
												if (Form1.customScoutMenuSelectionEnabled > 0 && (CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId != characterAccountConfig.int_136 || flag13))
												{
													uint[] uint_6 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates;
													if (flag13)
													{
									...
									else if ((characterAccountConfig.int_136 == CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId && (Form1.mainAccountLeavesRearCampEnabled > 0 || ((Form1.remoteAuxiliarySyncModeEnabled > 0 || Form1.manualAuxiliaryMachineModeEnabled > 0) && CharacterStateSyncCoordinator.characterSyncSnapshot_1.mapId > 0))) || (characterAccountConfig.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId && (Form1.auxiliaryAccountsWaitForMainAccountEnabled <= 0 || CharacterStateSyncCoordinator.characterSyncSnapshot_0.fightState > 0)))
									{
										GameAutomationUtility.FollowCoordinateRoute(characterAccountConfig, TongKimBattlefieldHelper.uint_3, null, null, num25);
									}
									break;
								}
								flag5 = false;
								...
								while (num3 != num25 && num60 < 15)
								{
									...
									num20 = BitConverter.ToUInt32(array3, 0);
									num22 = num20 + num21;
									WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array3, 4, ref int_7);
							...
							else
							{
								...
								if (flag11 || FormDame.alwaysAttackEnabled > 0)
								{
									...
									bool flag17 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.spaceKeyPressedFlag == 1 || (flag12 && CharacterStateSyncCoordinator.characterSyncSnapshot_1.spaceKeyPressedFlag == 1);
							...
							if (!flag12)
							{
								...
								{
									uint num65 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.packedMousePosition >> 16;
									uint num66 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.packedMousePosition - (num65 << 16);
									array10 = GameInterfaceMemoryHelper.ConvertScreenToWorldCoordinates(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, (int)num66, (int)num65);
									uint[] array11 = GameInterfaceMemoryHelper.ConvertWorldToScreenCoordinates(array5, array10);
									num64 = (array11[1] << 16) + array11[0];
									uint_7 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates;
									GameInterfaceMemoryHelper.WritePackedMousePosition(characterAccountConfig, num64);
									Thread.Sleep(10);
								}
							}
							else
							{
								uint num67 = CharacterStateSyncCoordinator.characterSyncSnapshot_1.packedMousePosition >> 16;
								uint num68 = CharacterStateSyncCoordinator.characterSyncSnapshot_1.packedMousePosition - (num67 << 16);
								array10 = GameInterfaceMemoryHelper.ConvertScreenToWorldCoordinates(CharacterStateSyncCoordinator.characterSyncSnapshot_1.coordinates, (int)num68, (int)num67);
								uint[] array12 = GameInterfaceMemoryHelper.ConvertWorldToScreenCoordinates(array5, array10);
								num64 = (array12[1] << 16) + array12[0];
								uint_7 = CharacterStateSyncCoordinator.characterSyncSnapshot_1.coordinates;
								GameInterfaceMemoryHelper.WritePackedMousePosition(characterAccountConfig, num64);
								Thread.Sleep(10);
							}
							GameAutomationUtility.ApplyConfiguredHorseSwitching(characterAccountConfig);
							...
							if (num64 != 0 && characterAccountConfig.int_136 != ApplicationRuntimeCoordinator.foregroundCharacterAccount.int_136)
							{
								if (characterAccountConfig.int_95 <= 0)
								{
									WindowsInteropHelper.ReadProcessUInt32(num22 + GameConfigurationManager.memorySignatureScanConfig_31.resolvedValue, characterAccountConfig.int_137);
								...
								{
									uint[] array13 = GameAutomationUtility.GetCoordinateOffsetAlongLine(uint_7, array10, -1 * (Form1.mainAccountSearchDistance - 50));
									long num70 = GameAutomationUtility.GetSquaredCoordinateDistance(array5, array13);
									if (num70 > 7000L)
									{
							...
							if (flag11)
							{
								...
								{
									num25 = (int)WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, characterAccountConfig.int_137);
									array5 = new uint[2]
									{
										WindowsInteropHelper.ReadProcessUInt32(num22 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, characterAccountConfig.int_137),
										WindowsInteropHelper.ReadProcessUInt32(num22 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_59.resolvedValue, characterAccountConfig.int_137)
									...
									uint[] uint_8 = array5;
									if (flag2 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId == num25 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.fightState > 0 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates != null)
									{
										uint_8 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates;
										num31 += num12;
									}
									uint num71 = 0u;
									if (Form1.shareTargetEnabled > 0 && (flag12 || flag2))
									{
										if (flag12)
										{
											if (CharacterStateSyncCoordinator.characterSyncSnapshot_1.mapId == num25 && CharacterStateSyncCoordinator.characterSyncSnapshot_1.currentTargetEntityId != num5)
											{
												num71 = CharacterStateSyncCoordinator.characterSyncSnapshot_1.currentTargetEntityId;
											}
										}
										else if (flag2 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId == num25 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.currentTargetEntityId != num5)
										{
											num71 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.currentTargetEntityId;
										}
									...
									if (characterAccountConfig.int_119 > 0 && characterAccountConfig.int_3 != null)
									{
										...
										if (array14 != null && array14[0, 0] >= 0)
										{
											...
											while (true)
											{
												...
												num23 = (int)WindowsInteropHelper.ReadProcessUInt32(num22 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, characterAccountConfig.int_137);
												num24 = (int)WindowsInteropHelper.ReadProcessUInt32(num22 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, characterAccountConfig.int_137);
												num26 = (int)WindowsInteropHelper.ReadProcessUInt32(num22 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, characterAccountConfig.int_137);
												int num76 = (int)WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, characterAccountConfig.int_137);
												if (num26 > 0 && num25 == num76 && num23 != 11 && num23 != 22 && num24 != 0)
												{
													for (int k = 0; k < array14.GetLength(0); k++)
													{
														...
														num75 = num20 + (uint)(num34 * (int)GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue);
														WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num75 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array3, 4, ref int_7);
														...
														if (num33 > 0)
														{
															WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num75 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, array3, 4, ref int_7);
															if (BitConverter.ToInt32(array3, 0) <= 0)
															{
																continue;
															}
														...
														if (!flag21 || num33 > 0)
														{
															...
															num32 = num74;
															WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num75 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, array3, 4, ref int_7);
															array6[0] = BitConverter.ToUInt32(array3, 0);
															WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num75 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_59.resolvedValue, array3, 4, ref int_7);
															...
															if (flag2)
															{
																...
																long num77 = GameAutomationUtility.GetSquaredCoordinateDistance(array5, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates);
																if (int_8 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId || num77 > num12 * num12)
																{
																	goto IL_2304;
																}
																int num78 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, array6));
																int num79 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(array5, array6));
															...
															if (GameAutomationUtility.GetSquaredCoordinateDistance(array5, array6) > num32 * num32 && characterAccountConfig.int_95 <= 0)
															{
																continue;
															}
															for (num15 = 0; num15 < GameConfigurationManager.int_0; num15++)
															...
															WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_161.resolvedValue - 8, BitConverter.GetBytes(num73), 4, ref int_7);
												...
												if (num13 <= 0 && characterAccountConfig.int_6 <= 0 && flag20)
												{
													...
													for (int l = 0; l < array14.GetLength(0); l++)
													{
														...
														num75 = num20 + (uint)(num83 * (int)GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue);
														WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num75 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array3, 4, ref int_7);
														if (BitConverter.ToInt32(array3, 0) <= 0)
														{
															continue;
														...
														WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num75 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_59.resolvedValue, array3, 4, ref int_7);
														array6[1] = BitConverter.ToUInt32(array3, 0);
														long num85 = GameAutomationUtility.GetSquaredCoordinateDistance(array5, array6);
														...
														if (flag2)
														{
															int num86 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, array6));
															int num87 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(array5, array6));
													...
													WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_161.resolvedValue - 8, BitConverter.GetBytes(CharacterSkillHelper.ReadLeftSkillId(characterAccountConfig)), 4, ref int_7);
													WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_31.resolvedValue, BitConverter.GetBytes(num32), 4, ref int_7);
													WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, BitConverter.GetBytes(num34), 4, ref int_7);
												}
										...
										if (array14 != null)
										{
											...
											while (true)
											{
												if (array14[num89, 1] > 0)
												{
													...
													{
														int num90 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(array5, array6));
														int num91 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, array6));
														if (num90 - num32 > 0)
														{
															if (num91 > num90)
															{
																int num92 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, array5));
												...
												if (Form1.fightUntilDeathEnabled > 0 && (num33 <= 0 || num33 == array2[0]) && array2[1] > 0 && array2[2] == num25 && array2[3] > 0)
												{
													int num93 = array2[0];
													int num94 = array2[1];
													uint num95 = num20 + (uint)(num94 * (int)GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue);
													WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num95 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array3, 4, ref int_7);
													if (BitConverter.ToInt32(array3, 0) > 0)
													{
														WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num95 + GameConfigurationManager.memorySignatureScanConfig_45.resolvedValue, array3, 4, ref int_7);
														long num96 = BitConverter.ToInt32(array3, 0);
														if ((ulong)num96 > 0uL)
														{
															WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num95 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, array3, 4, ref int_7);
															if (num93 <= 0 || BitConverter.ToInt32(array3, 0) > 0)
															{
																array6 = new uint[2]
																{
																	WindowsInteropHelper.ReadProcessUInt32(num95 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, characterAccountConfig.int_137),
																	WindowsInteropHelper.ReadProcessUInt32(num95 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_59.resolvedValue, characterAccountConfig.int_137)
																};
																long num97 = GameAutomationUtility.GetSquaredCoordinateDistance(array5, array6);
																if (!flag2)
																{
																...
																else
																{
																	...
																	int num99 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, array6));
																	if (num98 - num32 <= 0)
																	{
																		num33 = num93;
																		num34 = num94;
																	...
																	{
																		int num100 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, array5));
							...
							goto IL_2d1f;
							IL_2d1f:
							if (!flag11 && characterAccountConfig.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId && CurrentCharacterMemoryHelper.GetCurrentTargetEntityIndexByTypes(characterAccountConfig, new int[2] { 0, 1 }) != 0)
							{
								if (num13 > 0)
								{
									WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, byte_, 4, ref int_7);
							...
							if (int_2 > 3)
							{
								long num101 = GameAutomationUtility.GetSquaredCoordinateDistance(uint_2, array5);
								uint_2 = null;
								num17 = 0;
								if (num101 < 180000L)
								{
							...
							if (Form1.scoutModeEnabled > 0 && num46 > 2000000L && num17 <= 0)
							{
								...
								if (Form1.customScoutMenuSelectionEnabled > 0 && (CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId != characterAccountConfig.int_136 || flag12))
								{
									uint[] uint_9 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates;
									if (flag12)
									{
										uint_9 = CharacterStateSyncCoordinator.characterSyncSnapshot_1.coordinates;
									}
				...
				else
				{
					...
					{
						WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_251.resolvedValue, GameConfigurationManager.byte_0, GameConfigurationManager.byte_0.Length, ref int_7);
					}
					num13 = 0;
					num14 = 0;
				}
	...
	private static void RunBattlefieldStatusOverlayWorker(int int_1)
	{
		...
		while (true)
		{
			...
			uint num7 = num6 + num5;
			uint_ = num7 + GameConfigurationManager.memorySignatureScanConfig_89.resolvedValue;
