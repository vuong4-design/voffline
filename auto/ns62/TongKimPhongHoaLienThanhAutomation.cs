	...
	public static void Run(int int_1)
	{
		...
		while (true)
		{
			...
			if (!characterAccountConfig.bool_15 && Class75.smethod_3(characterAccountConfig, Class75.uint_48, 4) <= 0)
			{
				...
				Class24.ReadProcessMemory(characterAccountConfig.int_137, GameConfigurationManager.memorySignatureScanConfig_11.uint_0, array3, 4, ref array4[0]);
				uint num18 = BitConverter.ToUInt32(array3, 0);
				Class24.ReadProcessMemory(characterAccountConfig.int_137, num18 + GameConfigurationManager.memorySignatureScanConfig_13.uint_0, array3, 4, ref array4[1]);
				uint num19 = BitConverter.ToUInt32(array3, 0);
				Class24.ReadProcessMemory(characterAccountConfig.int_137, GameConfigurationManager.memorySignatureScanConfig_14.uint_0, array3, 4, ref array4[2]);
				...
				Class24.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_55.uint_0, array3, 4, ref array4[4]);
				int num23 = BitConverter.ToInt32(array3, 0);
				Class24.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, array3, 4, ref array4[5]);
				int num24 = BitConverter.ToInt32(array3, 0);
				Class24.ReadProcessMemory(characterAccountConfig.int_137, GameConfigurationManager.memorySignatureScanConfig_27.uint_0, array3, 4, ref array4[6]);
				int num25 = BitConverter.ToInt32(array3, 0);
				Class24.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, array3, 4, ref array4[7]);
				...
				if ((characterAccountConfig.int_136 != ApplicationRuntimeCoordinator.characterAccountConfig_0.int_136 && characterAccountConfig.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.int_0) || (num27 != 1 && num27 != 2))
				{
					...
					if (num24 != 0 && num23 != 0 && num25 != 0 && num23 != 10 && num23 != 21 && num28 > 1)
					{
						...
						while (true)
						{
							...
							{
								Class24.smethod_30(num22 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_58.uint_0, characterAccountConfig.int_137),
								Class24.smethod_30(num22 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_59.uint_0, characterAccountConfig.int_137)
							};
							...
							if (!flag7)
							{
								if (num3 == num25)
								{
									if (num4 != num26)
									{
										...
										{
											Class24.ReadProcessMemory(characterAccountConfig.int_137, GameConfigurationManager.memorySignatureScanConfig_11.uint_0, array3, 4, ref int_7);
											num18 = BitConverter.ToUInt32(array3, 0);
											Class24.ReadProcessMemory(characterAccountConfig.int_137, num18 + GameConfigurationManager.memorySignatureScanConfig_13.uint_0, array3, 4, ref int_7);
											num19 = BitConverter.ToUInt32(array3, 0);
											num21 = num19 * GameConfigurationManager.memorySignatureScanConfig_15.uint_0;
											Class24.ReadProcessMemory(characterAccountConfig.int_137, GameConfigurationManager.memorySignatureScanConfig_14.uint_0, array3, 4, ref int_7);
											num20 = BitConverter.ToUInt32(array3, 0);
											num22 = num20 + num21;
											Class24.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, array3, 4, ref int_7);
									...
									if (array7 == null && 0 > num35 && (Class64.smethod_9(num25) != null || TongKimBattlefieldHelper.smethod_1(num25) != null || 0 > TongKimBattlefieldHelper.smethod_3(array5, num25)))
									{
										...
										{
											Class24.WriteProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_72.uint_0, byte_, 4, ref int_7);
										...
										if (num26 <= 0)
										{
											...
											uint num38 = Class24.smethod_30(num37 + GameConfigurationManager.memorySignatureScanConfig_73.uint_0, characterAccountConfig.int_137);
											...
											{
												flag4 = true;
												uint num40 = Class24.smethod_30(num37 + GameConfigurationManager.memorySignatureScanConfig_74.uint_0, characterAccountConfig.int_137);
												if (num40 != 0)
												{
									...
									if (num26 > 0 && !flag8)
									{
										...
										if (array7 != null)
										{
											...
											if (array3[0] != 0)
											{
												if (TongKimBattlefieldHelper.uint_0 != null && TongKimBattlefieldHelper.uint_0[0] != 0 && TongKimBattlefieldHelper.uint_0[1] != 0 && TongKimBattlefieldHelper.uint_1 != null && TongKimBattlefieldHelper.uint_1[0] != 0 && TongKimBattlefieldHelper.uint_1[1] != 0 && TongKimBattlefieldHelper.int_1 == num25)
												{
													...
													long num45 = Class64.smethod_18(array5, TongKimBattlefieldHelper.uint_1);
													if (!flag8)
													{
														...
														{
															Class75.smethod_61(characterAccountConfig, TongKimBattlefieldHelper.uint_1);
														}
													}
													if (flag8)
													{
										...
										if (flag2 && characterAccountConfig.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.int_0)
										{
											...
											int_2 = 0;
											num17 = 0;
											if (num26 > 0 && !characterAccountConfig.bool_22 && characterAccountConfig.int_93 == 1 && Form1.int_109 > 0 && (Form1.int_35 > 0 || Form1.int_34 > 0 || Form1.int_36 > 0) && Class24.smethod_30(num22 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, characterAccountConfig.int_137) != 0)
											{
										...
										else
										{
											...
											if (flag12)
											{
												...
												num23 = (int)Class24.smethod_30(num22 + GameConfigurationManager.memorySignatureScanConfig_55.uint_0, characterAccountConfig.int_137);
												if (num23 < 3)
												{
													array5 = new uint[2]
													{
									...
									if (Form1.int_97 <= 0 && (!flag5 || flag8 || num < 0 || num != Class85.smethod_4(characterAccountConfig)))
									{
										...
										uint num56 = Class24.smethod_30(num55 + GameConfigurationManager.memorySignatureScanConfig_73.uint_0, characterAccountConfig.int_137);
										uint num57 = Class24.smethod_30(num55 + GameConfigurationManager.memorySignatureScanConfig_74.uint_0, characterAccountConfig.int_137);
										if (num56 <= 1500000)
										{
									...
									if (0 > num35)
									{
										Class24.ReadProcessMemory(characterAccountConfig.int_137, GameConfigurationManager.memorySignatureScanConfig_27.uint_0, array3, 4, ref int_7);
								...
								while (num3 != num25 && num60 < 15)
								{
									...
									num20 = BitConverter.ToUInt32(array3, 0);
									num22 = num20 + num21;
									Class24.ReadProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, array3, 4, ref int_7);
							...
							if (num64 != 0 && characterAccountConfig.int_136 != ApplicationRuntimeCoordinator.characterAccountConfig_0.int_136)
							{
								...
								{
									Class24.smethod_30(num22 + GameConfigurationManager.memorySignatureScanConfig_31.uint_0, characterAccountConfig.int_137);
							...
							if (flag11)
							{
								...
								{
									num25 = (int)Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_27.uint_0, characterAccountConfig.int_137);
									array5 = new uint[2]
									{
										Class24.smethod_30(num22 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_58.uint_0, characterAccountConfig.int_137),
										Class24.smethod_30(num22 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_59.uint_0, characterAccountConfig.int_137)
									...
									if (characterAccountConfig.int_119 > 0 && characterAccountConfig.int_3 != null)
									{
										...
										if (array14 != null && array14[0, 0] >= 0)
										{
											...
											while (true)
											{
												...
												num23 = (int)Class24.smethod_30(num22 + GameConfigurationManager.memorySignatureScanConfig_55.uint_0, characterAccountConfig.int_137);
												num24 = (int)Class24.smethod_30(num22 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, characterAccountConfig.int_137);
												num26 = (int)Class24.smethod_30(num22 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, characterAccountConfig.int_137);
												int num76 = (int)Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_27.uint_0, characterAccountConfig.int_137);
												if (num26 > 0 && num25 == num76 && num23 != 11 && num23 != 22 && num24 != 0)
												{
													for (int k = 0; k < array14.GetLength(0); k++)
													{
														...
														Class24.ReadProcessMemory(characterAccountConfig.int_137, num75 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, array3, 4, ref int_7);
														...
														if (num33 > 0)
														{
															Class24.ReadProcessMemory(characterAccountConfig.int_137, num75 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, array3, 4, ref int_7);
															if (BitConverter.ToInt32(array3, 0) <= 0)
															{
																continue;
															}
														...
														if (!flag21 || num33 > 0)
														{
															...
															num32 = num74;
															Class24.ReadProcessMemory(characterAccountConfig.int_137, num75 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_58.uint_0, array3, 4, ref int_7);
															array6[0] = BitConverter.ToUInt32(array3, 0);
															Class24.ReadProcessMemory(characterAccountConfig.int_137, num75 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_59.uint_0, array3, 4, ref int_7);
															...
															Class24.WriteProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_161.uint_0 - 8, BitConverter.GetBytes(num73), 4, ref int_7);
															Class24.WriteProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_31.uint_0, BitConverter.GetBytes(num32), 4, ref int_7);
															Class24.WriteProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_72.uint_0, BitConverter.GetBytes(num34), 4, ref int_7);
															Thread.Sleep(10);
															num13 = 1;
															continue;
														}
												...
												if (num13 <= 0 && characterAccountConfig.int_6 <= 0 && flag20)
												{
													...
													Class24.WriteProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_161.uint_0 - 8, BitConverter.GetBytes(CharacterSkillHelper.smethod_13(characterAccountConfig)), 4, ref int_7);
													Class24.WriteProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_31.uint_0, BitConverter.GetBytes(num32), 4, ref int_7);
													Class24.WriteProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_72.uint_0, BitConverter.GetBytes(num34), 4, ref int_7);
												}
										...
										if (array14 != null)
										{
											...
											while (true)
											{
												...
												if (Form1.int_56 > 0 && (num33 <= 0 || num33 == array2[0]) && array2[1] > 0 && array2[2] == num25 && array2[3] > 0)
												{
													...
													Class24.ReadProcessMemory(characterAccountConfig.int_137, num95 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, array3, 4, ref int_7);
													if (BitConverter.ToInt32(array3, 0) > 0)
													{
														Class24.ReadProcessMemory(characterAccountConfig.int_137, num95 + GameConfigurationManager.memorySignatureScanConfig_45.uint_0, array3, 4, ref int_7);
														long num96 = BitConverter.ToInt32(array3, 0);
														if ((ulong)num96 > 0uL)
														{
															Class24.ReadProcessMemory(characterAccountConfig.int_137, num95 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, array3, 4, ref int_7);
															if (num93 <= 0 || BitConverter.ToInt32(array3, 0) > 0)
															{
																array6 = new uint[2]
																{
																	Class24.smethod_30(num95 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_58.uint_0, characterAccountConfig.int_137),
																	Class24.smethod_30(num95 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_59.uint_0, characterAccountConfig.int_137)
																};
												...
												if (characterAccountConfig.gstruct50_0.int_0 == 0 || CombatTargetSelectionHelper.smethod_10(characterAccountConfig, (uint)num34) <= 0)
												{
													...
													Class24.WriteProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_161.uint_0 - 8, BitConverter.GetBytes(value2), 4, ref int_7);
													Class24.WriteProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_31.uint_0, BitConverter.GetBytes(num32), 4, ref int_7);
													Class24.WriteProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_72.uint_0, BitConverter.GetBytes(num34), 4, ref int_7);
												}
				...
				else
				{
					...
					if (Form1.int_127 > 0)
					{
						Class24.WriteProcessMemory(characterAccountConfig.int_137, num22 + GameConfigurationManager.memorySignatureScanConfig_251.uint_0, GameConfigurationManager.byte_0, GameConfigurationManager.byte_0.Length, ref int_7);
					}
					num13 = 0;
					num14 = 0;
				}
