...
internal class CircularMovementHelper
{
	public static int MoveToNextPointAroundCenter(CharacterAccountConfig accountConfig, uint[] centerPosition, int radius)
	{
		...
		Class24.ReadProcessMemory(accountConfig.int_137, GameConfigurationManager.memorySignatureScanConfig_11.uint_0, array, 4, ref int_1);
		uint num11 = BitConverter.ToUInt32(array, 0);
		Class24.ReadProcessMemory(accountConfig.int_137, num11 + GameConfigurationManager.memorySignatureScanConfig_13.uint_0, array, 4, ref int_1);
		uint num12 = BitConverter.ToUInt32(array, 0);
		uint num13 = num12 * GameConfigurationManager.memorySignatureScanConfig_15.uint_0;
		Class24.ReadProcessMemory(accountConfig.int_137, GameConfigurationManager.memorySignatureScanConfig_14.uint_0, array, 4, ref int_1);
		...
		{
			Class24.ReadProcessMemory(accountConfig.int_137, num15 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_58.uint_0, array, 4, ref int_1);
			array3[0] = BitConverter.ToUInt32(array, 0);
			Class24.ReadProcessMemory(accountConfig.int_137, num15 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_59.uint_0, array, 4, ref int_1);
