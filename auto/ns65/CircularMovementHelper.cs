...
internal class CircularMovementHelper
{
	public static int MoveToNextPointAroundCenter(CharacterAccountConfig accountConfig, uint[] centerPosition, int radius)
	{
		...
		WindowsInteropHelper.ReadProcessMemory(accountConfig.int_137, accountConfig.uint_16 + GameProcessInteractionHelper.circularMovementStateSlot * 4, array, 4, ref int_1);
		int num = BitConverter.ToInt32(array, 0);
		if (num != radius)
		{
			array = BitConverter.GetBytes(radius);
			WindowsInteropHelper.WriteProcessMemory(accountConfig.int_137, accountConfig.uint_16 + GameProcessInteractionHelper.circularMovementStateSlot * 4, array, 4, ref int_1);
			double num2 = 200.0;
			...
			WindowsInteropHelper.WriteProcessMemory(accountConfig.int_137, accountConfig.uint_16 + (GameProcessInteractionHelper.circularMovementStateSlot + 1) * 4, array, 4, ref int_1);
			array = BitConverter.GetBytes(360 / num5);
			WindowsInteropHelper.WriteProcessMemory(accountConfig.int_137, accountConfig.uint_16 + (GameProcessInteractionHelper.circularMovementStateSlot + 2) * 4, array, 4, ref int_1);
			array = new byte[4];
			WindowsInteropHelper.WriteProcessMemory(accountConfig.int_137, accountConfig.uint_16 + (GameProcessInteractionHelper.circularMovementStateSlot + 3) * 4, array, 4, ref int_1);
		}
		WindowsInteropHelper.ReadProcessMemory(accountConfig.int_137, accountConfig.uint_16 + (GameProcessInteractionHelper.circularMovementStateSlot + 1) * 4, array, 4, ref int_1);
		uint num6 = BitConverter.ToUInt32(array, 0);
		WindowsInteropHelper.ReadProcessMemory(accountConfig.int_137, accountConfig.uint_16 + (GameProcessInteractionHelper.circularMovementStateSlot + 2) * 4, array, 4, ref int_1);
		uint num7 = BitConverter.ToUInt32(array, 0);
		WindowsInteropHelper.ReadProcessMemory(accountConfig.int_137, accountConfig.uint_16 + (GameProcessInteractionHelper.circularMovementStateSlot + 3) * 4, array, 4, ref int_1);
