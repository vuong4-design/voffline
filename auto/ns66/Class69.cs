...
internal class Class69
{
	...
	public static void smethod_0(int int_4)
	{
		...
		while (true)
		{
			...
			int num21 = Class89.smethod_39(characterAccountConfig_);
			uint[] array5;
			if (num19 != 0 && num18 != 0 && num20 != 0 && num21 > 1)
			{
				if (Class89.smethod_12(characterAccountConfig_) > 0)
				{
					if (Form1.int_127 > 0)
					{
				...
				else if (num18 != 10 && num18 != 21)
				{
								...
								if (num28 <= 22500L)
								{
									...
									if (flag3)
									{
										...
										if (num29 <= 0)
										{
											...
											if (int_6 > 0)
											{
												Class89.smethod_31(characterAccountConfig_, "_bad_" + num9, bool_0: false);
											}
										}
										else
										{
											Class89.smethod_31(characterAccountConfig_, "_good_" + num9, bool_0: false);
										}
									}
									else
									{
					...
					else
					{
						...
						num12++;
						uint[] uint_4 = null;
						int num30 = Class3.smethod_15(characterAccountConfig_, "Þch quan", ref uint_4, 3, bool_0: false);
						if (num30 <= 0)
						{
							if (num12 > 5)
							{
		...
		while (true)
		{
			...
			if (characterAccountConfig_0.bool_25 && characterAccountConfig_0.int_20[0] > 0 && characterAccountConfig_0.int_20[1] > 0)
			{
				...
				while (true)
				{
					...
					Thread.Sleep(300);
					num8 = 0;
					while (Class95.smethod_0(characterAccountConfig_0) < 0 && num8 < 10)
					{
					...
					int num9 = Class95.smethod_0(characterAccountConfig_0);
					num8 = Class95.smethod_1(characterAccountConfig_0, num9);
					int num10 = -1;
					for (int i = 0; i < num8; i++)
					{
						string string_ = Class95.smethod_3(characterAccountConfig_0, i, num9, 128);
					...
					Class95.smethod_5(characterAccountConfig_0, num10);
					Thread.Sleep(600);
					Class95.smethod_5(characterAccountConfig_0, 0);
					Thread.Sleep(600);
					if (num6 < 3)
				...
				if (num10 <= 0 && num9 >= 387 && num9 <= 389)
				{
					...
					while (true)
					{
						...
						if (num12 <= 1000000L)
						{
							...
							{
								uint[] array3 = null;
								int num13 = Class3.smethod_15(characterAccountConfig_0, "DÞch quan", ref array3, 3, bool_0: false, 300);
								if (num13 > 0)
								{
									Class95.smethod_8(characterAccountConfig_0);
									...
									Thread.Sleep(300);
									bool flag = false;
									int num14 = Class95.smethod_0(characterAccountConfig_0);
									num = Class95.smethod_1(characterAccountConfig_0, num14);
									...
									for (int i = 0; i < num; i++)
									{
										string string_2 = Class95.smethod_3(characterAccountConfig_0, i, num14, 128);
										if (Class11.smethod_2(string_2, string_))
										{
											Class95.smethod_5(characterAccountConfig_0, i);
											Thread.Sleep(300 + Class95.int_0);
											flag = true;
											num2++;
											break;
										}
	...
	private static int smethod_3(CharacterAccountConfig characterAccountConfig_0)
	{
		...
		while (true)
		{
			...
			if (characterAccountConfig_0.bool_25 && characterAccountConfig_0.int_20[0] > 0 && characterAccountConfig_0.int_20[1] > 0)
			{
				string[] array2 = Class89.smethod_26(characterAccountConfig_0, 6u);
				if (array2 != null)
				{
					for (int i = 0; i < array2.Length; i++)
					{
						if (array2[i] != null && 0 <= Class11.smethod_1(array2[i], "hÕt thêi gian"))
						{
							for (int j = 0; j < 6; j++)
							{
								Class89.smethod_31(characterAccountConfig_0, "_bad", bool_0: false);
							}
							Class95.smethod_8(characterAccountConfig_0);
							return -1;
						}
				...
				int num10 = 0;
				uint[] array4 = null;
				int num11 = Class3.smethod_15(characterAccountConfig_0, "C\u00b8nh tr|B", ref array4, 3, bool_0: false);
				if (num11 <= 0)
				{
					array = new byte[80];
					long num12 = 0L;
				...
				do
				{
					IL_04b2:
					Class95.smethod_8(characterAccountConfig_0);
					if (Class3.smethod_17(characterAccountConfig_0, num11))
					{
						...
						Thread.Sleep(300);
						num2 = Class95.smethod_1(characterAccountConfig_0);
						num = 0;
						num10++;
						if (num10 <= 1 || num2 <= 1)
						{
						...
						Class95.smethod_5(characterAccountConfig_0, 1);
						Thread.Sleep(600);
						Class95.smethod_5(characterAccountConfig_0, 0);
						return 1;
					}
	...
	private static int smethod_4(CharacterAccountConfig characterAccountConfig_0, ref int int_4, uint[] uint_23 = null, int int_5 = 280, bool bool_1 = false)
	{
		...
		int_4 = Class3.smethod_15(characterAccountConfig_0, string_, ref array2, 3, bool_0: false, int_5, array);
		if (int_4 > 0)
		{
			...
			while (!Class11.bool_0)
			{
				...
				if (num9 != 0 && num9 != 10 && num9 != 21)
				{
					...
					empty = Class95.Class92.smethod_0(characterAccountConfig_0).ToLower();
					...
					{
						if (!(empty != string.Empty) && !Class95.Class92.smethod_4(characterAccountConfig_0) && Class3.smethod_17(characterAccountConfig_0, int_4))
						{
	...
	private static void smethod_5()
	{
		...
		while (true)
		{
			for (int i = 0; i < 20; i++)
			{
				if (!Class95.Class92.smethod_4(gstruct51_))
				{
					break;
				}
	...
	private static void smethod_9(int int_4)
	{
		...
		while (true)
		{
			...
			if (!flag4)
			{
				...
				if ((characterAccountConfig.int_136 != Class81.characterAccountConfig_0.int_136 && characterAccountConfig.int_136 != Class46.characterSyncSnapshot_0.int_0) || (num31 != 1 && num31 != 2))
				{
					...
					if (num30 != 0)
					{
						if (array3 == null)
						{
							string string_3 = Class95.Class92.smethod_0(characterAccountConfig);
							if (Class11.smethod_1(string_3, "t×m Tiªu Tr") > 0)
							{
								flag3 = true;
							}
							string[] array12 = Class89.smethod_26(characterAccountConfig, 16u);
							if (array12 != null)
							{
								int num32 = 0;
								...
								if (!flag3)
								{
									int num34 = Class3.smethod_13(characterAccountConfig, "Tiªu TrÊn", 3);
									if (num34 <= 0)
									{
										continue;
									}
							...
							if (array3 == null)
							{
								...
								if (text5 != string.Empty)
								{
									...
									if (array14.Length > 4)
									{
										...
										array15 = Class89.smethod_26(characterAccountConfig, 32u);
										if (array15 != null)
										{
											int num35 = 0;
						...
						if (num36 <= 60000L)
						{
							if (num36 <= 22500L)
							{
								int num37 = Class3.smethod_13(characterAccountConfig, "Tiªu TrÊn", 3);
								if (num37 <= 0)
								{
									num4++;
									if (num4 > 10)
								...
								while (true)
								{
									...
									if (num6 > 200)
									{
										if (num6 == 201)
										{
											...
											Class95.smethod_6(characterAccountConfig, string_4);
										}
									}
									else
									{
										string string_5 = "trao th|KÕt thóc";
										int num39 = Class95.smethod_6(characterAccountConfig, string_5);
										num6 = 201 * Convert.ToByte(num39 > 0);
									}
									Thread.Sleep(300);
									Class95.Class92.smethod_5(characterAccountConfig);
									if (Class3.smethod_11(characterAccountConfig, num37) <= 0)
									{
										if (0 <= num18)
										{
											Form1.int_61 = num18;
			...
			Class24.ReadProcessMemory(characterAccountConfig.int_137, characterAccountConfig.uint_16 + Class75.uint_43 * 4, array16, 4, ref int_6);
			...
			Class24.ReadProcessMemory(characterAccountConfig.int_137, characterAccountConfig.uint_16 + Class75.uint_44 * 4, array16, 1, ref int_6);
			int num47 = array16[0];
				...
				while (true)
				{
					...
					if (Class89.smethod_12(characterAccountConfig) != 1 && !Class46.smethod_7(characterAccountConfig, ref num19))
					{
						...
						while (true)
						{
							...
							if (Class3.smethod_31(characterAccountConfig, num8, num49) == 0)
							{
			...
			if (num7 != 1)
			{
				if (num7 == 2)
				{
					...
					long_4 = 0L;
					num11 = 0;
					num2 = Class3.smethod_13(characterAccountConfig, string_2, 3);
					if (num2 > 0)
					{
						flag = false;
						Class95.smethod_8(characterAccountConfig);
						...
						Thread.Sleep(600);
						int num52 = Class95.smethod_0(characterAccountConfig);
						int num53 = Class95.smethod_1(characterAccountConfig, num52);
						if (num53 > 0)
						{
							if (num6 > 200)
							{
								string string_6 = "Thñ Khè|n v× triÒu|giao nhiÖm|phÇn th|KÕt thóc";
								int num54 = Class95.smethod_6(characterAccountConfig, string_6);
								if (num54 > 0)
								{
									num6 = 0;
								}
							...
							else if (num6 <= 181)
							{
								...
								int num55 = Class95.smethod_6(characterAccountConfig, string_7);
							...
							else
							{
								...
								Class95.smethod_6(characterAccountConfig, string_8);
								Thread.Sleep(300);
								string string_9 = Class95.smethod_2(characterAccountConfig).ToLower();
								string text6 = Class95.Class92.smethod_0(characterAccountConfig).ToLower();
								Class95.smethod_8(characterAccountConfig);
				...
				num2 = Class3.smethod_13(characterAccountConfig, "Xa phu", 3, bool_0: true);
				if (num2 <= 0)
				{
					num4++;
					if (num4 > 10)
				...
				while (true)
				{
					...
					Class95.smethod_6(characterAccountConfig, "TÝn Sø|Mu");
					Thread.Sleep(1000);
					break;
				}
				continue;
			...
			continue;
			IL_1085:
			int num57 = Class3.smethod_13(characterAccountConfig, text + array3[num9], 3);
			if (num57 > 0)
			{
				for (int m = 0; m < 2; m++)
				{
					...
					Thread.Sleep(800);
					string[] array17 = Class89.smethod_26(characterAccountConfig, 4u);
					if (array17 == null)
					{
						continue;
					}
			...
			num8 = Class3.smethod_13(characterAccountConfig, text2 + array3[num9], 0);
			if (num8 <= 0)
			{
				continue;
			}
					...
					if (!bool_0 && (num12 <= 0L || num59 <= int_2[1] * 1000))
					{
						...
						if (gstruct61_.int_0 > 1)
						{
							...
							if (array8 == null)
							{
								...
								Class3.smethod_19(characterAccountConfig, num8);
							}
			...
			continue;
			IL_1e3d:
			num2 = Class3.smethod_15(characterAccountConfig, string_2, ref uint_, 3, bool_0: false);
			if (num2 > 0)
			{
				...
				while (true)
				{
					if (!Class11.bool_0)
					{
						...
						if (!Class95.Class92.smethod_4(characterAccountConfig) && (empty == null || !(empty != string.Empty)))
						{
							num67 = Class95.smethod_1(characterAccountConfig);
							if (num67 <= 0 && 0 > Class95.smethod_0(characterAccountConfig))
							{
								if (num68 <= 10)
								{
									num68++;
					...
					int num71 = Class95.smethod_0(characterAccountConfig);
					num67 = Class95.smethod_1(characterAccountConfig, num71);
					num69 = -1;
					if (num6 > 200)
					{
					...
					if (num67 > 0)
					{
						...
						{
							string text8 = Class95.smethod_3(characterAccountConfig, num72, num71, 128).ToLower();
					...
					Class95.smethod_5(characterAccountConfig, num69);
					Thread.Sleep(1000);
					Class95.smethod_8(characterAccountConfig);
					break;
				}
			...
			{
				num20 = 0;
				string[] array19 = Class89.smethod_26(characterAccountConfig, 6u);
				if (array19 != null)
				{
				...
				if (num8 > 0 && Class3.smethod_11(characterAccountConfig, num8) > 0)
				{
					string string_11 = Class3.smethod_22(characterAccountConfig, num8).ToLower();
