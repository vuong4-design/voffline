...
internal class TinSuMissionAutomation
{
	...
	public static uint[,] uint_14;

	public static uint[,] uint_15;

	public static uint[,] uint_16;

	public static uint[,] uint_17;
	...
	public static void RunTinSuPhongKyMissionAutomation(int int_4)
	{
		...
		while (true)
		{
			...
			characterAccountConfig_ = Form1.characterAccountConfig_1[num13];
			if (!characterAccountConfig_.bool_25 || characterAccountConfig_.int_20[0] <= 0 || characterAccountConfig_.int_20[1] <= 0)
			{
				break;
			}
			uint num14 = WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_11.resolvedValue, characterAccountConfig_.int_137);
			uint num15 = WindowsInteropHelper.ReadProcessUInt32(num14 + GameConfigurationManager.memorySignatureScanConfig_13.resolvedValue, characterAccountConfig_.int_137);
			uint num16 = WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_14.resolvedValue, characterAccountConfig_.int_137);
			uint num17 = num16 + num15 * GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue;
			int num18 = (int)WindowsInteropHelper.ReadProcessUInt32(num17 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, characterAccountConfig_.int_137);
			int num19 = (int)WindowsInteropHelper.ReadProcessUInt32(num17 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, characterAccountConfig_.int_137);
			int num20 = (int)WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, characterAccountConfig_.int_137);
			...
			if (num19 != 0 && num18 != 0 && num20 != 0 && num21 > 1)
			{
				if (GameInterfaceMemoryHelper.ReadEngineStateByte(characterAccountConfig_) > 0)
				{
					...
					{
						WindowsInteropHelper.WriteProcessMemory(characterAccountConfig_.int_137, num17 + GameConfigurationManager.memorySignatureScanConfig_251.resolvedValue, GameConfigurationManager.byte_0, GameConfigurationManager.byte_0.Length, ref int_5);
					}
				}
				else if (num18 != 10 && num18 != 21)
				{
					...
					array5 = new uint[2]
					{
						WindowsInteropHelper.ReadProcessUInt32(num17 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, characterAccountConfig_.int_137),
						WindowsInteropHelper.ReadProcessUInt32(num17 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_59.resolvedValue, characterAccountConfig_.int_137)
					};
					if (array5[0] == 0 || array5[1] == 0)
					{
						continue;
					}
					if (387 <= num20 && num20 <= 389)
					{
						num = 0;
						flag = false;
						flag2 = false;
						if (num22 <= 0)
						{
							...
							array2 = null;
							flag3 = false;
							if (characterAccountConfig_.bool_4)
							{
								num9 = 0;
							}
							bool_ = true;
						...
						while (true)
						{
							if (array3 != null)
							{
								...
								WindowsInteropHelper.WriteProcessMemory(characterAccountConfig_.int_137, num17 + GameConfigurationManager.memorySignatureScanConfig_89.resolvedValue, array, array.Length, ref int_5);
							}
							array5 = new uint[2]
							{
								WindowsInteropHelper.ReadProcessUInt32(num17 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, characterAccountConfig_.int_137),
							...
							{
								uint_ = null;
								flag4 = characterAccountConfig_.bool_4;
							}
							if (characterAccountConfig_.bool_4)
							{
								...
								if (characterAccountConfig_.bool_4 && characterAccountConfig_.int_21 <= num9 && uint_ != null && uint_.GetLength(0) - 1 <= num3)
								{
									break;
								}
								if (flag3)
								{
									if (array4 == null || num4 < 0 || array4.GetLength(0) <= num4)
									{
										uint_ = null;
										continue;
									}
								...
								if (uint_ == null || uint_.GetLength(0) <= num3 || num3 < 0)
								{
									uint_ = null;
									continue;
								}
							...
							if (int_0 == characterAccountConfig_.int_136 || uint_ == null)
							{
								...
								num2 = 0;
								int_0 = 0;
								if (characterAccountConfig_.int_34 > 0 && characterAccountConfig_.uint_3 != null && characterAccountConfig_.uint_3.GetLength(0) > 0)
								{
									uint_ = characterAccountConfig_.uint_2;
									array4 = characterAccountConfig_.uint_3;
									if (uint_ == null || uint_.GetLength(0) == 0)
									{
										uint_ = new uint[1, 2] { { 49523u, 99244u } };
									}
								}
								else
								{
					...
					if (num22 > 0)
					{
						if (GameProcessInteractionHelper.ReadSharedSlotIntegerValue(characterAccountConfig_, GameProcessInteractionHelper.uint_19, 4) > 0 && num < 3)
						{
							num++;
					...
					if (num20 != 80 && num20 != 37)
					{
						if (GameProcessInteractionHelper.ReadSharedSlotIntegerValue(characterAccountConfig_, GameProcessInteractionHelper.uint_19, 4) > 0 && num < 5)
						{
							num++;
			...
			continue;
			IL_0ab6:
			if (!CharacterMovementHelper.IsMovementActive(characterAccountConfig_) || CommonUtility.GetElapsedMilliseconds(long_) > 6000L)
			{
			...
			if (num31 <= 1000000L)
			{
				...
				if (num31 <= 22500L)
				{
					...
					else
					{
						...
						if (num9 < characterAccountConfig_.int_21)
						{
							for (int i = 0; i < uint_2.GetLength(0); i++)
							{
								if (uint_2[i, 0] != array3[0] || uint_2[i, 1] != array3[1])
								{
									continue;
								}
								bool flag6 = false;
	...
	private static int RunTinSuMissionNpcDialogSequence(CharacterAccountConfig characterAccountConfig_0, int int_4, uint[] uint_23 = null)
	{
		...
		while (true)
		{
			...
			if (CommonUtility.bool_0 || num7 < 0)
			{
				break;
			}
			...
			if (characterAccountConfig_0.bool_25 && characterAccountConfig_0.int_20[0] > 0 && characterAccountConfig_0.int_20[1] > 0)
			{
				...
				WindowsInteropHelper.WriteProcessMemory(characterAccountConfig_0.int_137, num4 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, array, array.Length, ref int_5);
				Thread.Sleep(300);
				num8 = 0;
				while (true)
				{
	...
	private static int NavigateTinSuMissionAreaViaDichQuan(CharacterAccountConfig characterAccountConfig_0)
	{
		int int_ = 0;
		byte[] array = null;
		uint[] uint_ = new uint[2] { 50338u, 100212u };
		long long_ = 0L;
		int num = 0;
		int num2 = 0;
		int num3 = 0;
		while (true)
		{
			...
			if (characterAccountConfig_0.bool_25 && characterAccountConfig_0.int_20[0] > 0 && characterAccountConfig_0.int_20[1] > 0)
			{
				uint num5 = WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_11.resolvedValue, characterAccountConfig_0.int_137);
				uint num6 = WindowsInteropHelper.ReadProcessUInt32(num5 + GameConfigurationManager.memorySignatureScanConfig_13.resolvedValue, characterAccountConfig_0.int_137);
				uint num7 = WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_14.resolvedValue, characterAccountConfig_0.int_137);
				uint num8 = num7 + num6 * GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue;
				...
				int num10 = (int)WindowsInteropHelper.ReadProcessUInt32(num8 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, characterAccountConfig_0.int_137);
						...
						if (num12 <= 1000000L)
						{
							...
							if (num12 <= 22500L)
							{
								...
								if (num13 > 0)
								{
									...
									WindowsInteropHelper.WriteProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, array, array.Length, ref int_);
									num = 0;
		...
		while (true)
		{
			...
			if (characterAccountConfig_0.bool_25 && characterAccountConfig_0.int_20[0] > 0 && characterAccountConfig_0.int_20[1] > 0)
			{
				...
				if (num11 <= 0)
				{
					...
					uint num15 = characterAccountConfig_0.uint_7 + GameConfigurationManager.memorySignatureScanConfig_9.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_10.resolvedValue + 4;
					WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num15, array5, 4, ref int_);
					int num16 = BitConverter.ToInt32(array5, 0);
					int num17 = (int)WindowsInteropHelper.ReadProcessUInt32(num5 + GameConfigurationManager.memorySignatureScanConfig_13.resolvedValue, characterAccountConfig_0.int_137);
					int num18 = 0;
					for (uint num19 = 1u; num19 < 256; num19++)
					{
						...
						uint num20 = num7 + num19 * GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue;
						WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num20 + GameConfigurationManager.memorySignatureScanConfig_16.resolvedValue, array5, 4, ref int_);
						if (array5[0] == 0)
						{
							continue;
						}
						num18++;
						WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num20 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array5, 4, ref int_);
						if (BitConverter.ToInt32(array5, 0) > 0 && WindowsInteropHelper.ReadProcessUInt32(num20 + GameConfigurationManager.memorySignatureScanConfig_52.resolvedValue, characterAccountConfig_0.int_137) == 3)
						{
	...
	private static int InteractWithTinSuTrinhEntity(CharacterAccountConfig characterAccountConfig_0, ref int int_4, uint[] uint_23 = null, int int_5 = 280, bool bool_1 = false)
	{
		...
		if (int_4 > 0)
		{
			...
			{
				Thread.Sleep(10);
				int num9 = (int)WindowsInteropHelper.ReadProcessUInt32(num4 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, characterAccountConfig_0.int_137);
				if (num9 != 0 && num9 != 10 && num9 != 21)
				{
					if (CommonUtility.GetElapsedMilliseconds(long_) > 300L)
					{
					...
					if (!bool_1)
					{
						WindowsInteropHelper.WriteProcessMemory(characterAccountConfig_0.int_137, num4 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, bytes, bytes.Length, ref int_6);
					}
					empty = NpcDialogHelper.PopupMessageHelper.GetText(characterAccountConfig_0).ToLower();
					long num11 = CurrentCharacterMemoryHelper.GetPrimaryExperienceValue(characterAccountConfig_0);
					long num12 = CurrentCharacterMemoryHelper.GetSecondaryExperienceValue(characterAccountConfig_0);
					if (bool_1)
					{
						num6 = num11 + 1L;
					}
					...
					{
						if (!(empty != string.Empty) && !NpcDialogHelper.PopupMessageHelper.IsActive(characterAccountConfig_0) && GameEntityMemoryHelper.IsEntityPresentByIndex(characterAccountConfig_0, int_4))
						{
							if (num8 > 0L && CommonUtility.GetElapsedMilliseconds(num8) > 1700L)
							{
	...
	private static void DismissTinSuPopupWithKeyboardLoop()
	{
		...
		CharacterAccountConfig gstruct51_ = Form1.characterAccountConfig_1[num];
		while (true)
		{
			for (int i = 0; i < 20; i++)
			{
				if (!NpcDialogHelper.PopupMessageHelper.IsActive(gstruct51_))
				{
					break;
				}
				WindowsInteropHelper.PostKeyPressWithScanCode(gstruct51_.uint_4, 32u);
				Thread.Sleep(500);
			}
			WindowsInteropHelper.PostKeyPressWithScanCode(gstruct51_.uint_4, 32u);
			Thread.Sleep(500);
			if (NpcDialogHelper.PopupMessageHelper.IsActive(gstruct51_))
			{
				WindowsInteropHelper.PostKeyPressWithScanCode(gstruct51_.uint_4, 27u);
				Thread.Sleep(500);
				continue;
			}
			break;
	...
	private static void RunTinSuThienBaoKhoMissionAutomation(int int_4)
	{
		...
		string string_ = "nam";
		uint[] array = new uint[2] { 96638u, 162816u };
		uint[] array2 = new uint[2] { 96559u, 162841u };
		int num2 = 0;
		uint[] uint_ = null;
		string string_2 = "DÞch quan";
		uint num3 = 0u;
		bool flag = false;
		int num4 = 0;
		int num5 = 0;
		int num6 = 0;
		int num7 = 0;
		string text = "B¶o r\u00ad¬ng ";
		string text2 = "B¶o Khè Thñ Hé Gi¶ ";
		int num8 = 0;
		int num9 = 0;
		int num10 = -1;
		int[] array3 = null;
		...
		while (true)
		{
			...
			if (CommonUtility.bool_0 || num22 < 0)
			{
				break;
			}
			characterAccountConfig = Form1.characterAccountConfig_1[num22];
			uint num25;
			int num28;
			string object_2;
			uint[] array11;
			...
			if (!flag4)
			{
				if (!characterAccountConfig.bool_25 || characterAccountConfig.int_20[0] <= 0 || characterAccountConfig.int_20[1] > 0)
				{
					break;
				}
				uint num23 = WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_11.resolvedValue, characterAccountConfig.int_137);
				uint num24 = WindowsInteropHelper.ReadProcessUInt32(num23 + GameConfigurationManager.memorySignatureScanConfig_13.resolvedValue, characterAccountConfig.int_137) * GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue;
				num25 = WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_14.resolvedValue, characterAccountConfig.int_137);
				num3 = num25 + num24;
				int num26 = (int)WindowsInteropHelper.ReadProcessUInt32(num3 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, characterAccountConfig.int_137);
				int num27 = (int)WindowsInteropHelper.ReadProcessUInt32(num3 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, characterAccountConfig.int_137);
				...
				if ((characterAccountConfig.int_136 != ApplicationRuntimeCoordinator.characterAccountConfig_0.int_136 && characterAccountConfig.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId) || (num31 != 1 && num31 != 2))
				{
					...
					if (num30 != 0)
					{
						if (array3 == null)
						{
							...
							if (array12 != null)
							{
								...
								for (int i = 0; i < array12.Length; i++)
								{
									...
									string text3 = array12[i];
									int num33 = text3.IndexOf("thø tù");
									if (num33 <= 0)
									{
										continue;
									}
									num32 = 0;
									for (int j = num33; j < text3.Length; j++)
									{
										if (num32 < array13.Length && '0' < text3[j] && text3[j] <= '9')
										{
											array13[num32] = (byte)text3[j] - 48;
											num32++;
										}
									}
									break;
								}
								if (num32 == array13.Length)
								{
									string text4 = null;
									array3 = new int[array13.Length];
						...
						while (!flag3 && (array3 == null || array3.Length > num9))
						{
							if (0 <= num18)
							{
							...
							{
								array3[l] = CommonUtility.ParseInt32OrZero(array15[l]);
							}
							num9 = 6;
							flag3 = true;
						}
						...
						if (num36 <= 60000L)
						{
							if (num36 <= 22500L)
							{
								...
								if (array10[0] > 0 && array10[1] > 0)
								{
									...
									WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num3 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, bytes, 4, ref int_5);
									Thread.Sleep(600);
								}
								int num38 = 0;
								while (true)
								{
									...
									if (num6 > 200)
									{
										if (num6 == 201)
										{
											string string_4 = "i ra|KÕt thóc";
											NpcDialogHelper.SelectMatchingMenuOptions(characterAccountConfig, string_4);
										}
									}
									else
									{
										string string_5 = "trao th|KÕt thóc";
										int num39 = NpcDialogHelper.SelectMatchingMenuOptions(characterAccountConfig, string_5);
				...
				if (Form1.mouseDragPatchEnabled > 0)
				{
					WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num3 + GameConfigurationManager.memorySignatureScanConfig_251.resolvedValue, GameConfigurationManager.byte_0, GameConfigurationManager.byte_0.Length, ref int_5);
				}
				num15 = 0;
				continue;
			}
			...
			WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, characterAccountConfig.uint_16 + GameProcessInteractionHelper.uint_43 * 4, array16, 4, ref int_6);
			int num45 = BitConverter.ToInt32(array16, 0);
			int num46 = num45;
			if (characterAccountConfig.int_95 > 0 && characterAccountConfig.int_96 > 0)
			{
				num46 = characterAccountConfig.int_96;
			}
			if (num46 <= 0)
			{
				num46 = 400;
			}
			WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, characterAccountConfig.uint_16 + GameProcessInteractionHelper.uint_44 * 4, array16, 1, ref int_6);
			int num47 = array16[0];
			if (num47 > 0 && num46 > num45 && num45 > 0)
			{
				num46 = num45;
			}
				...
				while (true)
				{
					...
					if (GameInterfaceMemoryHelper.ReadEngineStateByte(characterAccountConfig) != 1 && !CharacterStateSyncCoordinator.DetectPrimaryAccountInputActivity(characterAccountConfig, ref num19))
					{
						...
						while (true)
						{
							...
							{
								num48++;
								if (characterAccountConfig.int_3 == null || characterAccountConfig.int_3.GetLength(0) <= num48 || characterAccountConfig.int_4 == null)
								{
									break;
								}
								num49 = characterAccountConfig.int_3[num48, 0];
								if (num49 <= 0)
								{
									continue;
								}
							...
							if (GameEntityMemoryHelper.GetEntityActiveEffectIdForSkill(characterAccountConfig, num8, num49) == 0)
							{
								...
								if (GameProcessInteractionHelper.ReadSharedSlotIntegerValue(characterAccountConfig, GameProcessInteractionHelper.uint_6, 4) <= 0 && array10[0] > 0 && array10[1] > 0)
								{
									...
									WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num3 + GameConfigurationManager.memorySignatureScanConfig_31.resolvedValue, BitConverter.GetBytes(value), 4, ref int_5);
									WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num3 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, BitConverter.GetBytes(num8), 4, ref int_5);
									Thread.Sleep(30);
								}
								num15 = 1;
							}
			...
			if (num7 != 1)
			{
				if (num7 == 2)
				{
					...
					if (num2 > 0)
					{
						...
						if (array10[0] > 0 && array10[1] > 0)
						{
							WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num3 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, BitConverter.GetBytes(num2), 4, ref int_5);
							Thread.Sleep(600);
						}
						int num51 = 0;
						while (!CommonUtility.bool_0)
						...
						if (num53 > 0)
						{
							if (num6 > 200)
							{
								string string_6 = "Thñ Khè|n v× triÒu|giao nhiÖm|phÇn th|KÕt thóc";
								int num54 = NpcDialogHelper.SelectMatchingMenuOptions(characterAccountConfig, string_6);
								if (num54 > 0)
								{
									num6 = 0;
								}
							...
							{
								string string_7 = "Thñ Khè|muèn v× tri|xãa b|hñy nhiÖm|óng vËy|KÕt thóc";
								int num55 = NpcDialogHelper.SelectMatchingMenuOptions(characterAccountConfig, string_7);
								num6 = 182 * Convert.ToByte(num55 > 0);
							}
							else
							{
								NpcDialogHelper.PopupMessageHelper.WriteTextAndResetLength(characterAccountConfig);
								string string_8 = "Thñ Khè|muèn v× triÒu|b»ng lßng|ång ý";
								NpcDialogHelper.SelectMatchingMenuOptions(characterAccountConfig, string_8);
								Thread.Sleep(300);
								...
								bool value2 = text6.IndexOf("TÝn sø".ToLower()) > 0 || text6.IndexOf("n sø ®æc biöt".ToLower()) > 0 || text6.IndexOf("cung tèng".ToLower()) > 0 || text6.IndexOf("cung tiÔn".ToLower()) > 0;
				...
				while (true)
				{
					...
					NpcDialogHelper.SelectMatchingMenuOptions(characterAccountConfig, "TÝn Sø|Mu");
					Thread.Sleep(1000);
					break;
				}
				continue;
			...
			if (num57 > 0)
			{
				for (int m = 0; m < 2; m++)
				{
					...
					WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num3 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, bytes2, 4, ref int_5);
					Thread.Sleep(800);
					...
					string value3 = ("sè " + array3[num9] + " thµnh c«ng").ToUpper();
					int num58 = 0;
					while (num58 < array17.Length)
					{
						if (array17[num58].ToUpper().IndexOf(value3) <= 0)
						{
							num58++;
							continue;
						}
			...
			if (num13 > 0L && CommonUtility.GetElapsedMilliseconds(num13) > 20000L)
			{
				num21 = 0;
				num14 = 0L;
				Class64.TryRecoverStuckMovement(characterAccountConfig);
			...
			if (GameProcessInteractionHelper.ReadSharedSlotIntegerValue(characterAccountConfig, GameProcessInteractionHelper.uint_6, 4) <= 0 && array10[0] > 0 && array10[1] > 0)
			{
				...
				WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num3 + GameConfigurationManager.memorySignatureScanConfig_31.resolvedValue, BitConverter.GetBytes(num46), 4, ref int_5);
				WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num3 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, BitConverter.GetBytes(num8), 4, ref int_5);
			}
			num15 = 1;
			continue;
			...
			{
				long num62 = CommonUtility.GetElapsedMilliseconds(long_3);
				if (num62 < 300L)
				{
					continue;
				}
						...
						if (gstruct61_.memberCount > 1)
						{
							...
							else
							{
								...
								if (Form1.characterAccountConfig_1 != null && gstruct61_.gstruct60_0 != null)
								{
									...
									{
										if (string_10 == Form1.characterAccountConfig_1[n].string_22)
										{
											flag6 = Form1.characterAccountConfig_1[n].bool_25 && Form1.characterAccountConfig_1[n].int_20[0] > 0 && Form1.characterAccountConfig_1[n].int_20[1] == 0;
											break;
										}
									}
								}
			...
			if (num2 > 0)
			{
				...
				while (true)
				{
					if (!CommonUtility.bool_0)
					{
						...
						if (!NpcDialogHelper.PopupMessageHelper.IsActive(characterAccountConfig) && (empty == null || !(empty != string.Empty)))
						{
			...
			if (array18 != null)
			{
				...
				if (num5 != 111 && MapNavigationHelper.NavigateToDestination(characterAccountConfig, object_, string_))
				{
					...
					{
						if (num28 != (int)WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, characterAccountConfig.int_137))
						{
							break;
						}
						Thread.Sleep(800);
			...
			if (Class64.GetSquaredCoordinateDistance(array11, array7) <= 60000L)
			{
				...
				if (array19 != null)
				{
					...
					int num76 = 0;
					while (num76 < array19.Length)
					{
						if (array19[num76].ToUpper().IndexOf(value5) <= 0)
						{
							num76++;
							continue;
						}
					...
					string value6 = "cã thÓ më B¶o R\u00ad¬ng".ToUpper();
					string value7 = (array3[num9] + " sè").ToUpper();
					num76 = 0;
					while (num76 < array19.Length)
					{
						string text9 = array19[num76].ToUpper();
						if (text9.IndexOf(value6) <= 0 || text9.IndexOf(value7) <= 0)
						{
							num76++;
							continue;
						}
	...
	private static int AreAllPartyMembersNearby(CharacterAccountConfig characterAccountConfig_0, PartySnapshot gstruct61_0)
	{
		if (gstruct61_0.memberCount > 1 && gstruct61_0.gstruct60_0 != null && gstruct61_0.gstruct60_0.Length > 1)
		{
			...
			uint num5 = characterAccountConfig_0.uint_7 + GameConfigurationManager.memorySignatureScanConfig_9.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_10.resolvedValue + 4;
	...
	private static int CountConfiguredMissionMembersVisible(CharacterAccountConfig characterAccountConfig_0)
	{
		if (characterAccountConfig_0.string_19 != null && characterAccountConfig_0.string_19.Length != 0)
		{
			...
			byte[] array = new byte[4];
			byte[] array2 = new byte[32];
			uint num3 = characterAccountConfig_0.uint_7 + GameConfigurationManager.memorySignatureScanConfig_9.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_10.resolvedValue + 4;
			WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num3, array, 4, ref int_);
			...
			for (uint num7 = 1u; num7 < 256; num7++)
			{
				...
				uint num8 = num2 + num7 * GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue;
				...
				int num9 = (int)WindowsInteropHelper.ReadProcessUInt32(num8 + GameConfigurationManager.memorySignatureScanConfig_52.resolvedValue, characterAccountConfig_0.int_137);
				if (num9 != 1)
				{
					continue;
				}
				...
				if (characterAccountConfig_0.string_19.Length <= num6)
				{
					num6 = 100;
					break;
				}
	...
	private static int CountConfiguredPartyMembersPresent(CharacterAccountConfig characterAccountConfig_0)
	{
		if (characterAccountConfig_0.string_19 != null && characterAccountConfig_0.string_19.Length != 0)
		{
			...
			if (gStruct.memberCount > 0 && gStruct.gstruct60_0 != null && gStruct.gstruct60_0.Length >= characterAccountConfig_0.string_19.Length)
			{
				...
				if (num >= characterAccountConfig_0.string_19.Length)
				{
					num = 100;
				}
				return num;
