...
internal class TinSuMissionAutomation
{
	...
	public static void smethod_0(int int_4)
	{
		...
		while (true)
		{
			...
			uint num14 = WindowsInteropHelper.smethod_30(GameConfigurationManager.memorySignatureScanConfig_11.uint_0, characterAccountConfig_.int_137);
			uint num15 = WindowsInteropHelper.smethod_30(num14 + GameConfigurationManager.memorySignatureScanConfig_13.uint_0, characterAccountConfig_.int_137);
			uint num16 = WindowsInteropHelper.smethod_30(GameConfigurationManager.memorySignatureScanConfig_14.uint_0, characterAccountConfig_.int_137);
			...
			if (num19 != 0 && num18 != 0 && num20 != 0 && num21 > 1)
			{
				...
				else if (num18 != 10 && num18 != 21)
				{
					...
					array5 = new uint[2]
					{
						WindowsInteropHelper.smethod_30(num17 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_58.uint_0, characterAccountConfig_.int_137),
						WindowsInteropHelper.smethod_30(num17 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_59.uint_0, characterAccountConfig_.int_137)
					};
			...
			Class75.smethod_61(characterAccountConfig_, array3);
			Thread.Sleep(100);
			continue;
			IL_0817:
			...
			if (num31 <= 1000000L)
			{
				...
				if (num31 <= 22500L)
				{
					...
					else
					{
						...
						Class11.smethod_38(ref array2, num33);
						flag3 = true;
						num4 = Class64.smethod_20(array4, array5);
						num6 = 1;
					}
		...
		while (true)
		{
			...
			if (characterAccountConfig_0.bool_25 && characterAccountConfig_0.int_20[0] > 0 && characterAccountConfig_0.int_20[1] > 0)
			{
				...
				while (uint_23 != null && num8 < 10)
				{
					...
					Class75.smethod_61(characterAccountConfig_0, uint_23);
					Thread.Sleep(300);
					num8++;
				}
				...
				while (true)
				{
					...
					for (int i = 0; i < num8; i++)
					{
						...
						{
							if (Class11.smethod_2(string_, array4[j]))
							{
								num6++;
								num10 = i;
								break;
	...
	private static int smethod_2(CharacterAccountConfig characterAccountConfig_0)
	{
		...
		while (true)
		{
			...
			if (characterAccountConfig_0.bool_25 && characterAccountConfig_0.int_20[0] > 0 && characterAccountConfig_0.int_20[1] > 0)
			{
				uint num5 = WindowsInteropHelper.smethod_30(GameConfigurationManager.memorySignatureScanConfig_11.uint_0, characterAccountConfig_0.int_137);
				uint num6 = WindowsInteropHelper.smethod_30(num5 + GameConfigurationManager.memorySignatureScanConfig_13.uint_0, characterAccountConfig_0.int_137);
				...
				int num9 = (int)WindowsInteropHelper.smethod_30(GameConfigurationManager.memorySignatureScanConfig_27.uint_0, characterAccountConfig_0.int_137);
				int num10 = (int)WindowsInteropHelper.smethod_30(num8 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, characterAccountConfig_0.int_137);
							...
							if (num12 <= 22500L)
							{
								...
								if (num13 > 0)
								{
									...
									for (int i = 0; i < num; i++)
									{
										...
										if (Class11.smethod_2(string_2, string_))
										{
		...
		while (true)
		{
			...
			if (characterAccountConfig_0.bool_25 && characterAccountConfig_0.int_20[0] > 0 && characterAccountConfig_0.int_20[1] > 0)
			{
				...
				if (array2 != null)
				{
					...
					{
						if (array2[i] != null && 0 <= Class11.smethod_1(array2[i], "hÕt thêi gian"))
						{
							for (int j = 0; j < 6; j++)
							{
				...
				if (num11 <= 0)
				{
					...
					int num17 = (int)WindowsInteropHelper.smethod_30(num5 + GameConfigurationManager.memorySignatureScanConfig_13.uint_0, characterAccountConfig_0.int_137);
					int num18 = 0;
					for (uint num19 = 1u; num19 < 256; num19++)
					{
						...
						if (BitConverter.ToInt32(array5, 0) > 0 && WindowsInteropHelper.smethod_30(num20 + GameConfigurationManager.memorySignatureScanConfig_52.uint_0, characterAccountConfig_0.int_137) == 3)
						{
	...
	private static int smethod_4(CharacterAccountConfig characterAccountConfig_0, ref int int_4, uint[] uint_23 = null, int int_5 = 280, bool bool_1 = false)
	{
		...
		if (int_4 > 0)
		{
			...
			{
				Thread.Sleep(10);
				int num9 = (int)WindowsInteropHelper.smethod_30(num4 + GameConfigurationManager.memorySignatureScanConfig_55.uint_0, characterAccountConfig_0.int_137);
				if (num9 != 0 && num9 != 10 && num9 != 21)
				{
					if (Class11.smethod_28(long_) > 300L)
					{
						...
						if (num10 > 11500L)
						{
							Class75.smethod_61(characterAccountConfig_0, uint_24);
						}
						else
						{
							Class75.smethod_61(characterAccountConfig_0, array4);
							num8 = Class11.smethod_27();
						}
						long_ = Class11.smethod_27();
						Thread.Sleep(100);
					}
					...
					if (num6 == num11 && num7 == num12)
					{
						...
						num5 = Convert.ToByte(0 <= Class11.smethod_1(empty, "®· ®".ToLower()));
						break;
					}
					num5 = 1;
					break;
			...
			if (num5 <= 0)
			{
				...
				if (text != null && 0 <= Class11.smethod_1(text, "hÕt thêi"))
				{
	...
	private static void smethod_5()
	{
		...
		while (true)
		{
			for (int i = 0; i < 20; i++)
			{
				...
				WindowsInteropHelper.smethod_4(gstruct51_.uint_4, 32u);
				Thread.Sleep(500);
			}
			WindowsInteropHelper.smethod_4(gstruct51_.uint_4, 32u);
			Thread.Sleep(500);
			if (NpcDialogHelper.PopupMessageHelper.smethod_4(gstruct51_))
			{
				WindowsInteropHelper.smethod_4(gstruct51_.uint_4, 27u);
				Thread.Sleep(500);
				continue;
			}
			break;
	...
	private static void smethod_9(int int_4)
	{
		...
		while (true)
		{
			...
			if (!flag4)
			{
				...
				uint num23 = WindowsInteropHelper.smethod_30(GameConfigurationManager.memorySignatureScanConfig_11.uint_0, characterAccountConfig.int_137);
				uint num24 = WindowsInteropHelper.smethod_30(num23 + GameConfigurationManager.memorySignatureScanConfig_13.uint_0, characterAccountConfig.int_137) * GameConfigurationManager.memorySignatureScanConfig_15.uint_0;
				num25 = WindowsInteropHelper.smethod_30(GameConfigurationManager.memorySignatureScanConfig_14.uint_0, characterAccountConfig.int_137);
				num3 = num25 + num24;
				...
				num30 = (int)WindowsInteropHelper.smethod_30(num3 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, characterAccountConfig.int_137);
				...
				{
					object_2 = WindowsInteropHelper.smethod_28(characterAccountConfig.uint_7 + GameConfigurationManager.memorySignatureScanConfig_28.uint_0 + GameConfigurationManager.memorySignatureScanConfig_29.uint_0, characterAccountConfig.int_137, 60);
					array11 = new uint[2]
					{
					...
					WindowsInteropHelper.ReadProcessMemory(Class11.int_1, Class11.uint_1 + GameConfigurationManager.uint_1 * 4, array10, 2, ref int_5);
					num15 = 0;
					...
					if (num30 != 0)
					{
						...
						while (!flag3 && (array3 == null || array3.Length > num9))
						{
								...
								if (text5 != string.Empty)
								{
									...
									if (array14.Length > 4)
									{
										...
										if (array15 != null)
										{
											...
											{
												if (Class11.smethod_1(array15[num35], object_3) <= 0)
												{
													num35++;
													continue;
												}
							...
							{
								array3[l] = Class11.smethod_11(array15[l]);
							}
							num9 = 6;
							flag3 = true;
						}
						...
						{
							Class75.smethod_52(characterAccountConfig, "<color=yellow>§èi thäai Tiªu trÊn tr¶ nhiÖm vô !");
								...
								while (true)
								{
									...
									if (num6 > 200)
									{
										if (num6 == 201)
										{
											...
											NpcDialogHelper.smethod_6(characterAccountConfig, string_4);
										}
									}
									else
									{
										string string_5 = "trao th|KÕt thóc";
										int num39 = NpcDialogHelper.smethod_6(characterAccountConfig, string_5);
					...
					if (!flag2 && characterAccountConfig.int_65 > 0)
					{
						...
						if (characterAccountConfig.int_66 <= num40)
						{
							...
							{
								Class75.smethod_38(characterAccountConfig, (uint)(num40 - characterAccountConfig.int_66));
							}
						}
						else
						{
							Class75.smethod_37(characterAccountConfig, (uint)(characterAccountConfig.int_66 - num40));
						}
						flag2 = true;
					}
					if (num6 < 201)
					{
						...
						if (int_2[0] > 0 && characterAccountConfig.int_121[0] > 0 && characterAccountConfig.int_121[2] > 0 && characterAccountConfig.string_19 != null && characterAccountConfig.string_19.Length != 0)
						{
							if (characterAccountConfig.int_121[1] > 0)
							{
								...
								if (Class11.smethod_28(long_4) > 1000L)
								{
									...
									Class75.smethod_52(characterAccountConfig, ">Cßn " + num43 + " gi©y chê PT ®Çy ®ñ c\u00b8c thµnh viªn.");
								}
								if (num43 > 0)
								{
									Thread.Sleep(300);
							...
							else
							{
								...
								if (gStruct.int_0 > 1)
								{
									if (Class11.smethod_28(long_4) > 6000L)
									{
										num11++;
										long_4 = Class11.smethod_27();
										Class75.smethod_52(characterAccountConfig, ">§ang chê ®éi tr\u00adëng b\u00b8o danh.");
									}
									Thread.Sleep(300);
									continue;
								}
								...
								if (Class11.smethod_28(long_4) > 1000L)
								{
									num11++;
									long_4 = Class11.smethod_27();
									Class75.smethod_52(characterAccountConfig, ">Cßn " + num44 + " chê ®éi tr\u00adëng b\u00b8o danh.");
								}
								if (num44 > 0)
								{
									Thread.Sleep(300);
						...
						else if (gStruct.int_0 != 1)
						{
							if (gStruct.int_0 > 1)
							{
								if (gStruct.string_0 != characterAccountConfig.string_22)
								{
									if (Class11.smethod_28(long_2) > 8000L)
									{
										Class75.smethod_52(characterAccountConfig, "§ang ®îi ®éi tr\u00adëng b\u00b8o danh...");
										long_2 = Class11.smethod_27();
									}
									Thread.Sleep(300);
									continue;
								...
								bool_0 = false;
								bool flag5 = false;
								if (Class11.smethod_28(long_2) > 6000L && !(flag5 = smethod_13(characterAccountConfig)))
								{
									Class75.smethod_52(characterAccountConfig, "§ang ®îi ®Çy ®ñ c\u00b8c thµnh viªn trong tæ ®éi.");
									long_2 = Class11.smethod_27();
								}
								if (!flag5)
								{
			...
			Class75.smethod_52(characterAccountConfig, "<bclr=blue><color=green>KET THUC NHIEM VU THIEN BAO KHO.");
			break;
			IL_152f:
			int int_6 = 0;
			byte[] array16 = new byte[4];
			WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, characterAccountConfig.uint_16 + Class75.uint_43 * 4, array16, 4, ref int_6);
			...
			WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, characterAccountConfig.uint_16 + Class75.uint_44 * 4, array16, 1, ref int_6);
			int num47 = array16[0];
					...
					if (num2 > 0)
					{
						...
						if (num53 > 0)
						{
							if (num6 > 200)
							{
								...
								int num54 = NpcDialogHelper.smethod_6(characterAccountConfig, string_6);
								if (num54 > 0)
								{
									num6 = 0;
								}
							...
							else if (num6 <= 181)
							{
								...
								int num55 = NpcDialogHelper.smethod_6(characterAccountConfig, string_7);
			...
			if (num13 > 0L && Class11.smethod_28(num13) > 20000L)
			{
				num21 = 0;
				num14 = 0L;
				Class64.smethod_12(characterAccountConfig);
			...
			{
				long num62 = Class11.smethod_28(long_3);
				if (num62 < 300L)
				{
					continue;
				}
					...
					if (!bool_0 && (num12 <= 0L || num59 <= int_2[1] * 1000))
					{
						...
						if (gstruct61_.int_0 > 1)
						{
							...
							if (Class11.smethod_28(long_2) > 3000L)
							{
								if (num12 > 0L)
								{
									Class75.smethod_52(characterAccountConfig, "§ang chê ®ång ®éi: " + (int_2[1] - (int)(num59 / 1000L)));
								}
								else
								{
									Class75.smethod_52(characterAccountConfig, "§ang chê ®ång ®éi...");
								}
								long_2 = Class11.smethod_27();
							}
							continue;
			...
			if (array18 != null)
			{
				...
				if (num5 != 111 && MapNavigationHelper.smethod_7(characterAccountConfig, object_, string_))
				{
					...
					{
						if (num28 != (int)WindowsInteropHelper.smethod_30(GameConfigurationManager.memorySignatureScanConfig_27.uint_0, characterAccountConfig.int_137))
						{
							break;
						}
						Thread.Sleep(800);
			...
			Class75.smethod_52(characterAccountConfig, "<color=yellow>Ch¹y tÝn sø: h·y vÒ thµnh thÞ råi míi b¾t ®Çu.");
			...
			if (num10 != num9)
			{
				Class75.smethod_52(characterAccountConfig, "<bclr=blue><color=green>Më r\u00ad¬ng: " + array3[num9]);
				num10 = num9;
				num12 = 0L;
				bool_0 = false;
				array8 = null;
			...
			if (Class64.smethod_18(array11, array7) <= 60000L)
			{
				...
				if (num8 > 0 && GameEntityMemoryHelper.smethod_11(characterAccountConfig, num8) > 0)
				{
					...
					if (Class11.smethod_1(string_11, object_4) == 0)
					{
						goto IL_1199;
					}
				}
	...
	private static int smethod_11(CharacterAccountConfig characterAccountConfig_0)
	{
		if (characterAccountConfig_0.string_19 != null && characterAccountConfig_0.string_19.Length != 0)
		{
			...
			for (uint num7 = 1u; num7 < 256; num7++)
			{
				...
				int num9 = (int)WindowsInteropHelper.smethod_30(num8 + GameConfigurationManager.memorySignatureScanConfig_52.uint_0, characterAccountConfig_0.int_137);
				if (num9 != 1)
				{
					continue;
				}
