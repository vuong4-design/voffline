...
internal class TinSuMissionAutomation
{
	...
	public static void smethod_0(int int_4)
	{
		...
		while (true)
		{
			...
			continue;
			IL_0ab6:
			if (!CharacterMovementHelper.IsMovementActive(characterAccountConfig_) || CommonUtility.smethod_28(long_) > 6000L)
			{
	...
	private static int smethod_4(CharacterAccountConfig characterAccountConfig_0, ref int int_4, uint[] uint_23 = null, int int_5 = 280, bool bool_1 = false)
	{
		...
		if (int_4 > 0)
		{
			...
			while (!CommonUtility.bool_0)
			{
				...
				{
					if (CommonUtility.smethod_28(long_) > 300L)
					{
	...
	private static void smethod_9(int int_4)
	{
		...
		while (true)
		{
				...
				if ((characterAccountConfig.int_136 != ApplicationRuntimeCoordinator.characterAccountConfig_0.int_136 && characterAccountConfig.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.int_0) || (num31 != 1 && num31 != 2))
				{
					...
					if (num30 != 0)
					{
						...
						while (!flag3 && (array3 == null || array3.Length > num9))
						{
							...
							{
								array3[l] = CommonUtility.smethod_11(array15[l]);
							}
							num9 = 6;
							flag3 = true;
						}
					...
					if (num6 < 201)
					{
						...
						if (int_2[0] > 0 && characterAccountConfig.int_121[0] > 0 && characterAccountConfig.int_121[2] > 0 && characterAccountConfig.string_19 != null && characterAccountConfig.string_19.Length != 0)
						{
							...
							else
							{
								...
								if (gStruct.int_0 > 1)
								{
									if (CommonUtility.smethod_28(long_4) > 6000L)
									{
										num11++;
										long_4 = CommonUtility.smethod_27();
						...
						else if (gStruct.int_0 != 1)
						{
							if (gStruct.int_0 > 1)
							{
								if (gStruct.string_0 != characterAccountConfig.string_22)
								{
									if (CommonUtility.smethod_28(long_2) > 8000L)
									{
								...
								bool_0 = false;
								bool flag5 = false;
								if (CommonUtility.smethod_28(long_2) > 6000L && !(flag5 = smethod_13(characterAccountConfig)))
								{
			...
			if (num13 > 0L && CommonUtility.smethod_28(num13) > 20000L)
			{
				num21 = 0;
				num14 = 0L;
				Class64.smethod_12(characterAccountConfig);
			...
			{
				long num62 = CommonUtility.smethod_28(long_3);
				if (num62 < 300L)
				{
					continue;
				}
			...
			if (GameInterfaceMemoryHelper.smethod_12(characterAccountConfig) != 1 && !CharacterStateSyncCoordinator.smethod_7(characterAccountConfig, ref num19))
			{
				if (int_2[0] > 0)
				{
					num59 = CommonUtility.smethod_28(num12);
