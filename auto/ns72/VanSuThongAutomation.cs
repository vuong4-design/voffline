...
internal class VanSuThongAutomation
{
	...
	public static void Run(int characterId)
	{
		...
		while (true)
		{
			...
			if (Form1.string_11 != null && !(Form1.string_11 == string.Empty))
			{
				...
				int num11 = (int)Class24.smethod_30(num9 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, characterAccountConfig.int_137);
				int num12 = (int)Class24.smethod_30(num9 + GameConfigurationManager.memorySignatureScanConfig_55.uint_0, characterAccountConfig.int_137);
				int num13 = (int)Class24.smethod_30(num9 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, characterAccountConfig.int_137);
					...
					do
					{
						...
						if (num2 > 0)
						{
							...
							if (text2 == null || !Class11.smethod_2(text2, text))
							{
								num2 = 0;
								uint_ = null;
								Class24.WriteProcessMemory(characterAccountConfig.int_137, num9 + GameConfigurationManager.memorySignatureScanConfig_72.uint_0, byte_, 4, ref int_1);
							}
						}
						if (num2 <= 0)
						{
						...
						Class24.WriteProcessMemory(characterAccountConfig.int_137, num9 + GameConfigurationManager.memorySignatureScanConfig_72.uint_0, bytes, 4, ref int_1);
						Thread.Sleep(300);
						int num17 = 0;
						...
						while (true)
						{
							...
							{
								Class24.ReadProcessMemory(characterAccountConfig.int_137, characterAccountConfig.uint_7 + GameConfigurationManager.memorySignatureScanConfig_172.uint_0, array2, 4, ref int_1);
	...
	private static string FindVanSuThongNpcName(CharacterAccountConfig characterAccountConfig_0)
	{
		...
		for (uint num9 = 1u; num9 < 256; num9++)
		{
			...
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num10 + GameConfigurationManager.memorySignatureScanConfig_16.uint_0, array, 4, ref int_);
			if (array[0] == 0)
			{
				continue;
			}
			num7++;
			Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num10 + GameConfigurationManager.memorySignatureScanConfig_52.uint_0, array, 4, ref int_);
			uint num11 = BitConverter.ToUInt32(array, 0);
			if (num11 == 3)
			{
				uint[] array4 = new uint[2];
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num10 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_58.uint_0, array, 4, ref int_);
				array4[0] = BitConverter.ToUInt32(array, 0);
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num10 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_59.uint_0, array, 4, ref int_);
				array4[1] = BitConverter.ToUInt32(array, 0);
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num10 + GameConfigurationManager.memorySignatureScanConfig_16.uint_0, array2, array2.Length, ref int_);
