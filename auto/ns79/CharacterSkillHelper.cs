...
internal class CharacterSkillHelper
{
	...
	public static FactionSkillCatalogEntry[] gstruct57_0;

	public static SkillMetadata[] gstruct58_0;
	...
	static CharacterSkillHelper()
	{
		...
		uint_1 = 72u;
		uint_2 = 172u;
		gstruct57_0 = new FactionSkillCatalogEntry[11]
		{
			new FactionSkillCatalogEntry
			{
				factionId = 1,
		...
		gstruct58_0 = new SkillMetadata[11]
		{
			new SkillMetadata
			{
				skillId = 10,
	...
	{
		int num = GameProcessInteractionHelper.ReadSharedSlotIntegerValue(characterAccountConfig_0, GameProcessInteractionHelper.directShortcutSkillReferenceSlot, 4);
		...
		GameProcessInteractionHelper.WriteSharedSlotInt32(characterAccountConfig_0, GameProcessInteractionHelper.directShortcutSkillReferenceSlot, 0, 4);
		GameProcessInteractionHelper.WriteSharedSlotInt32(characterAccountConfig_0, GameProcessInteractionHelper.directShortcutSkillReferenceSlot + 4, 0, 4);
		if (string_0 == null)
		{
		...
		if (array == null)
		{
			int num2 = GameProcessInteractionHelper.ReadSharedSlotIntegerValue(characterAccountConfig_0, GameProcessInteractionHelper.directShortcutSkillReferenceSlot + 8, 4);
			...
			if (Math.Abs(second - num2) > 15)
			{
				...
				GameProcessInteractionHelper.WriteSharedSlotInt32(characterAccountConfig_0, GameProcessInteractionHelper.directShortcutSkillReferenceSlot + 8, second, 4);
			}
		}
		else
		{
			GameProcessInteractionHelper.WriteSharedSlotInt32(characterAccountConfig_0, GameProcessInteractionHelper.directShortcutSkillReferenceSlot, (int)array[0], 4);
			GameProcessInteractionHelper.WriteSharedSlotInt32(characterAccountConfig_0, GameProcessInteractionHelper.directShortcutSkillReferenceSlot + 4, (int)array[1], 4);
		}
	}
	...
	public static bool ContainsSkillId(SkillMetadata[] gstruct58_1, int int_3)
	{
		if (gstruct58_1 != null)
		{
	...
	public static int FindSkillIdByName(SkillMetadata[] gstruct58_1, string string_0)
	{
		if (gstruct58_1 != null)
		{
			for (int i = 0; i < gstruct58_1.Length; i++)
	...
	public static SkillMetadata[] ReadLearnedSkills(CharacterAccountConfig characterAccountConfig_0, int int_3 = -1)
	{
		int int_4 = 0;
		byte[] array = new byte[4];
	...
	public static SkillMetadata[] CreateBuiltInSkillCatalog()
	{
		return new SkillMetadata[955]
		{
			new SkillMetadata
			{
				skillId = 1,
