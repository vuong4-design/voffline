								...
								if (num == num28 && (num2 == CharacterStateSyncCoordinator.characterSyncSnapshot_0.int_4 || Form1.int_25 <= 0))
								{
									...
									if (!CongThanhQuanTransportCatalog.IsTransportMap(num28))
									{
										if (num29 > 0)
										{
											...
											if (GameProcessInteractionHelper.smethod_3(characterAccountConfig, GameProcessInteractionHelper.uint_19, 4) > 0 && MapNavigationHelper.smethod_7(characterAccountConfig, int_7))
											{
												Thread.Sleep(300);
