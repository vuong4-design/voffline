...
internal class CongThanhChienAutomation
{
	public static void Run(int int_0)
	{
		...
		while (true)
		{
			...
			if (CommonUtility.bool_0 || num15 < 0 || Form1.pkModeIndex != 2)
			{
				break;
			}
			...
			if (!characterAccountConfig.bool_15 && GameProcessInteractionHelper.ReadSharedSlotIntegerValue(characterAccountConfig, GameProcessInteractionHelper.clickNpcAutomationActiveSlot, 4) <= 0)
			{
				...
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, GameConfigurationManager.memorySignatureScanConfig_11.resolvedValue, array3, 4, ref array6[0]);
				uint num21 = BitConverter.ToUInt32(array3, 0);
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num21 + GameConfigurationManager.memorySignatureScanConfig_13.resolvedValue, array3, 4, ref array6[1]);
				...
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, GameConfigurationManager.memorySignatureScanConfig_14.resolvedValue, array3, 4, ref array6[2]);
				...
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, array3, 4, ref array6[4]);
				int num26 = BitConverter.ToInt32(array3, 0);
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array3, 4, ref array6[5]);
				int num27 = BitConverter.ToInt32(array3, 0);
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, array3, 4, ref array6[6]);
				int num28 = BitConverter.ToInt32(array3, 0);
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, array3, 4, ref array6[7]);
					...
					if (num27 != 0 && num26 != 0 && num28 != 0 && num31 > 1 && num26 != 10 && num26 != 21)
					{
						...
						while (true)
						{
							...
							if (num33 <= 0 && !flag9)
							{
								...
								if (num == num28 && (num2 == CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId || Form1.findMainAccountEnabled <= 0))
								{
									if (num4 != Form1.primaryBattlefieldIndex)
									{
										flag4 = false;
										num7 = 0;
										num4 = Form1.primaryBattlefieldIndex;
									}
									num34 = 600;
									...
									num16 = Form1.mainAccountSearchDistance;
									if (characterAccountConfig.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId)
									{
										if (num36 <= 180 && num16 < Form1.combatApproachDistance)
										{
											num16 = Form1.combatApproachDistance;
										}
										if (characterAccountConfig.int_131[0] > 0 && Form1.continueMedicineThrowingEnabled > 0 && num16 > 180)
										{
											num16 = 180;
										}
										if (flag11)
										{
											if (num29 > 0)
											{
												num16 = characterAccountConfig.gstruct50_0.postCastSearchDistance;
											}
											flag11 = false;
										}
									}
									...
									flag12 = false;
									flag13 = false;
									if ((Form1.enterCongThanhChienMapWithMainAccountEnabled > 0 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId != characterAccountConfig.int_136 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId > 0 && 926 <= CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId && CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId <= 932 && num19 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId) || num4 != Form1.primaryBattlefieldIndex)
									{
										flag4 = false;
										num7 = 0;
										num4 = Form1.primaryBattlefieldIndex;
										num14 = 0;
										num19 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId;
									}
									if (num3 != num29)
									{
										Thread.Sleep(100);
										...
										while (num29 == 0 && num39 < 30 && num29 != num3)
										{
											...
											WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num21 + GameConfigurationManager.memorySignatureScanConfig_13.resolvedValue, array3, 4, ref int_6);
											...
											num25 = num24 + num23;
											WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, array3, 4, ref int_6);
									...
									if (!CongThanhQuanTransportCatalog.IsTransportMap(num28))
									{
										if (num29 > 0)
										{
											...
											{
												WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, byte_, 4, ref int_6);
												if (InterMapTravelHelper.UseCurrentMapTransportNpc(characterAccountConfig) > 0)
												{
													break;
												}
											}
											int int_7 = CongThanhQuanTransportCatalog.CityEntries[Form1.primaryBattlefieldIndex].int_0;
											if (GameProcessInteractionHelper.ReadSharedSlotIntegerValue(characterAccountConfig, GameProcessInteractionHelper.uint_19, 4) > 0 && MapNavigationHelper.NavigateToDestination(characterAccountConfig, int_7))
											{
												...
												if (WindowsInteropHelper.ReadProcessUInt32(num25 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, characterAccountConfig.int_137) == 0)
												{
													break;
												}
											}
										...
										if (Form1.mainAccountSelfControlsCongThanhChienEnabled > 0 && characterAccountConfig.int_136 == CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId && ((Form1.remoteAuxiliarySyncModeEnabled <= 0 && Form1.manualAuxiliaryMachineModeEnabled <= 0) || CharacterStateSyncCoordinator.characterSyncSnapshot_1.mapId <= 0))
										{
											GameAutomationUtility.TryShowStatusMessageIfDue(characterAccountConfig, "CTC Ac chÝnh ng\u00adêi dïng tù ®iÒu khiÓn..");
											Thread.Sleep(300);
											break;
										}
										...
										if (!flag5)
										{
											int num40 = InventoryItemMemoryHelper.GetInventoryEntryCount(characterAccountConfig);
											if (flag && num5 >= 0 && num5 == num40)
											{
												if (flag7)
												{
													...
													if (((num42 > 100L && characterAccountConfig.int_106[0] > 0 && characterAccountConfig.int_106[1] > 0 && num41 <= characterAccountConfig.int_106[1]) || (characterAccountConfig.int_109[0] > 0 && characterAccountConfig.int_109[1] > 0 && num47 <= (double)characterAccountConfig.int_109[1])) && ConsumableAutomationHelper.UseInventoryItemsByGenre(characterAccountConfig, 0) > 0)
													{
														Thread.Sleep(600);
													}
													if (((num45 > 50L && characterAccountConfig.int_107[0] > 0 && characterAccountConfig.int_107[1] > 0 && num44 <= characterAccountConfig.int_107[1]) || (characterAccountConfig.int_111[0] > 0 && characterAccountConfig.int_111[1] > 0 && num48 <= (double)characterAccountConfig.int_111[1])) && ConsumableAutomationHelper.UseInventoryItemsByGenre(characterAccountConfig, 1) > 0)
													{
														Thread.Sleep(300);
													}
													Thread.Sleep(150);
													num5 = InventoryItemMemoryHelper.GetInventoryEntryCount(characterAccountConfig);
													flag7 = false;
												}
												int_8 = CongThanhQuanTransportCatalog.CityEntries[Form1.primaryBattlefieldIndex].int_0;
												array8 = CongThanhQuanTransportCatalog.CityEntries[Form1.primaryBattlefieldIndex].uint_0;
												text2 = CongThanhQuanTransportCatalog.CityEntries[Form1.primaryBattlefieldIndex].string_0;
												string_ = CongThanhQuanTransportCatalog.CityEntries[Form1.primaryBattlefieldIndex].string_1;
												string_2 = CongThanhQuanTransportCatalog.CityEntries[Form1.secondaryBattlefieldIndex].string_1;
												if (Form1.enterCongThanhChienMapWithMainAccountEnabled > 0 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId != characterAccountConfig.int_136 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId > 0 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.entityExistsFlag > 0 && 926 <= CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId && CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId <= 932)
												{
													for (num32 = 0; num32 < CongThanhQuanTransportCatalog.CityEntries.Length; num32++)
													{
														if (CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId == CongThanhQuanTransportCatalog.CityEntries[num32].int_1)
														{
												...
												if (Form1.congThanhChienTownPortalEnabled > 0 && GameProcessInteractionHelper.ReadSharedSlotIntegerValue(characterAccountConfig, GameProcessInteractionHelper.uint_19, 4) > 0)
												{
													NpcDialogHelper.DismissActiveDialogsAndMenus(characterAccountConfig);
													Thread.Sleep(100);
													if (GameAutomationUtility.TryUseMatchingInventoryItem(characterAccountConfig, "ThÇn Hµnh", bool_0: false))
													{
														Thread.Sleep(300);
														...
														num49 = 0;
														if (Form1.congThanhChienTownPortalMenuIndices != null && Form1.congThanhChienTownPortalMenuIndices != string.Empty)
														{
															string[] array10 = Form1.congThanhChienTownPortalMenuIndices.Split(',', ';', '.', '-', '/');
									...
									if (!(flag15 = Form1.findMainAccountEnabled > 0 && (Form1.findMainAccountInCityEnabled > 0 || CharacterStateSyncCoordinator.characterSyncSnapshot_0.fightState > 0) && CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId != characterAccountConfig.int_136 && CommonUtility.IsNonZeroCoordinatePair(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates) && CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId > 0 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.entityExistsFlag > 0))
									{
										if (characterAccountConfig.int_68 != null && characterAccountConfig.int_68[0] > 0 && !AuxiliaryMachineManager.bool_3)
										{
											...
											{
												array12 = GameAutomationUtility.FindConfiguredTargetCharacterCoordinates(characterAccountConfig, ref int_2);
												if (array12 != null)
												{
													num12 = 0L;
													long num55 = GameAutomationUtility.GetSquaredCoordinateDistance(uint_3, array12);
													if (num55 < 8000L)
													{
														goto IL_2724;
													}
													if (num55 >= 15000L && num55 >= characterAccountConfig.int_68[1] * characterAccountConfig.int_68[1])
													{
														if (num55 < 360000L)
														{
															...
															GameProcessInteractionHelper.RunToCoordinates(characterAccountConfig, array12);
															Thread.Sleep(200);
															break;
														}
														if (num55 < 1200000L)
										...
										if (flag14)
										{
											...
											num26 = (int)WindowsInteropHelper.ReadProcessUInt32(num25 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, characterAccountConfig.int_137);
											if (num26 < 3)
											{
												uint_3 = new uint[2]
												{
												...
												if (GameAutomationUtility.GetSquaredCoordinateDistance(uint_3, CharacterStateSyncCoordinator.characterSyncSnapshot_1.coordinates) > 5625L)
												{
													if (num17 > 0)
													{
														WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, byte_, 4, ref int_6);
									...
									{
										num28 = (int)WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, characterAccountConfig.int_137);
										uint_3 = new uint[2]
										{
											WindowsInteropHelper.ReadProcessUInt32(num25 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, characterAccountConfig.int_137),
											WindowsInteropHelper.ReadProcessUInt32(num25 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_59.resolvedValue, characterAccountConfig.int_137)
										};
										if (CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId == num28 && CongThanhQuanTransportCatalog.IsTransportMap(num28))
										{
											num57 = GameAutomationUtility.GetSquaredCoordinateDistance(uint_3, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates);
											if (characterAccountConfig.int_130[0] > 0 && characterAccountConfig.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId && num29 == CharacterStateSyncCoordinator.characterSyncSnapshot_0.fightState && num29 > 0)
											{
												int num58 = characterAccountConfig.int_130[1] + Form1.mainAccountSearchDistance;
												if (num57 <= num58 * num58 && CircularMovementHelper.MoveToNextPointAroundCenter(characterAccountConfig, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, characterAccountConfig.int_130[1]) > 0)
												{
													goto IL_404b;
												}
											}
											...
											uint_2 = null;
											int_1 = 0;
											if (num29 > 0 && !characterAccountConfig.bool_22 && characterAccountConfig.int_93 == 1 && Form1.dismountWhenReadyEnabled > 0 && (Form1.attackMonstersEnabled > 0 || Form1.attackPlayersEnabled > 0 || Form1.prioritizeBossTargetsEnabled > 0) && WindowsInteropHelper.ReadProcessUInt32(num25 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, characterAccountConfig.int_137) != 0)
											{
											...
											if (num13 <= 0L || CommonUtility.GetElapsedMilliseconds(num13) >= 1500L)
											{
												...
												if (CharacterStateSyncCoordinator.RefreshTrackedEntityPositionAndDetectSeparation(num8, ref uint_3, ref uint_) > 0)
												{
													long num60 = GameAutomationUtility.GetSquaredCoordinateDistance(uint_4, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates);
													long num61 = GameAutomationUtility.GetSquaredCoordinateDistance(uint_3, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates);
													if (num61 <= num16 * num16)
													{
														...
														num17 = 0;
														CharacterStateSyncCoordinator.MoveTowardCoordinateWithOffset(characterAccountConfig, uint_3, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, num60 <= 5625L);
														goto IL_3fdc;
													}
													if (num59 > 0)
													{
														uint[] uint_5 = GameAutomationUtility.GetCoordinateOffsetAlongLine(uint_3, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, -100);
												...
												num13 = 0L;
												if (num17 == 0 && GameAutomationUtility.GetSquaredCoordinateDistance(uint_4, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates) > Form1.mainAccountSearchDistance * Form1.mainAccountSearchDistance)
												{
													num10++;
													if (num10 > 3)
													{
											...
											int_1 = 0;
											uint_2 = null;
											array = CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates;
											flag6 = true;
										}
										else if (CongThanhQuanTransportCatalog.IsTransportMap(CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId))
										{
											uint_3 = new uint[2]
											{
												WindowsInteropHelper.ReadProcessUInt32(num25 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, characterAccountConfig.int_137),
											...
											uint[] array13 = CongThanhQuanTransportCatalog.GetRouteWaypoint(num28, uint_3, CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates);
											if (array13 != null)
											{
												...
												if (num57 >= 90000L)
												{
													...
													if (int_1 > 6)
													{
														long num62 = GameAutomationUtility.GetSquaredCoordinateDistance(uint_2, uint_3);
														uint_2 = null;
														if (num62 < 180000L)
														{
															GameAutomationUtility.MoveToApproachCoordinateAndWaitForMovementState(characterAccountConfig, uint_3, array14, 600);
															break;
														}
														int_1 = 0;
													}
												...
												for (int l = 0; l < 10; l++)
												{
													...
													num57 = GameAutomationUtility.GetSquaredCoordinateDistance(uint_3, array14);
													if (num57 < 11500L || WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, characterAccountConfig.int_137) != num28)
													{
														break;
													}
													GameProcessInteractionHelper.RunToCoordinates(characterAccountConfig, array14);
													Thread.Sleep(300);
												}
												for (int m = 0; m < 5; m++)
												{
													GameAutomationUtility.Move200UnitsAtAngle(characterAccountConfig, int_9);
													Thread.Sleep(300);
													uint num63 = WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, characterAccountConfig.int_137);
													if (num63 != num28)
													{
														break;
													}
								...
								while (true)
								{
									if (num != num28)
									{
										...
										num24 = BitConverter.ToUInt32(array3, 0);
										num25 = num24 + num23;
										WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array3, 4, ref int_6);
							...
							if (!flag14)
							{
								if (characterAccountConfig.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId && characterAccountConfig.int_136 != ApplicationRuntimeCoordinator.foregroundCharacterAccount.int_136 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.packedMousePosition != 0)
								{
									...
									array15 = GameInterfaceMemoryHelper.ConvertScreenToWorldCoordinates(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, (int)int_10, (int)num67);
									uint[] array16 = GameInterfaceMemoryHelper.ConvertWorldToScreenCoordinates(uint_3, array15);
									num66 = (array16[1] << 16) + array16[0];
									uint_6 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates;
									GameInterfaceMemoryHelper.WritePackedMousePosition(characterAccountConfig, num66);
									Thread.Sleep(10);
								}
							}
							else
							{
								uint num68 = CharacterStateSyncCoordinator.characterSyncSnapshot_1.packedMousePosition >> 16;
								uint int_11 = CharacterStateSyncCoordinator.characterSyncSnapshot_1.packedMousePosition - (num68 << 16);
								array15 = GameInterfaceMemoryHelper.ConvertScreenToWorldCoordinates(CharacterStateSyncCoordinator.characterSyncSnapshot_1.coordinates, (int)int_11, (int)num68);
								uint[] array17 = GameInterfaceMemoryHelper.ConvertWorldToScreenCoordinates(uint_3, array15);
							...
							if (num66 != 0 && characterAccountConfig.int_136 != ApplicationRuntimeCoordinator.foregroundCharacterAccount.int_136)
							{
								...
								{
									WindowsInteropHelper.ReadProcessUInt32(num25 + GameConfigurationManager.memorySignatureScanConfig_31.resolvedValue, characterAccountConfig.int_137);
								...
								{
									uint[] array18 = GameAutomationUtility.GetCoordinateOffsetAlongLine(uint_6, array15, -1 * (Form1.mainAccountSearchDistance - 50));
									long num71 = GameAutomationUtility.GetSquaredCoordinateDistance(uint_3, array18);
									if (num71 > 7000L)
									{
							...
							if (Form1.useSecondaryBattlefieldEnabled > 0 && num14 >= Form1.secondaryBattlefieldCycleThreshold && (Form1.stayOnSecondaryMapEnabled > 0 || num14 < Form1.secondaryBattlefieldCycleThreshold * 2))
							{
								...
								string_ = CongThanhQuanTransportCatalog.CityEntries[Form1.secondaryBattlefieldIndex].string_1;
								int_8 = CongThanhQuanTransportCatalog.CityEntries[Form1.secondaryBattlefieldIndex].int_0;
								flag4 = true;
								if (text != null && text != string.Empty)
								{
									text2 = text;
							...
							int[] array19 = GameAutomationUtility.FindTravelHubGroupPosition(num28);
							int num74;
							if (array19 != null && num29 <= 0)
							{
								...
								if (array8 == null)
								{
									...
									if (array8 == null)
									{
										...
										{
											string string_5 = CongThanhQuanTransportCatalog.CityEntries[Form1.primaryBattlefieldIndex].string_1;
											...
											GameProcessInteractionHelper.PrintGameMessage(characterAccountConfig, string_6);
											GameProcessInteractionHelper.PrintGameMessage(characterAccountConfig, string_7);
										}
										break;
									}
								}
								...
								long num73 = GameAutomationUtility.GetSquaredCoordinateDistance(uint_3, array8);
								if (num73 <= 90000L)
								{
									uint_2 = null;
									uint[] uint_8 = null;
									...
									if (num74 <= 0)
									{
										...
										GameAutomationUtility.TryShowStatusMessageIfDue(characterAccountConfig, "Khong tim thay Xa phu Cong thanh chien, auto tu dong thiet lap lai.");
										break;
									}
									for (int num75 = 0; num75 < 10; num75++)
									{
										...
										num57 = GameAutomationUtility.GetSquaredCoordinateDistance(uint_3, uint_8);
										if (num57 <= 11500L)
										{
											break;
										}
										GameProcessInteractionHelper.RunToCoordinates(characterAccountConfig, uint_8);
										Thread.Sleep(300);
									}
									WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, BitConverter.GetBytes(num74), 4, ref int_6);
									Thread.Sleep(600);
									...
									if (0 <= NpcDialogHelper.GetActiveMenuLayoutState(characterAccountConfig) && num77 > 0 && 0 <= num76)
									{
										...
										int num78 = -1;
										int num79 = (int)WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, characterAccountConfig.int_137);
										for (num32 = 0; num32 < array22.Length; num77 = NpcDialogHelper.GetMenuOptionCount(characterAccountConfig, num76), num32++)
										{
											...
											while (num81 < 15)
											{
												...
												int num82 = (int)WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, characterAccountConfig.int_137);
												if (num79 == num82)
												{
													Thread.Sleep(60);
													num81++;
										...
										for (num32 = 0; num32 < num83; num32++)
										{
											...
											while (num84 < 15)
											{
												int num85 = (int)WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, characterAccountConfig.int_137);
												if (num79 == num85)
												{
													Thread.Sleep(60);
													num84++;
										...
										if (Form1.useSecondaryBattlefieldEnabled > 0)
										{
											num14++;
										}
									}
								...
								if (int_1 > 6)
								{
									bool flag18 = uint_2 != null && GameAutomationUtility.GetSquaredCoordinateDistance(uint_2, uint_3) < 180000L;
									uint_2 = null;
									if (flag18)
									{
										GameAutomationUtility.MoveToApproachCoordinateAndWaitForMovementState(characterAccountConfig, uint_3, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, 600);
										break;
									}
									int_1 = 0;
								}
							...
							else if (!flag3 && !ConsumableAutomationHelper.IsMapIdInSpecialAutomationSet(num28))
							{
								flag3 = true;
								if (GameAutomationUtility.TryUseTownTeleportItem(characterAccountConfig))
								{
							...
							int int_12 = 1;
							array19 = GameAutomationUtility.FindTravelHubGroupPosition(string_);
							if (array19 != null)
							{
								int_12 = GameAutomationUtility.TravelHubMapIds[array19[0], array19[1]];
							}
							...
							break;
							IL_3fdc:
							if (!flag13 && characterAccountConfig.int_136 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId && CurrentCharacterMemoryHelper.GetCurrentTargetEntityIndexByTypes(characterAccountConfig, new int[2] { 0, 1 }) != 0)
							{
								if (num17 > 0)
								{
									WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, byte_, 4, ref int_6);
							...
							goto IL_404b;
							IL_2724:
							num29 = (int)WindowsInteropHelper.ReadProcessUInt32(num25 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, characterAccountConfig.int_137);
							if (num29 <= 0)
							{
								break;
							}
							num74 = 0;
							flag15 = Form1.findMainAccountEnabled > 0 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId != characterAccountConfig.int_136 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.accountId > 0 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.entityExistsFlag > 0 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId == num28;
							flag13 = !characterAccountConfig.bool_22 && (Form1.attackMonstersEnabled > 0 || Form1.attackPlayersEnabled > 0);
							if (characterAccountConfig.int_101[0] > 0 && characterAccountConfig.int_101[1] > 0 && characterAccountConfig.string_23 == "NGAMY")
							{
								...
								if (num86 > characterAccountConfig.int_101[4] && CombatTargetSelectionHelper.TryApplyConfiguredNgamyBuff(characterAccountConfig))
								{
							...
							if (!characterAccountConfig.bool_22)
							{
								...
								if (flag13 || FormDame.alwaysAttackEnabled > 0)
								{
									...
									bool flag22 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.spaceKeyPressedFlag == 1 || (flag14 && CharacterStateSyncCoordinator.characterSyncSnapshot_1.spaceKeyPressedFlag == 1);
							...
							if (int_1 > 6)
							{
								long num88 = GameAutomationUtility.GetSquaredCoordinateDistance(uint_2, uint_3);
								uint_2 = null;
								if (num88 < 180000L)
								{
									CharacterMovementHelper.SetMovementActive(characterAccountConfig, bool_0: false);
							...
							if (num57 > Form1.mountHorseDistance * Form1.mountHorseDistance)
							{
								GameAutomationUtility.SwitchHorseStateIfNeeded(characterAccountConfig, bool_0: false);
							}
							...
							if (CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates != null && (!CharacterMovementHelper.IsMovementActive(characterAccountConfig) || CommonUtility.GetElapsedMilliseconds(long_) > 4000L))
							{
							...
							while (true)
							{
								...
								for (int num93 = 0; num93 < array9.Length; num93++)
								{
									...
									while (num94 < 8)
									{
										...
										int num95 = (int)WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, characterAccountConfig.int_137);
										if (num92 == num95)
										{
							...
							if (flag13)
							{
								if (!CharacterStateSyncCoordinator.DetectPrimaryAccountInputActivity(characterAccountConfig, ref int_5) && GameInterfaceMemoryHelper.ReadEngineStateByte(characterAccountConfig) != 1)
								{
									...
									uint[] uint_9 = uint_3;
									if (flag15 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId == num28 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.fightState > 0 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates != null)
									{
										uint_9 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates;
										num34 += num16;
									}
									uint num98 = 0u;
									if (Form1.shareTargetEnabled > 0 && (flag14 || flag15))
									{
										if (!flag14)
										{
											if (flag15 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId == num28 && CharacterStateSyncCoordinator.characterSyncSnapshot_0.currentTargetEntityId != num8)
											{
												num98 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.currentTargetEntityId;
											}
										}
										else if (CharacterStateSyncCoordinator.characterSyncSnapshot_1.mapId == num28 && CharacterStateSyncCoordinator.characterSyncSnapshot_1.currentTargetEntityId != num8)
										{
											num98 = CharacterStateSyncCoordinator.characterSyncSnapshot_1.currentTargetEntityId;
										}
										if (num98 == 0 && Form1.autoFindTargetEnabled <= 0)
										{
											goto IL_3fdc;
										}
									}
									...
									{
										array23 = ((characterAccountConfig.int_5 <= 0) ? CombatTargetSelectionHelper.FindCombatTargetCandidates(characterAccountConfig, num98, num34, uint_9) : CombatTargetSelectionHelper.FindCombatTargetCandidatesWithBuffTargeting(characterAccountConfig, num98, num34, uint_9));
										if (array23 != null && array23[0, 0] >= 0)
										{
											int num99 = -1;
											int int_13 = CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId;
											num17 = 0;
											bool flag23 = false;
											bool flag24 = false;
											while (true)
											{
												...
												num26 = (int)WindowsInteropHelper.ReadProcessUInt32(num25 + GameConfigurationManager.memorySignatureScanConfig_55.resolvedValue, characterAccountConfig.int_137);
												num27 = (int)WindowsInteropHelper.ReadProcessUInt32(num25 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, characterAccountConfig.int_137);
												num29 = (int)WindowsInteropHelper.ReadProcessUInt32(num25 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, characterAccountConfig.int_137);
												int num103 = (int)WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, characterAccountConfig.int_137);
												if (num29 > 0 && num28 == num103 && num26 != 11 && num26 != 22 && num27 != 0)
												{
													for (int num104 = 0; num104 < array23.GetLength(0); num104++)
													{
														...
														num102 = num24 + (uint)(num38 * (int)GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue);
														WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num102 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array3, 4, ref int_6);
														...
														if (num105 > 0)
														{
															WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num102 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, array3, 4, ref int_6);
															if (BitConverter.ToInt32(array3, 0) <= 0)
															{
																continue;
															}
														...
														if (!flag24 || num105 > 0)
														{
															...
															num36 = num101;
															WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num102 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, array3, 4, ref int_6);
															array11[0] = BitConverter.ToUInt32(array3, 0);
															WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num102 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_59.resolvedValue, array3, 4, ref int_6);
															...
															if (flag15)
															{
																...
																long num106 = GameAutomationUtility.GetSquaredCoordinateDistance(uint_3, CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates);
																if (int_13 != CharacterStateSyncCoordinator.characterSyncSnapshot_0.mapId || num106 > num16 * num16)
																{
																	goto IL_3511;
																}
																int num107 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, array11));
																int num108 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(uint_3, array11));
															...
															if (GameAutomationUtility.GetSquaredCoordinateDistance(uint_3, array11) > num36 * num36 && characterAccountConfig.int_95 <= 0)
															{
																continue;
															}
															...
															WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_161.resolvedValue - 8, BitConverter.GetBytes(num100), 4, ref int_6);
															WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_31.resolvedValue, BitConverter.GetBytes(num36), 4, ref int_6);
															WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, BitConverter.GetBytes(num38), 4, ref int_6);
															Thread.Sleep(10);
															num17 = 1;
															continue;
														}
												...
												if (num17 <= 0 && characterAccountConfig.int_6 <= 0 && flag23)
												{
													...
													for (int num114 = 0; num114 < array23.GetLength(0); num114++)
													{
														...
														num102 = num24 + (uint)(num116 * (int)GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue);
														WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num102 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array3, 4, ref int_6);
														if (BitConverter.ToInt32(array3, 0) <= 0)
														{
															continue;
														...
														WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num102 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_59.resolvedValue, array3, 4, ref int_6);
														array11[1] = BitConverter.ToUInt32(array3, 0);
														long num118 = GameAutomationUtility.GetSquaredCoordinateDistance(uint_3, array11);
														...
														if (flag15)
														{
															int num119 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, array11));
															int num120 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(uint_3, array11));
													...
													WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_161.resolvedValue - 8, BitConverter.GetBytes(CharacterSkillHelper.ReadLeftSkillId(characterAccountConfig)), 4, ref int_6);
													WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_31.resolvedValue, BitConverter.GetBytes(num36), 4, ref int_6);
													WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, BitConverter.GetBytes(num38), 4, ref int_6);
												}
									...
									else if (flag13 = !characterAccountConfig.bool_22 && (Form1.attackMonstersEnabled > 0 || Form1.attackPlayersEnabled > 0))
									{
										array23 = CombatTargetSelectionHelper.FindCombatTargetCandidatesWithBuffTargeting(characterAccountConfig, num98, num34, uint_9);
										if (array23 == null)
										{
											flag13 = false;
										}
										else
										{
											...
											while (true)
											{
												if (array23[num123, 1] > 0)
												{
													...
													if (flag15)
													{
														int num124 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(uint_3, array11));
														...
														if (num124 - num36 > 0)
														{
															if (num125 > num124)
															{
																int num126 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, uint_3));
													...
													else if (GameAutomationUtility.GetSquaredCoordinateDistance(uint_3, array11) > num36 * num36 && characterAccountConfig.int_95 <= 0)
													{
														if (characterAccountConfig.int_88 != 1 || num123 != 0)
														{
															break;
												...
												_ = array23[num123, 2];
												if (Form1.fightUntilDeathEnabled > 0 && (num127 <= 0 || num127 == array2[0]) && array2[1] > 0 && array2[2] == num28 && array2[3] > 0)
												{
													int num128 = array2[0];
													int num129 = array2[1];
													uint num130 = num24 + (uint)(num129 * (int)GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue);
													WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num130 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array3, 4, ref int_6);
													if (BitConverter.ToInt32(array3, 0) > 0)
													{
														WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num130 + GameConfigurationManager.memorySignatureScanConfig_45.resolvedValue, array3, 4, ref int_6);
														long num131 = BitConverter.ToInt32(array3, 0);
														if ((ulong)num131 > 0uL)
														{
															WindowsInteropHelper.ReadProcessMemory(characterAccountConfig.int_137, num130 + GameConfigurationManager.memorySignatureScanConfig_43.resolvedValue, array3, 4, ref int_6);
															if (num128 <= 0 || BitConverter.ToInt32(array3, 0) > 0)
															{
																array11 = new uint[2]
																{
																	WindowsInteropHelper.ReadProcessUInt32(num130 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, characterAccountConfig.int_137),
																	WindowsInteropHelper.ReadProcessUInt32(num130 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_59.resolvedValue, characterAccountConfig.int_137)
																};
																long num132 = GameAutomationUtility.GetSquaredCoordinateDistance(uint_3, array11);
																if (flag15)
																{
																	int num133 = (int)Math.Sqrt(num132);
																	int num134 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, array11));
																	if (num133 - num36 > 0)
																	{
																		if (num134 > num133)
																		{
																			int num135 = (int)Math.Sqrt(GameAutomationUtility.GetSquaredCoordinateDistance(CharacterStateSyncCoordinator.characterSyncSnapshot_0.coordinates, uint_3));
												...
												if (characterAccountConfig.gstruct50_0.enabled == 0 || CombatTargetSelectionHelper.TryUseConfiguredPreAttackSkill(characterAccountConfig, (uint)num38) <= 0)
												{
													WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_161.resolvedValue - 8, BitConverter.GetBytes(CharacterSkillHelper.ReadLeftSkillId(characterAccountConfig)), 4, ref int_6);
													WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_31.resolvedValue, BitConverter.GetBytes(num36), 4, ref int_6);
													WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_72.resolvedValue, BitConverter.GetBytes(num38), 4, ref int_6);
												}
												flag11 = characterAccountConfig.gstruct50_0.enabled > 0 && characterAccountConfig.gstruct50_0.skillId > 0 && characterAccountConfig.gstruct50_0.postCastSearchDistanceAdjustmentEnabled > 0 && characterAccountConfig.gstruct50_0.postCastSearchDistance > 0;
												break;
											}
										}
									}
				...
				else
				{
					...
					{
						WindowsInteropHelper.WriteProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_251.resolvedValue, GameConfigurationManager.byte_0, GameConfigurationManager.byte_0.Length, ref int_6);
					}
					num17 = 0;
					num18 = 0;
				}
	...
	private static int FindTypeThreeEntityByNameAndReturnCoordinates(CharacterAccountConfig characterAccountConfig_0, string string_0, ref uint[] uint_0)
	{
		...
		WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_27.resolvedValue, characterAccountConfig_0.int_137);
		...
		if (num5 > 1)
		{
			...
			for (uint num7 = 1u; num7 < 256; num7++)
			{
				...
				uint num8 = num3 + num7 * GameConfigurationManager.memorySignatureScanConfig_15.resolvedValue;
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_16.resolvedValue, array, 4, ref int_);
				if (array[0] == 0)
				{
					continue;
				}
				num6++;
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_50.resolvedValue, array, 4, ref int_);
				if (BitConverter.ToInt32(array, 0) <= 0)
				{
					continue;
				}
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_52.resolvedValue, array, 4, ref int_);
				uint num9 = BitConverter.ToUInt32(array, 0);
				if (num9 == 3)
				{
					WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_16.resolvedValue, array2, array2.Length, ref int_);
					string text2 = GameTextEncodingHelper.DecodeNullTerminatedUtf7(array2).Trim().ToLower();
					if (!(text2 != text))
					{
						uint_0 = new uint[2];
						WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, array, 4, ref int_);
						uint_0[0] = BitConverter.ToUInt32(array, 0);
						WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num8 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_59.resolvedValue, array, 4, ref int_);
	...
	private static string FindNearbyCongThanhTravelNpcName(CharacterAccountConfig characterAccountConfig_0)
	{
		...
		if (num6 >= 0)
		{
			...
			for (uint num10 = 1u; num10 < 256; num10++)
			{
				...
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num11 + GameConfigurationManager.memorySignatureScanConfig_16.resolvedValue, array4, 4, ref int_);
				if (array4[0] == 0)
				{
					continue;
				}
				num8++;
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num11 + GameConfigurationManager.memorySignatureScanConfig_52.resolvedValue, array4, 4, ref int_);
				...
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num11 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_58.resolvedValue, array4, 4, ref int_);
				array7[0] = BitConverter.ToUInt32(array4, 0);
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num11 + GameConfigurationManager.memorySignatureScanConfig_57.resolvedValue + GameConfigurationManager.memorySignatureScanConfig_59.resolvedValue, array4, 4, ref int_);
				array7[1] = BitConverter.ToUInt32(array4, 0);
				WindowsInteropHelper.ReadProcessMemory(characterAccountConfig_0.int_137, num11 + GameConfigurationManager.memorySignatureScanConfig_16.resolvedValue, array5, array5.Length, ref int_);
				string text2 = GameTextEncodingHelper.DecodeNullTerminatedUtf7(array5);
				...
				if (!flag)
				{
					...
					{
						long num13 = GameAutomationUtility.GetSquaredCoordinateDistance(uint_, array7);
