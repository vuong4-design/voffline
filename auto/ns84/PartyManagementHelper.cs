...
internal class PartyManagementHelper
{
	...
	public static bool IsInTeam(CharacterAccountConfig characterAccountConfig_0)
	{
		...
		return WindowsInteropHelper.ReadProcessUInt32(num + GameConfigurationManager.memorySignatureScanConfig_12.uint_0 + GameConfigurationManager.memorySignatureScanConfig_202.uint_0, characterAccountConfig_0.int_137) != 0;
	}
	...
	public static GStruct61 ReadTeamInfo(CharacterAccountConfig characterAccountConfig_0)
	{
		...
		for (int i = 0; i < 8; i++)
		{
			string text = WindowsInteropHelper.ReadNullTerminatedUtf7ProcessString(GameConfigurationManager.memorySignatureScanConfig_203.uint_0 + characterAccountConfig_0.uint_7 + (uint)(i * (int)GameConfigurationManager.memorySignatureScanConfig_198.uint_0), characterAccountConfig_0.int_137, 32);
			if (text != string.Empty)
			{
				...
				array[i].int_1 = i;
				array[i].int_0 = (int)WindowsInteropHelper.ReadProcessUInt32((uint)(GameConfigurationManager.memorySignatureScanConfig_200.uint_0 + characterAccountConfig_0.uint_7 + i * GameConfigurationManager.memorySignatureScanConfig_199.uint_0), characterAccountConfig_0.int_137);
			}
		}
	...
	public void method_1()
	{
		...
		while (!CommonUtility.bool_0)
		{
			...
			uint num6 = WindowsInteropHelper.ReadProcessUInt32(GameConfigurationManager.memorySignatureScanConfig_165.uint_0, characterAccountConfig_.int_137);
			uint uint_ = WindowsInteropHelper.ReadProcessUInt32(num6 + GameConfigurationManager.memorySignatureScanConfig_167.uint_0, characterAccountConfig_.int_137);
					...
					if (!(gStruct2.string_0 != characterAccountConfig_.string_22))
					{
						if (gStruct2.int_0 != 8)
						{
							...
							for (int j = num; j < num2; j++)
							{
								...
								uint num10 = WindowsInteropHelper.ReadProcessUInt32(num5 + num9 + GameConfigurationManager.memorySignatureScanConfig_52.uint_0, characterAccountConfig_.int_137);
								if (num10 != 1 || WindowsInteropHelper.ReadProcessUInt32(num5 + num9 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, characterAccountConfig_.int_137) == 0)
								{
									continue;
								}
								string text2 = WindowsInteropHelper.ReadNullTerminatedUtf7ProcessString(num5 + num9 + GameConfigurationManager.memorySignatureScanConfig_16.uint_0, characterAccountConfig_.int_137, 32);
			...
			goto IL_06cd;
			IL_062a:
			uint num14 = WindowsInteropHelper.ReadProcessUInt32(num7 + GameConfigurationManager.memorySignatureScanConfig_170.uint_0, characterAccountConfig_.int_137);
