	...
	public static void Run(int int_0)
	{
		...
		while (true)
		{
			...
			if (characterAccountConfig.bool_25 && characterAccountConfig.bool_55 && !flag)
			{
				...
				uint num10 = Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_11.uint_0, characterAccountConfig.int_137);
				uint num11 = Class24.smethod_30(num10 + GameConfigurationManager.memorySignatureScanConfig_13.uint_0, characterAccountConfig.int_137);
				uint num12 = Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_14.uint_0, characterAccountConfig.int_137);
				uint num13 = num12 + num11 * GameConfigurationManager.memorySignatureScanConfig_15.uint_0;
				num14 = (int)Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_27.uint_0, characterAccountConfig.int_137);
				int num15 = (int)Class24.smethod_30(num13 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, characterAccountConfig.int_137);
				int num16 = (int)Class24.smethod_30(num13 + GameConfigurationManager.memorySignatureScanConfig_55.uint_0, characterAccountConfig.int_137);
				int num17 = (int)Class24.smethod_30(num13 + GameConfigurationManager.memorySignatureScanConfig_50.uint_0, characterAccountConfig.int_137);
				...
				{
					Class24.smethod_30(num13 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_58.uint_0, characterAccountConfig.int_137),
					Class24.smethod_30(num13 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_59.uint_0, characterAccountConfig.int_137)
				};
				...
				if (num14 != 342)
				{
					...
					num19 = Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_11.uint_0, characterAccountConfig.int_137) + GameConfigurationManager.memorySignatureScanConfig_97.uint_0;
					uint num20 = Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_105.uint_0, characterAccountConfig.int_137);
					num21 = 0;
					...
					if (num2 == -1)
					{
						...
						for (num30 = 1u; num30 < GameConfigurationManager.int_1 && num22 > num23; num30++)
						{
							...
							Class24.ReadProcessMemory(characterAccountConfig.int_137, num25 + GameConfigurationManager.memorySignatureScanConfig_106.uint_0 - 4, array, 4, ref int_1);
							...
							if (array[0] == 0 || (int)Class24.smethod_30(num25 + GameConfigurationManager.memorySignatureScanConfig_108.uint_0, characterAccountConfig.int_137) <= 0)
							{
								continue;
							}
							uint num31 = Class24.smethod_30(num19 + num28 * 20 + GameConfigurationManager.memorySignatureScanConfig_100.uint_0 - 8, characterAccountConfig.int_137);
							...
							if (0 > text3.IndexOf(text2.ToLower()))
							{
								...
								uint num32 = Class24.smethod_30(num25 + GameConfigurationManager.memorySignatureScanConfig_119.uint_0, characterAccountConfig.int_137);
					...
					while (true)
					{
						...
						if (num28 != 0)
						{
							num20 = Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_105.uint_0, characterAccountConfig.int_137);
							num25 = num20 + (uint)(num42 * (int)GameConfigurationManager.memorySignatureScanConfig_106.uint_0);
							num29 = num25 + GameConfigurationManager.memorySignatureScanConfig_107.uint_0;
							Class24.ReadProcessMemory(characterAccountConfig.int_137, num29, array2, array2.Length, ref int_1);
							text3 = GameTextEncodingHelper.smethod_3(array2).ToLower();
							uint num43 = Class24.smethod_30(num25 + GameConfigurationManager.memorySignatureScanConfig_119.uint_0, characterAccountConfig.int_137);
							if ((num43 == 0 || num43 >= 100) && (text3.IndexOf(text2.ToLower()) >= 0 || text3.IndexOf(text.ToLower()) >= 0))
							{
								Class24.WriteProcessMemory(characterAccountConfig.int_137, num13 + GameConfigurationManager.memorySignatureScanConfig_72.uint_0, BitConverter.GetBytes(num40), 4, ref int_1);
								...
								num26 = Class24.smethod_30(num24 + GameConfigurationManager.memorySignatureScanConfig_100.uint_0 - 4, characterAccountConfig.int_137);
								num27 = Class24.smethod_30(num24 + GameConfigurationManager.memorySignatureScanConfig_100.uint_0, characterAccountConfig.int_137);
								uint num44 = Class24.smethod_30(num19 + num28 * 20 + GameConfigurationManager.memorySignatureScanConfig_100.uint_0 - 8, characterAccountConfig.int_137);
								num21 = 0;
								Class75.smethod_46(characterAccountConfig, num26, num27, num44, num26, num27, num44);
								while (true)
								{
									if ((int)Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_123.uint_0, characterAccountConfig.int_137) <= 0)
									{
										Thread.Sleep(150);
										num21++;
										if (num21 > 10)
									...
									while (true)
									{
										...
										for (num21 = 0; num21 < 10; num21++)
										{
											int num45 = (int)Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_27.uint_0, characterAccountConfig.int_137);
											int num46 = (int)Class24.smethod_30(num13 + GameConfigurationManager.memorySignatureScanConfig_43.uint_0, characterAccountConfig.int_137);
			...
			num26 = Class24.smethod_30(num24 + GameConfigurationManager.memorySignatureScanConfig_100.uint_0 - 4, characterAccountConfig.int_137);
			num27 = Class24.smethod_30(num24 + GameConfigurationManager.memorySignatureScanConfig_100.uint_0, characterAccountConfig.int_137);
			uint num47 = Class24.smethod_30(num19 + num28 * 20 + GameConfigurationManager.memorySignatureScanConfig_100.uint_0 - 8, characterAccountConfig.int_137);
			num21 = 0;
			if (num47 != 3)
			{
				...
				if (array7 != null)
				{
					...
					{
						Class24.ReadProcessMemory(characterAccountConfig.int_137, num19 + num28 * 20 + GameConfigurationManager.memorySignatureScanConfig_100.uint_0 - 8, array, 4, ref int_1);
			...
			num47 = Class24.smethod_30(num19 + num28 * 20 + GameConfigurationManager.memorySignatureScanConfig_100.uint_0 - 8, characterAccountConfig.int_137);
			if (num47 != 3)
			{
				if (num6 >= 3)
				{
			...
			while (true)
			{
				if (num21 < 150)
				{
					...
					int num48 = (int)Class24.smethod_30(GameConfigurationManager.memorySignatureScanConfig_27.uint_0, characterAccountConfig.int_137);
					if (num48 != num14)
					{
						break;
					}
	...
	private static uint smethod_2(CharacterAccountConfig characterAccountConfig_0)
	{
		...
		if (num5 == 175)
		{
			...
			for (uint num10 = 1u; num10 < 256; num10++)
			{
				...
				num7++;
				Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num11 + GameConfigurationManager.memorySignatureScanConfig_52.uint_0, array, 4, ref int_);
				uint num12 = BitConverter.ToUInt32(array, 0);
				if (num12 == 3)
				{
					uint[] array4 = new uint[2];
					Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num11 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_58.uint_0, array, 4, ref int_);
					array4[0] = BitConverter.ToUInt32(array, 0);
					Class24.ReadProcessMemory(characterAccountConfig_0.int_137, num11 + GameConfigurationManager.memorySignatureScanConfig_57.uint_0 + GameConfigurationManager.memorySignatureScanConfig_59.uint_0, array, 4, ref int_);
