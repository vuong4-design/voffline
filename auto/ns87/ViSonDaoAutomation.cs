	...
	public static void Run(int int_0)
	{
		...
		while (true)
		{
			...
			if (characterAccountConfig.bool_25 && characterAccountConfig.bool_55 && !flag)
			{
				...
				if (num17 <= 0 || num14 <= 0 || num16 == 10 || num16 == 21 || num18 <= 1 || (characterAccountConfig.int_136 == ApplicationRuntimeCoordinator.foregroundCharacterAccount.int_136 && GameInterfaceMemoryHelper.ReadEngineStateByte(characterAccountConfig) == 1))
				{
					continue;
				}
