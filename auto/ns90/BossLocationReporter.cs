...
internal class BossLocationReporter
{
	...
	public static int[] ReportOptions = new int[4]
	{
		...
		Class66.smethod_4("KenhBang", 0, "0"),
	...
	private static void RunForCharacter(int int_3)
	{
		...
		while (true)
		{
			...
			{
				Class24.ReadProcessMemory(characterAccountConfig.int_137, Class56.memorySignatureScanConfig_27.uint_0, array, 4, ref int_4);
				...
				if (num2 == num5)
				{
					...
					if (num6 > 1)
					{
						...
						uint num8 = Class24.smethod_30(num7 + Class56.memorySignatureScanConfig_13.uint_0, characterAccountConfig.int_137) * Class56.memorySignatureScanConfig_15.uint_0;
						uint num9 = Class24.smethod_30(Class56.memorySignatureScanConfig_14.uint_0, characterAccountConfig.int_137);
						uint num10 = num9 + num8;
						Class24.ReadProcessMemory(characterAccountConfig.int_137, num10 + Class56.memorySignatureScanConfig_43.uint_0, array, 4, ref int_4);
						...
						if (num11 > 0)
						{
							...
							{
								Class24.smethod_30(num10 + Class56.memorySignatureScanConfig_57.uint_0 + Class56.memorySignatureScanConfig_58.uint_0, characterAccountConfig.int_137),
								Class24.smethod_30(num10 + Class56.memorySignatureScanConfig_57.uint_0 + Class56.memorySignatureScanConfig_59.uint_0, characterAccountConfig.int_137)
							};
							...
							for (uint num13 = 1u; num13 < 256; num13++)
							{
								...
								uint num14 = num9 + num13 * Class56.memorySignatureScanConfig_15.uint_0;
								Class24.ReadProcessMemory(characterAccountConfig.int_137, num14 + Class56.memorySignatureScanConfig_16.uint_0, array, 4, ref int_4);
								if (array[0] != 0)
								{
									num12++;
									Class24.ReadProcessMemory(characterAccountConfig.int_137, num14 + Class56.memorySignatureScanConfig_50.uint_0, array, 4, ref int_4);
									if (BitConverter.ToInt32(array, 0) > 0)
									{
										Class24.ReadProcessMemory(characterAccountConfig.int_137, num14 + Class56.memorySignatureScanConfig_52.uint_0, array, 4, ref int_4);
										if (BitConverter.ToInt32(array, 0) == 0)
										{
											Class24.ReadProcessMemory(characterAccountConfig.int_137, num14 + Class56.memorySignatureScanConfig_55.uint_0, array, 4, ref int_4);
											...
											if (num15 != 10 && num15 != 21)
											{
												...
												if (num16 > 0)
												{
													Class24.ReadProcessMemory(characterAccountConfig.int_137, num14 + Class56.memorySignatureScanConfig_26.uint_0 + 8, array, 4, ref int_4);
													int num17 = BitConverter.ToInt32(array, 0);
													if (num17 > 0)
													{
														Class24.ReadProcessMemory(characterAccountConfig.int_137, num14 + Class56.memorySignatureScanConfig_26.uint_0 + 12, array, 4, ref int_4);
														int num18 = BitConverter.ToInt32(array, 0);
														if (num18 >= 16)
														{
															Class24.ReadProcessMemory(characterAccountConfig.int_137, num14 + Class56.memorySignatureScanConfig_51.uint_0, array, 4, ref int_4);
															int num19 = BitConverter.ToInt32(array, 0);
															if (num19 > 0)
															{
																Class24.ReadProcessMemory(characterAccountConfig.int_137, num14 + Class56.memorySignatureScanConfig_53.uint_0, array, 4, ref int_4);
																int num20 = BitConverter.ToInt32(array, 0);
																if (num20 >= 0 && num20 <= 4)
																{
																	Class24.ReadProcessMemory(characterAccountConfig.int_137, num14 + Class56.memorySignatureScanConfig_57.uint_0 + Class56.memorySignatureScanConfig_58.uint_0, array, 4, ref int_4);
																	array6[0] = BitConverter.ToUInt32(array, 0);
																	Class24.ReadProcessMemory(characterAccountConfig.int_137, num14 + Class56.memorySignatureScanConfig_57.uint_0 + Class56.memorySignatureScanConfig_59.uint_0, array, 4, ref int_4);
																	array6[1] = BitConverter.ToUInt32(array, 0);
																	Class24.ReadProcessMemory(characterAccountConfig.int_137, num14 + Class56.memorySignatureScanConfig_45.uint_0, array, 4, ref int_4);
