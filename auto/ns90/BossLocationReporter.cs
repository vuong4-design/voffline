	...
	public static string GetNearestDirectionHint(int int_3, uint[] uint_0)
	{
		...
		while (true)
		{
			if (num < directionHintGroups.Length)
			{
				...
				{
					long num4 = GameAutomationUtility.GetSquaredCoordinateDistance(uint_0, directionHintGroups[num].directionHints[i].coordinates);
					if (num2 < 0 || num4 < num3)
					{
						num2 = i;
						num3 = num4;
														...
														if (num18 >= 16)
														{
															...
															if (num19 > 0)
															{
																...
																if (num20 >= 0 && num20 <= 4)
																{
																	...
																	GameAutomationUtility.GetSquaredCoordinateDistance(array5, array6);
																	num = num13;
																	double num23 = 0.0;
																	if ((ulong)num22 > 0uL)
																	{
																	...
																	{
																		if (num3 != num16 || array4 == null || GameAutomationUtility.GetSquaredCoordinateDistance(array4, array5) > 1500000L)
																		{
																			num3 = num16;
																			array4 = new uint[2]
																			{
